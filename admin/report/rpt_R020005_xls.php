	...
	if($count_data){
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if(array_search($REPORT_ORDER, $arr_rpt_order) !== false  && array_search($REPORT_ORDER, $arr_rpt_order) == 0 && count($arr_rpt_order) > 1){
				...
				$worksheet->write_string($xlsRow, 4, "$LEVEL_NAME", set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
				...
				$worksheet->write_string($xlsRow, 8, "$POSTDATE", set_format("xlsFmtTableDetail", "B", "C", "TLRB", 0));
			}else{
				$xlsRow++;
				...
				$worksheet->write_string($xlsRow, 4, "$LEVEL_NAME", set_format("xlsFmtTableDetail", "", "R", "TLRB", 0));
				...
				$worksheet->write_string($xlsRow, 7, "$BIRTHDATE", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 8, "$POSTDATE", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
			} // end if
		} // end for				
	}else{
		$xlsRow = 0;
