<?
	...
	function print_header($xlsRow){
		...
		$worksheet->write($xlsRow, 0, "ช่วงระดับตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 1, "ระดับเริ่มต้น", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 2, "ระดับสูงสุด", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
