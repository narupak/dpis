...
//	session_cache_limiter("nocache");
	...
	if ($FLAG_RTF) {
		...
		$fname= "rpt_master_table_province.rtf";
...
//	$db_dpis->show_error();
	...
	//		echo "$head_text1<br>";
			$tab_align = "center";
			$result = $RTF->open_tab($head_text1, $head_width1, 7, "TRHBL", $head_align1, "", "16", "b", $fmtTableHeader_col_idx, $fmtTableHeader_bgcol_idx, $COLUMN_FORMAT, "", false, $tab_align);
		} else {
