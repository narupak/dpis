<?
	...
	function print_header(){
		...
		$worksheet->write($xlsRow, 5, "เงินเดือน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 6, "เงินเดือนสูงสุด", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 7, "ฐานในการ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 8, "ร้อยละของ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 9, "ร้อยละของ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 10, "จำนวนเงินที่", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 11, "จำนวนเงินที่ได้รับ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 12, "เงินตอบแทนฯ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 13, "รวม", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 14, "เงินเดือน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 15, "ผลการ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 16, "หมายเหตุ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		...
		$worksheet->write($xlsRow, 5, "(บาท)", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 6, "แต่ละประเภทฯ", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 7, "คำนวณ (บาท)", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 8, "การประเมิน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 9, "การเลื่อน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 10, "คำนวณได้", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 11, "การเลื่อนจริง(บาท)", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		...
		$worksheet->write($xlsRow, 14, "หลังเลื่อน (บาท)", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 15, "ประเมิน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
	...
	elseif($KF_CYCLE == 2)	$SAH_EFFECTIVEDATE = ($search_budget_year-543) . "-10-01";/*เดิม $SAH_EFFECTIVEDATE = ($search_budget_year-544) . "-10-01";*/
	if($DPISDB=="odbc"){  
					  ...
					  $search_condition
					  order by SAH_POS_NO_NAME, CLng(SAH_POS_NO) ";
					  ...
					  where		a.PER_ID=b.PER_ID and PER_TYPE = $search_per_type and PER_STATUS = 1 and 
										SAH_EFFECTIVEDATE = '$SAH_EFFECTIVEDATE' and SAH_KF_CYCLE = $KF_CYCLE and b.MOV_CODE not in ('215','21510','21520')
					  $search_condition
					  order by SAH_POS_NO_NAME, to_number(replace(SAH_POS_NO,'-','')) ";	}
	...
	if($count_data){
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if($CONTENT_TYPE=="CONTENT"){
				...
				$worksheet->write_string($xlsRow, 6, (($NUMBER_DISPLAY==2)?convert2thaidigit($LAYER_SALARY_MAX):$LAYER_SALARY_MAX), set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
				$worksheet->write_string($xlsRow, 7,(($NUMBER_DISPLAY==2)?convert2thaidigit($SAH_SALARY_MIDPOINT):$SAH_SALARY_MIDPOINT), set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
				$worksheet->write_string($xlsRow, 8, (($NUMBER_DISPLAY==2)?convert2thaidigit($SAH_TOTAL_SCORE):$SAH_TOTAL_SCORE), set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
				...
				$worksheet->write_string($xlsRow, 11, (($NUMBER_DISPLAY==2)?convert2thaidigit($SAH_SALARY_UP):$SAH_SALARY_UP), set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
				$worksheet->write_string($xlsRow, 12,(($NUMBER_DISPLAY==2)?convert2thaidigit($SAH_SALARY_EXTRA):$SAH_SALARY_EXTRA), set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
				$worksheet->write_string($xlsRow, 13,(($NUMBER_DISPLAY==2)?convert2thaidigit($SAH_SALARY_TOTAL):$SAH_SALARY_TOTAL), set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
				$worksheet->write_string($xlsRow, 14, (($NUMBER_DISPLAY==2)?convert2thaidigit($SAH_SALARY):$SAH_SALARY), set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
				$worksheet->write_string($xlsRow, 15, "$MOV_NAME", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
				$worksheet->write_string($xlsRow, 16, "$SAH_REMARK", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
			} // end if
		} // end for				
