<?
	...
	function print_header(){
		global $worksheet, $xlsRow, $FULLNAME_HEAD;
		...
		$worksheet->write($xlsRow, 8, "ดำรงตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 9, "ตำแหน่งและส่วนราชการที่เลื่อน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
		...
		$worksheet->write($xlsRow, 15, "", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));

		$xlsRow++;
		$worksheet->write($xlsRow, 0, "ที่", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
		$worksheet->write($xlsRow, 1, $FULLNAME_HEAD, set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
		$worksheet->write($xlsRow, 2, "วุฒิ/สาขา", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
		$worksheet->write($xlsRow, 3, "ตำแหน่ง/สังกัด", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		...
		$worksheet->write($xlsRow, 8, "ในระดับ", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
		$worksheet->write($xlsRow, 9, "ตำแหน่ง/สังกัด", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 10, "ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 11, "ระดับ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 12, "เลขที่", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 13, "เงินเดือน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 14, "ตั้งแต่วันที่", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
		$worksheet->write($xlsRow, 15, "หมายเหตุ", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));

		$xlsRow++;
		$worksheet->write($xlsRow, 0, "", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 1, "", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 2, "สถานศึกษา", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 3, "", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 4, "ประเภท", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		...
		$worksheet->write($xlsRow, 8, "ปัจจุบันเมื่อ", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 9, "", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 10, "ประเภท", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
...
//			$CMD_NOTE = $arr_content[$data_count][cmd_note];
			...
			if($CONTENT_TYPE=="ORG" || $CONTENT_TYPE=="ORG_1" || $CONTENT_TYPE=="ORG_2"){
				...
				if($CONTENT_TYPE=="ORG"){
					...
					$worksheet->write($xlsRow, 6, "", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 1));
					...
					$worksheet->write($xlsRow, 9, "$NEW_ORG_NAME ", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 1));
					$worksheet->write($xlsRow, 10, "", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 1));
					$worksheet->write($xlsRow, 11, "", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 1));
					$worksheet->write($xlsRow, 12, "", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 1));
					$worksheet->write($xlsRow, 13, "", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 1));
					...
					$worksheet->write($xlsRow, 6, "", set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
					...
					$worksheet->write($xlsRow, 9, "$NEW_ORG_NAME ", set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
					$worksheet->write($xlsRow, 10, "", set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
					$worksheet->write($xlsRow, 11, "", set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
					$worksheet->write($xlsRow, 12, "", set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
					$worksheet->write($xlsRow, 13, "", set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
				...
				if($CMD_NOTE2){
					...
					$worksheet->write_string($xlsRow, 2, "$EDUCATE", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
					$worksheet->write_string($xlsRow, 3, "$CMD_POSITION", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
					$worksheet->write_string($xlsRow, 4, "$CMD_POSITION_TYPE", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
					$worksheet->write_string($xlsRow, 5, "$CMD_LEVEL_NAME", set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
					$worksheet->write_string($xlsRow, 6, "$CMD_POS_NO", set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
					$worksheet->write($xlsRow, 7, "$PREV_BUDGET_YEAR_SALARY", set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
					$worksheet->write_string($xlsRow, 8, "$LEVEL_EFFECTIVEDATE", set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
					///$worksheet->write($xlsRow, 6, "$BUDGET_YEAR_SALARY", set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
					$worksheet->write_string($xlsRow, 9, "$NEW_POSITION", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
					$worksheet->write_string($xlsRow, 10, "$NEW_POSITION_TYPE", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
					$worksheet->write_string($xlsRow, 11, "$NEW_LEVEL_NAME", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
					$worksheet->write_string($xlsRow, 12, "$NEW_POS_NO", set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
					$worksheet->write($xlsRow, 13, "$CMD_SALARY", set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
					$worksheet->write_string($xlsRow, 14, "$CMD_DATE", set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
					$worksheet->write_string($xlsRow, 15, "$CMD_NOTE1", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
				} // end if
			} // end if
		} // end for				
	...
	header("Content-Type: application/x-msexcel; name=\"บัญชีแนบท้ายคำสั่งเลื่อนระดับ.xls\"");
	header("Content-Disposition: inline; filename=\"บัญชีแนบท้ายคำสั่งเลื่อนระดับ.xls\"");
	$fh=fopen($fname, "rb");
	fpassthru($fh);
	fclose($fh);
	unlink($fname);
