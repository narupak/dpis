...
*/
	function print_header(){
		...
		$worksheet->write($xlsRow, 1, "ประเภทตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		...
		$worksheet->write($xlsRow, 5, "รวม", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));

		$xlsRow++;
		$worksheet->write($xlsRow, 0, "", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 1, "ทั่วไป", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 2, "วิชาการ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 3, "อำนวยการ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 4, "บริหาร", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	if($count_data){
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if($REPORT_ORDER == "DEPARTMENT"){
				if($data_count > 0){
					...
					$worksheet->write($xlsRow, 2, ($GRAND_TOTAL_2[$DEPARTMENT_ID]?number_format($GRAND_TOTAL_2[$DEPARTMENT_ID]):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
					$worksheet->write($xlsRow, 3, ($GRAND_TOTAL_3[$DEPARTMENT_ID]?number_format($GRAND_TOTAL_3[$DEPARTMENT_ID]):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
					$worksheet->write($xlsRow, 4, ($GRAND_TOTAL_4[$DEPARTMENT_ID]?number_format($GRAND_TOTAL_4[$DEPARTMENT_ID]):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
					$worksheet->write($xlsRow, 5, ($GRAND_TOTAL[$DEPARTMENT_ID]?number_format($GRAND_TOTAL[$DEPARTMENT_ID]):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
				...
				if(array_search($REPORT_ORDER, $arr_rpt_order) !== false  && array_search($REPORT_ORDER, $arr_rpt_order) == 0 && count($arr_rpt_order) > 1){
					...
					$worksheet->write($xlsRow, 2, ($COUNT_2?number_format($COUNT_2):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
					$worksheet->write($xlsRow, 3, ($COUNT_3?number_format($COUNT_3):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
					$worksheet->write($xlsRow, 4,  ($COUNT_4?number_format($COUNT_4):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
					$worksheet->write($xlsRow, 5,($COUNT_TOTAL?number_format($COUNT_TOTAL):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
				}else{
					$xlsRow++;
		...
		if(count($GRAND_TOTAL) > 1){
			...
			$xlsRow++;
			$worksheet->write_string($xlsRow, 0, "รวมทั้งสิ้น", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 0));
			...
			$worksheet->write($xlsRow, 2, (array_sum($GRAND_TOTAL_2)?number_format(array_sum($GRAND_TOTAL_2)):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
			$worksheet->write($xlsRow, 3, (array_sum($GRAND_TOTAL_3)?number_format(array_sum($GRAND_TOTAL_3)):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
			$worksheet->write($xlsRow, 4, (array_sum($GRAND_TOTAL_4)?number_format(array_sum($GRAND_TOTAL_4)):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
			$worksheet->write($xlsRow, 5, (array_sum($GRAND_TOTAL)?number_format(array_sum($GRAND_TOTAL)):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
		} // end if
	}else{
		$worksheet = &$workbook->addworksheet("$report_code".($count_org_ref?"_$count_org_ref":""));
		$worksheet->set_margin_right(0.50);
