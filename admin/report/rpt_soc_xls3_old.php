...
//	$db_dpis->show_error();
	...
	while($data = $db_dpis->get_array()){
		...
		// === หาเครื่องราชย์
		$DC_CODE = $DEH_DATE = "";
		$cmd = " select DC_CODE, DEH_DATE, DEH_POSITION, DEH_ORG
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	header("Content-Type: application/x-msexcel; name=\"soc_history.xls\"");
	header("Content-Disposition: inline; filename=\"soc_history.xls\"");
	$fh=fopen($fname, "rb");
	fpassthru($fh);
	fclose($fh);
	unlink($fname);
