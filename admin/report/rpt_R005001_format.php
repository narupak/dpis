...
//	fix head for rpt_R005001
	...
	$heading_text[1] = "<**1**>เป็นข้าราชการ|ระดับ";
	$heading_text[2] = "<**1**>เป็นข้าราชการ|วัน/เดือน/ปี";
	$heading_text[3] = "<**1**>เป็นข้าราชการ|เงินเดือน";
	$heading_text[4] = "ตำแหน่ง|";
	$heading_text[5] = "<**2**>เครื่องราชอิสริยาภรณ์|ครั้งสุดท้าย";
	$heading_text[6] = "<**2**>เครื่องราชอิสริยาภรณ์|วัน/เดือน/ปี";
	$heading_text[7] = "<**2**>เครื่องราชอิสริยาภรณ์|ขอครั้งนี้";
