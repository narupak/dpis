...
//	$arr_rpt_order = array("POSNO"); 
	...
	$report_code = "data พนักงานราชการ";
...
*/
	...
	function initialize_parameter($current_index){
		...
		global $POEMS_NO, $SESS_ORG_STRUCTURE;
	...
	if($DPISDB=="odbc"){
		...
		$cmd = " select		
				...
				where		a.ORG_ID=b.ORG_ID and a.EP_CODE=c.EP_CODE and b.PV_CODE=f.PV_CODE(+) and 
							b.OT_CODE=g.OT_CODE(+)	
							$search_condition
				order by		b.ORG_ID_REF, $order_by   ";
	}elseif($DPISDB=="mysql"){
