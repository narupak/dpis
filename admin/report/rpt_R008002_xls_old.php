...
//		elseif($DPISDB=="oci8") $arr_search_condition[] = "(SUBSTR(trim(a.INV_DATE), 1, 10) <= '$search_date_max')";
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ลำดับที่","ชื่อ - สกุล","ตำแหน่ง","$ORG_TITLE","ฐานความผิด","กรณีความผิด","โทษที่ได้รับ","วันที่มีผล");
		$ws_head_line2 = array("","","","","","","","บังคับใช้");
		...
		$ws_width = array(8,30,30,30,19,19,19,19);
...
/*		
		...
		$worksheet->write($xlsRow, 4, "ฐานความผิด", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 5, "กรณีความผิด", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 6, "โทษที่ได้รับ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 7, "วันที่มีผล", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		...
		$worksheet->write($xlsRow, 7, "บังคับใช้", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
*/
	} // function		
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	if($count_data){
		...
		// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนข้อมูล
			...
			$wsdata_align_1 = array("C","C","C","C","C","C","C","C");
...
/*
			...
			$worksheet->write_string($xlsRow, 7, "$NAME_7", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
*/
		} // end for
	}else{
		$xlsRow = 0;
