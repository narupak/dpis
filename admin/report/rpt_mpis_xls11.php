<?
	$report_code = "data ลูกจ้างชั่วคราว Flow In";
	...
	$cmd = " select 	PER_ID, PER_GENDER, PER_BIRTHDATE, PER_STARTDATE, LEVEL_NO, 
					...
					ORG_ID, MOV_CODE, POT_ID, PER_OCCUPYDATE 
			from		PER_PERSONAL  
			where	PER_TYPE=4 and PER_OCCUPYDATE >= '$budget_year_from' and PER_OCCUPYDATE <= '$budget_year_to' "; 
