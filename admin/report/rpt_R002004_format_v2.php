...
//	fix head for rpt_R002004
	...
	if ($SESS_DEPARTMENT_NAME=="กรมการปกครอง") {
		$heading_text[1] = "<**1**>ช่วงอายุ|21 - 30";
		$heading_text[2] = "<**1**>ช่วงอายุ|31 - 40";
		$heading_text[3] = "<**1**>ช่วงอายุ|41 - 50";
		$heading_text[4] = "<**1**>ช่วงอายุ|51 - 60";
		$heading_text[5] = "อายุเฉลี่ย|";
		...
		$heading_width[8] = "20";
		$heading_width[9] = "20";
                 * $heading_text[1] = "<**1**>ช่วงอายุ|<=24";
		$heading_text[2] = "<**1**>ช่วงอายุ|25 - 29";
		$heading_text[3] = "<**1**>ช่วงอายุ|30 - 34";
		$heading_text[4] = "<**1**>ช่วงอายุ|35 - 39";
		$heading_text[5] = "<**1**>ช่วงอายุ|40 - 44";
		$heading_text[6] = "<**1**>ช่วงอายุ|45 - 49";
		$heading_text[7] = "<**1**>ช่วงอายุ|50 - 54";
		$heading_text[8] = "<**1**>ช่วงอายุ|>=55";
		$heading_text[9] = "อายุเฉลี่ย|";

		$heading_align = array("C","C","C","C","C","C","C","C","C","C");	
		
		$data_align = array("L","R","R","R","R","R","R","R","R","R");*/
		...
		$heading_width[11] = "20";
                ...
                $heading_text[1] = "<**1**>ช่วงอายุ|<21";
		$heading_text[2] = "<**1**>ช่วงอายุ|21-25";
		$heading_text[3] = "<**1**>ช่วงอายุ|26-30";
		$heading_text[4] = "<**1**>ช่วงอายุ|31-35";
		$heading_text[5] = "<**1**>ช่วงอายุ|36-40";
		$heading_text[6] = "<**1**>ช่วงอายุ|41-45";
		$heading_text[7] = "<**1**>ช่วงอายุ|46-50";
		$heading_text[8] = "<**1**>ช่วงอายุ|51-55";
                $heading_text[9] = "<**1**>ช่วงอายุ|56-60";
                $heading_text[10] = "<**1**>ช่วงอายุ|>60";
                $heading_text[11] = "รวม|(จำนวน)";
		$heading_text[12] = "อายุตัว|เฉลี่ย(ปี)";
