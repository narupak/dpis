<?
	...
	include ("rpt_data_move_comdtl_N_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ลำดับ",$FULLNAME_HEAD,"วุฒิ/สาขา",$COM_HEAD_01."เดิม","<**1**>","<**1**>",$COM_HEAD_02."ที่ย้าย","<**2**>","<**2**>","ตั้งแต่วันที่","หมายเหตุ");
		...
		$ws_border_line1 = array("TLR","TLR","TLR","TB","TB","TBR","TBL","TB","TB","TLR","TLR");
		...
		$ws_width = array(5,20,20,20,6,8,20,6,8,15,20);
...
//	$ORG_ID = $ORG_ID_1 = $ORG_ID_2 = -1;
	...
	while($data = $db_dpis->get_array()){
		...
		$CMD_POSITION = $data[CMD_POSITION];
                ...
                //echo 'CMD_POSITION:'.$CMD_POSITION.'<pre>';
		...
		$NEW_PM_NAME = $arr_temp[2];*/
                ...
                //echo '<br>เดิม CMD_POSITION:'.$CMD_POSITION.',NEW_POS_NO:'.$NEW_POS_NO.',NEW_PM_NAME:'.$NEW_PM_NAME;
                
                //echo '<br>ใหม่ CMD_POSITION:'.$TMP_PL_NAME.',NEW_POS_NO:'.$TMP_NEW_POS_NO.',NEW_PM_NAME:'.$TMP_NEW_PM_NAME;
                //die();
		...
		if($PER_TYPE==1){
			...
			$NEW_PT_NAME = trim($data2[PT_NAME]);
                        ...
                        /*เดิม ทำการปิดไว้เพราะมีการส่งค่ามาเป็น Array แล้ว*/
