...
//		echo "format.. ไม่ใช่กรมการปกครอง...COM_LEVEL_SALP=$COM_LEVEL_SALP<br>";
    if ($COM_LEVEL_SALP == 6) {
        if ($CARDNO_FLAG == 1) {
            $heading_width = array(6, 30, 15, 15, 50, 10, 15, 15, 15, 10, 15, 15, 10, 10, 10, 50);
            $heading_text = array("ลำดับ|ที่", $FULLNAME_HEAD . "|", "เลขประจำตัว|ประชาชน", "ประเภท|ตำแหน่ง", $COM_HEAD_01 . "|สังกัด / ตำแหน่ง", "<**1**>|เลขที่", "<**1**>|ระดับตำแหน่ง", "เงินเดือน|เต็มขั้น", "เงินตอบแทน|พิเศษ", "เงินเดือน|ก่อนเลื่อน", "ให้ได้รับ|เงินเดือน", "จำนวนเงิน|ที่เลื่อน", "เปอร์เซ็นต์|ที่เลื่อน", "ฐานในการ|คำนวณ", "ผลการ|ประเมิน", "หมายเหตุ|");
            ...
            $heading_width = array(6, 30, 15, 50, 10, 15, 15, 15, 10, 15, 15, 10, 10, 10, 50);
            $heading_text = array("ลำดับ|ที่", $FULLNAME_HEAD . "|$CARDNO_TITLE", "", "ประเภท|ตำแหน่ง", $COM_HEAD_01 . "|สังกัด / ตำแหน่ง", "<**1**>|เลขที่", "<**1**>|ระดับตำแหน่ง", "เงินเดือน|เต็มขั้น", "เงินตอบแทน|พิเศษ", "เงินเดือน|ก่อนเลื่อน", "ให้ได้รับ|เงินเดือน", "จำนวนเงิน|ที่เลื่อน", "เปอร์เซ็นต์|ที่เลื่อน", "ฐานในการ|คำนวณ", "ผลการ|ประเมิน", "หมายเหตุ|");
        ...
        if ($BKK_FLAG == 1) {
            ...
            if ($CARDNO_FLAG == 1) {
                $heading_width = array(6, 30, 15, 15, 50, 10, 15, 15, 15, 10, 50);
                $heading_text = array("ลำดับ|ที่", $FULLNAME_HEAD . "|", "เลขประจำตัว|ประชาชน", "ประเภท|ตำแหน่ง", $COM_HEAD_01 . "|สังกัด / ตำแหน่ง", "<**1**>|เลขที่", "<**1**>|ระดับตำแหน่ง", "เงินเดือน|เต็มขั้น", "เงินตอบแทน|พิเศษ", "ผลการ|ประเมิน", "หมายเหตุ|");
                $heading_align = array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C');
                $column_function = array((($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"));
                $data_align = array("C", "L", "C", "C", "L", "C", "L", "R", "R", "R", "L");
            } else {
                $heading_width = array(6, 30, 15, 50, 10, 15, 15, 15, 10, 50);
                $heading_text = array("ลำดับ|ที่", $FULLNAME_HEAD . "|$CARDNO_TITLE", "ประเภท|ตำแหน่ง", $COM_HEAD_01 . "|สังกัด / ตำแหน่ง", "<**1**>|เลขที่", "<**1**>|ระดับตำแหน่ง", "เงินเดือน|เต็มขั้น", "เงินตอบแทน|พิเศษ", "ผลการ|ประเมิน", "หมายเหตุ|");
                $heading_align = array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C');
                $column_function = array((($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"));
                $data_align = array("C", "L", "C", "L", "C", "L", "R", "R", "R", "L");
            }
        ...
        if ($CARDNO_FLAG == 1) {
            $heading_width = array(6, 30, 15, 40, 12, 13, 8, 10, 10, 10, 20);
            ...
            $heading_align = array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C');
            $column_function = array((($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"));
            $data_align = array("C", "L", "C", "C", "L", "C", "L", "R", "R", "R", "L");
        } else {
            $heading_width = array(6, 30, 40, 12, 13, 8, 10, 10, 10, 20);
            ...
            $heading_align = array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C');
            $column_function = array((($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"));
            $data_align = array("C", "L", "C", "L", "C", "L", "R", "R", "R", "L");
        }
