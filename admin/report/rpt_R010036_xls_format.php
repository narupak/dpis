...
//	fix head for rpt_R010036
	...
	for($i=0; $i<$cnt_level_grp; $i++){
		...
		for($j=0; $j<count($ARR_LEVEL[$LEVEL_GROUP]); $j++){
			...
			$heading_text[$cnt_level_det*3+2] = "<**1**>ตำแหน่งประเภท|<**".($i+1)."**>".$ARR_LEVEL_GROUP_NAME[$LEVEL_GROUP]."|<**".($cnt_level_det+1)."**>".$ARR_LEVEL_NAME[$LEVEL_NO][1]."|ครอง";
			$heading_text[$cnt_level_det*3+3] = "<**1**>ตำแหน่งประเภท|<**".($i+1)."**>".$ARR_LEVEL_GROUP_NAME[$LEVEL_GROUP]."|<**".($cnt_level_det+1)."**>".$ARR_LEVEL_NAME[$LEVEL_NO][1]."|ว่าง";
			$heading_text[$cnt_level_det*3+4] = "<**1**>ตำแหน่งประเภท|<**".($i+1)."**>".$ARR_LEVEL_GROUP_NAME[$LEVEL_GROUP]."|<**".($cnt_level_det+1)."**>".$ARR_LEVEL_NAME[$LEVEL_NO][1]."|กรอบ";
			$heading_width[$cnt_level_det*3+2] = "8";
			$heading_width[$cnt_level_det*3+3] = "8";
			$heading_width[$cnt_level_det*3+4] = "8";
...
//			echo "idx:".($cnt_level_det*3+4)."->".$heading_text[$cnt_level_det*3+4]."<br>";
	...
	$heading_text[$cnt_level_det*3+2] = "<**2**>|<**".($cnt_level_grp+1)."^**>รวม|<**".($cnt_level_det+1)."^**>|ครอง";
	$heading_text[$cnt_level_det*3+3] = "<**2**>|<**".($cnt_level_grp+1)."^**>รวม|<**".($cnt_level_det+1)."^**>|ว่าง";
	$heading_text[$cnt_level_det*3+4] = "<**2**>|<**".($cnt_level_grp+1)."^**>รวม|<**".($cnt_level_det+1)."^**>|กรอบ";
//	echo "idx:".($cnt_level_det*3+2)."->".$heading_text[$cnt_level_det*3+2]."<br>";
//	echo "idx:".($cnt_level_det*3+3)."->".$heading_text[$cnt_level_det*3+3]."<br>";
//	echo "idx:".($cnt_level_det*3+4)."->".$heading_text[$cnt_level_det*3+4]."<br>";
	$heading_width[$cnt_level_det*3+2] = "8";
