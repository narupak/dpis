...
//	$arr_search_condition[] = "(a.PER_TYPE in (". implode(", ", $search_per_type) .") and (b.POS_ID >= 0 or e.POEM_ID >= 0))";
	...
	function print_header(){
		...
		$worksheet->write($xlsRow, 2, "วุฒิการศึกษา", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 3, "วันที่เลื่อนระดับ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
	} // function		
