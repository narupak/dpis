...
//		 		$arr_content[$data_count][5] = $arr_content[$data_count][5] + ($arr_content[$data_count][$sumcolcnt] * $arr_percent[$sumcolcnt] / 100);
				$arr_series_caption_data[$kk][$data_count] = ($arr_content[$data_count][$sumcolcnt] ? $arr_content[$data_count][$sumcolcnt] : 0);
			}
//			$arr_content[$data_count][gap] = floor($arr_content[$data_count][5] - $arr_content[$data_count][0]); 
		...
		$selectedFormat = "SWF";
		$series_caption_list = "ตนเอง;ผู้บังคับบัญชา;เพื่อนร่วมงาน;ผู้ใต้บังคับบัญชา";
