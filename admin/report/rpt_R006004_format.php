...
//	fix head for rpt_R006004
	...
	$heading_text[] = "<**1**>ปีงบประมาณ|<**2**>$search_budget_year|ครั้งที่ 2";
	$heading_text[] = "<**1**>ปีงบประมาณ|<**2**>$search_budget_year|ครั้งที่ 1";
	$heading_text[] = "<**1**>ปีงบประมาณ|<**3**>$search_budget_year_1|ครั้งที่ 2";
	$heading_text[] = "<**1**>ปีงบประมาณ|<**3**>$search_budget_year_1|ครั้งที่ 1";
	$heading_text[] = "<**1**>ปีงบประมาณ|<**4**>$search_budget_year_2|ครั้งที่ 2";
	$heading_text[] = "<**1**>ปีงบประมาณ|<**4**>$search_budget_year_2|ครั้งที่ 1";
	$heading_text[] = "<**1**>ปีงบประมาณ|<**5**>$search_budget_year_3|ครั้งที่ 2";
	$heading_text[] = "<**1**>ปีงบประมาณ|<**5**>$search_budget_year_3|ครั้งที่ 1";
	$heading_text[] = "<**1**>ปีงบประมาณ|<**6**>$search_budget_year_4|ครั้งที่ 2";
	$heading_text[] = "<**1**>ปีงบประมาณ|<**6**>$search_budget_year_4|ครั้งที่ 1";
	...
	if($have_pic)
	$data_align = array("R","C","L","C","L","R","C","C","C","C","C","C","C","C","C","C");
	else
	$data_align = array("R","L","C","L","R","C","C","C","C","C","C","C","C","C","C");
