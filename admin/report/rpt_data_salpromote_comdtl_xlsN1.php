	...
	function print_header(){
		...
		if ($COM_LEVEL_SALP==3 || $COM_LEVEL_SALP==4 || $COM_LEVEL_SALP==8) {
			...
			if ($COM_TYPE=="1005")
				...
				$worksheet->write($xlsRow, 10, "จำนวน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
			$worksheet->write($xlsRow, 11, "ฐานในการ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		...
		if ($COM_LEVEL_SALP==3 || $COM_LEVEL_SALP==4 || $COM_LEVEL_SALP==8) {
			...
			if ($COM_TYPE=="1005")
				...
				$worksheet->write($xlsRow, 10, "ขั้น", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
			$worksheet->write($xlsRow, 11, "คำนวณ", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
...
//		$CMD_ORG3 = $data[CMD_ORG3];
		...
		$arr_temp = explode("ระดับ", $LEVEL_NAME);
		$LEVEL_NAME = $arr_temp[1];
		if($PER_TYPE==1){
