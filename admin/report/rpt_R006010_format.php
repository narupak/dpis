...
//	fix head for rpt_R006010
	...
	if ($have_pic) {
		$heading_text[] = "รูป|";
		$heading_text[] = "สังกัด/ชื่อ - สกุล";
	} else {
		$heading_text[] = "สังกัด/ชื่อ - สกุล";
	}
	$heading_text[] = "ตำแหน่ง/ระดับ";
	$heading_text[] = "เลขที่ตำแหน่ง";
	$heading_text[] = "เงินเดือน(บาท)";
	...
	if($have_pic)
	$data_align = array("C","L","L","C","R");
	else
	$data_align = array("L","L","C","R");
