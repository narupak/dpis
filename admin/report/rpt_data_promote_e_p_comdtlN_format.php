...
//	fix head for P03010
	...
	if($COM_TYPE=="5042"){
		...
		$heading_text[4] = $COM_HEAD_01."เดิม|เลขที่|";
		$heading_text[5] = "ดำรงตำแหน่ง|ในระดับ|ปัจจุบันเมื่อ";
		$heading_text[6] = "|เงินเดือน";
		$heading_text[7] = "<**2**>ตำแหน่งที่เลื่อน/แต่งตั้ง|ตำแหน่ง/สังกัด|";
		$heading_text[8] = "<**2**>ตำแหน่งที่เลื่อน/แต่งตั้ง|เลขที่|";
		$heading_text[9] = "<**2**>ตำแหน่งที่เลื่อน/แต่งตั้ง|เงินเดือน";
		...
		$heading_text[8] = $COM_HEAD_02."ที่เลื่อน|ตำแหน่ง/สังกัด|";
		$heading_text[9] = $COM_HEAD_02."ที่เลื่อน|ตำแหน่ง|ประเภท";
		$heading_text[10] = $COM_HEAD_02."ที่เลื่อน|ระดับ|";	
		$heading_text[11] = $COM_HEAD_02."ที่เลื่อน|เลขที่|";
		$heading_text[12] = $COM_HEAD_02."ที่เลื่อน|เงินเดือน";
		...
		$heading_text[6] = $COM_HEAD_01."เดิม|เลขที่|";
		$heading_text[7] = $COM_HEAD_01."เดิม|เงินเดือน";
		$heading_text[8] = "ดำรงตำแหน่ง|ในระดับ|ปัจจุบันเมื่อ";
		$heading_text[9] = $COM_HEAD_02."ที่เลื่อน|ตำแหน่ง/สังกัด|";
		$heading_text[10] = $COM_HEAD_02."ที่เลื่อน|ตำแหน่ง|ประเภท";
		$heading_text[11] = $COM_HEAD_02."ที่เลื่อน|ระดับ|";	
		$heading_text[12] = $COM_HEAD_02."ที่เลื่อน|เลขที่|";
		$heading_text[13] = $COM_HEAD_02."ที่เลื่อน|เงินเดือน";
		$heading_text[14] = "|ตั้งแต่วันที่|";
