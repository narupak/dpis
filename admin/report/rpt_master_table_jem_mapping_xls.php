<?
	...
	function print_header($xlsRow){
		...
		$worksheet->write($xlsRow, 1, "Map Name", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 2, "Map Level", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 3, "Grade", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
	} // end if
