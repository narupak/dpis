<?php
    ...
    $filename_csv="datacsv_p0119.csv";  
    header('Content-Type: text/csv; charset=utf-8');
    header('Content-Disposition: attachment; filename='.$filename_csv); 
    
    $output = fopen('php://output', 'w');
if($search_per_type == 1){
    $column_name =array('เลขที่ตำแหน่ง','คำนำหน้าชื่อ(ไทย)','ชื่อ(ไทย)','นามสกุล(ไทย)','คำนำหน้าชื่อ(อังกฤษ)','ชื่อ(อังกฤษ)','นามสกุล(อังกฤษ)','เลขประจำตัวประชาชน',
                        'เพศ','วัน/เดือน/ปีเกิด','อายุข้าราชการ','ตำแหน่งในสายงาน','ตำแหน่งในการบริหารงาน','ประเภทตำแหน่ง','ระดับตำแหน่ง','กระทรวง','กรม','สำนัก/กอง',
                        'ต่ำกว่าสำนัก/กอง 1 ระดับ','ต่ำกว่าสำนัก/กอง 2 ระดับ','เงินเดือน','เงินประจำตำแหน่ง','วันเกษียณอายุ','วันที่เริ่มรับราชการ','อายุราชการ(อายุงาน)','วันที่เข้าส่วนราชการ','ระดับการศึกษา',
                        'วุฒิการศึกษา','วุฒิที่ใช้บรรจุสาขาวิชาเอก','สถาบันการศึกษา','ประเทศที่สำเร็จการศึกษา','ปีที่สำเร็จการศึกษา','ประเภททุนของวุฒิที่ใช้บรรจุ','ระดับการศึกษา',
                        'วุฒิการศึกษา','วุฒิในตำแหน่งปัจจุบันสาขาวิชาเอก','สถาบันการศึกษา','ประเทศที่สำเร็จการศึกษา','ปีที่สำเร็จการศึกษา','ประเภททุนของวุฒิในตำแหน่งปัจจุบัน',
                        'ระดับการศึกษา','วุฒิการศึกษา','วุฒิสูงสุดสาขาวิชาเอก','สถาบันการศึกษา','ประเทศที่สำเร็จการศึกษา','ปีที่สำเร็จการศึกษา','ประเภททุนของวุฒิสูงสุด',
                        'ด้านความเชี่ยวชาญพิเศษ','ด้านรอง','ด้านย่อย','เน้นทาง','ปีที่รับเครื่องราชฯ','เครื่องราช ฯ','สายงานระดับ','ระดับ 1','สำนัก/กอง','สายงานระดับ','ระดับ 2','สำนัก/กอง',
                        'สายงานระดับ','ระดับ 3','สำนัก/กอง','สายงานระดับ','ระดับ 4','สำนัก/กอง','สายงานระดับ','ระดับ 5','สำนัก/กอง','สายงานระดับ','ระดับ 6','สำนัก/กอง','สายงานระดับ','ระดับ 7','สำนัก/กอง','สายงานระดับ','ระดับ 8','สำนัก/กอง',
                        'สายงานระดับ','ระดับ 9','สำนัก/กอง','สายงานระดับ','ระดับ 10','สำนัก/กอง','สายงานระดับ','ระดับ 11','สำนัก/กอง','สายงานระดับ','ปฏิบัติงาน','สำนัก/กอง','สายงานระดับ','ชำนาญงาน','สำนัก/กอง','สายงานระดับ',
                        'อาวุโส','สำนัก/กอง','สายงานระดับ','ทักษะพิเศษ','สำนัก/กอง','สายงานระดับ','ปฏิบัติการ','สำนัก/กอง','สายงานระดับ','ชำนาญการ','สำนัก/กอง','สายงานระดับ','ชำนาญการพิเศษ','สำนัก/กอง','สายงานระดับ','เชี่ยวชาญ','สำนัก/กอง',
                        'สายงานระดับ','ทรงคุณวุฒิ','สำนัก/กอง','สายงานระดับ','อำนวยการต้น','สำนัก/กอง','สายงานระดับ','อำนวยการสูง','สำนัก/กอง','สายงานระดับ','บริหารต้น','สำนัก/กอง','สายงานระดับ','บริหารสูง','สำนัก/กอง','วันที่เข้าสู่ระดับปัจจุบัน',
                        'ฐานในการคำนวณ','สำนัก/กองมอบหมายงาน','เลขที่แฟ้ม','เบอร์โทรศัพท์มือถือ','อีเมล์','เลขที่ประจำตัวข้าราชการ','ความเชี่ยวชาญด้านหลัก-1','ความเชี่ยวชาญด้านรอง-1',
                        'รายละเอียด/คำอธิบาย-1','ระดับความสามารถ-1','ประเภทความเชี่ยวชาญ-1','ความเชี่ยวชาญด้านหลัก-2','ความเชี่ยวชาญด้านรอง-2','รายละเอียด/คำอธิบาย-2','ระดับความสามารถ-2','ประเภทความเชี่ยวชาญ-2');
    ...
    $column_name =array('เลขที่ตำแหน่ง','คำนำหน้าชื่อ(ไทย)','ชื่อ(ไทย)','นามสกุล(ไทย)','คำนำหน้าชื่อ(อังกฤษ)','ชื่อ(อังกฤษ)','นามสกุล(อังกฤษ)','เลขประจำตัวประชาชน',
                        ...
                        'วุฒิการศึกษา','วุฒิในตำแหน่งปัจจุบันสาขาวิชาเอก','สถาบันการศึกษา','ประเทศที่สำเร็จการศึกษา','ปีที่สำเร็จการศึกษา','ประเภททุนของวุฒิในตำแหน่งปัจจุบัน',
                        'ระดับการศึกษา','วุฒิการศึกษา','วุฒิสูงสุดสาขาวิชาเอก','สถาบันการศึกษา','ประเทศที่สำเร็จการศึกษา','ปีที่สำเร็จการศึกษา','ประเภททุนของวุฒิสูงสุด',
                        'ด้านความเชี่ยวชาญพิเศษ','ด้านรอง','ด้านย่อย','เน้นทาง','ปีที่รับเครื่องราชฯ','เครื่องราช ฯ','วันที่เข้าสู่ระดับปัจจุบัน',
                        'ฐานในการคำนวณ','สำนัก/กองมอบหมายงาน','เลขที่แฟ้ม','เบอร์โทรศัพท์มือถือ','อีเมล์','เลขที่ประจำตัวข้าราชการ','ความเชี่ยวชาญด้านหลัก-1','ความเชี่ยวชาญด้านรอง-1',
                        'รายละเอียด/คำอธิบาย-1','ระดับความสามารถ-1','ประเภทความเชี่ยวชาญ-1','ความเชี่ยวชาญด้านหลัก-2','ความเชี่ยวชาญด้านรอง-2','รายละเอียด/คำอธิบาย-2','ระดับความสามารถ-2','ประเภทความเชี่ยวชาญ-2');

}
    fputcsv($output, $column_name);
//    $cmd = " SELECT PER_NAME,PER_SURNAME,PER_CARDNO FROM PER_PERSONAL ";
//    $db_dpis->send_cmd($cmd);
//    $count = 0;
//    while($data = $db_dpis->get_array()) { 
//        $count++;
//        $data_1=array("NUM"=>1);
//        $data_push = $data_1+$data;
//        fputcsv($output, $data_push);
//    }
    /*CSV End*/
...
//		$db_dpis->show_error();
	...
	if($DPISDB=="odbc"){	
		...
		if($search_per_type==1){
			...
			$cmd = " select a.PER_ID, a.PN_CODE, a.PER_NAME, a.PER_SURNAME,a.PER_ENG_NAME,a.PER_ENG_SURNAME, a.LEVEL_NO, a.PER_TYPE, a.PER_STATUS, a.ORG_ID as ORG_ID_ASS, a.PER_FILE_NO, 
                                    a.POEM_ID as POS_ID, c.POEM_NO_NAME as POS_NO_NAME, c.POEM_NO as POS_NO, c.PN_CODE as PL_CODE, c.ORG_ID, c.ORG_ID_1, 
                                    a.PER_CARDNO,a.PER_SALARY, a.PER_MGTSALARY, a.PER_BIRTHDATE, a.PER_POSDATE,a.PER_RETIREDATE,a.PER_STARTDATE, a.PER_OCCUPYDATE,
                                    a.PER_GENDER ,a.PER_MOBILE,a.PER_EMAIL  ,a.PER_OFFNO
...
//	$db_dpis->show_error();
	...
	if($count_data){
		...
		if ($MFA_FLAG==1) {
			...
			$wsdata_fontfmt_1 = array("B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B","B");
			$wsdata_border_1 = array("TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB","TLRB");
...
//			$BIRTHDATE = show_date_format($data[PER_BIRTHDATE],$DATE_DISPLAY);
            $PER_RETIREDATE = show_date_format($data[PER_RETIREDATE],6);
            $BIRTHDATE = show_date_format($data[PER_BIRTHDATE],6); //31/01/2018
...
//			$OCCUPYDATE = show_date_format($data[PER_OCCUPYDATE],$DATE_DISPLAY);
            $STARTDATE = show_date_format($data[PER_STARTDATE],6);
            $OCCUPYDATE = show_date_format($data[PER_OCCUPYDATE],6);
		...
		//	$db_dpis2->show_error();
            ...
            $CURR_EFFECTIVEDATE = show_date_format(trim($data2[POH_EFFECTIVEDATE]),6);
		...
		//		echo $cmd."<hr>";
			...
			for ( $i=0; $i<count($level); $i++ ) { 
				...
				if (trim($data2[POH_EFFECTIVEDATE])) {	
										...
										$ORG_1[$level[$i]] = $data2[POH_ORG3];
					//$LEVEL_DATE[$level[$i]] = show_date_format($data2[POH_EFFECTIVEDATE],$DATE_DISPLAY);
                    $LEVEL_DATE[$level[$i]] = show_date_format($data2[POH_EFFECTIVEDATE],6);
				}
			} // end for
