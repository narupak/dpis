<?
	...
	function print_header($xlsRow){
		...
		$worksheet->write($xlsRow, 6, "เงินกู้เพื่อที่อยู่อาศัย", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
...
//			$worksheet->write($xlsRow, 0, (($NUMBER_DISPLAY==2)?convert2thaidigit("$POS_NO"):"$POS_NO"), set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
			...
			$worksheet->write($xlsRow, 6, "$PD_AMOUNT3", set_format("xlsFmtTableDetail", "", "R", "TLRB", 0));
