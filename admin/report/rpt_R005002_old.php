...
//	session_cache_limiter("nocache");
	...
	function print_header(){
		...
		$pdf->Cell((($heading_width[2] + $heading_width[3]) * 4) ,7,"เครื่องราชอิสริยาภรณ์",'LTR',0,'C',1);
		...
		$pdf->Cell($heading_width[1] ,7,"กรม/ส่วนราชการที่เทียบเท่า",'LR',0,'C',1);
		$pdf->Cell(($heading_width[2] + $heading_width[3]) ,7,"ม.ป.ช.",'LTR',0,'C',1);
		$pdf->Cell(($heading_width[2] + $heading_width[3]) ,7,"ม.ว.ม.",'LTR',0,'C',1);
		$pdf->Cell(($heading_width[2] + $heading_width[3]) ,7,"ป.ช.",'LTR',0,'C',1);
		$pdf->Cell(($heading_width[2] + $heading_width[3]) ,7,"ป.ม.",'LTR',0,'C',1);
