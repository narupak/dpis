<?
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		...
		$ws_head_line1 = array("ลำดับ",$FULLNAME_HEAD,$COM_HEAD_01,"<**1**>","<**1**>","<**1**>","มอบหมายให้ปฏิบัติราชการ","ตั้งแต่วันที่ - ","หมายเหตุ");
		$ws_head_line2 = array("ที่","$CARDNO_TITLE","ตำแหน่ง/สังกัด","ตำแหน่งประเภท","ระดับตำแหน่ง","เลขที่ตำแหน่ง","","ถึงวันที่","");
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	header("Content-Type: application/x-msexcel; name=\"บัญชีรายละเอียดการมอบหมายงาน/ปฏิบัติราชการแทน.xls\"");
	header("Content-Disposition: inline; filename=\"บัญชีรายละเอียดการมอบหมายงาน/ปฏิบัติราชการแทน.xls\"");
	$fh=fopen($fname, "rb");
	fpassthru($fh);
	fclose($fh);
	unlink($fname);
