<?
	...
	include ("rpt_data_move_salary_format.php");	// กำหนดหัวและตัวแปรสำหรับการเปลี่ยนรูปแบบรายงาน
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ลำดับ","ชื่อ - สกุล","","<**1**>อัตราเงินเดือนเดิม","<**1**>","<**1**>","<**1**>","<**2**>อัตราเงินเดือนที่ตัดโอนไปตั้งจ่ายใหม่","<**2**>","<**2**>","<**2**>","","");
		$ws_head_line2 = array("ที่","","ระดับ","ตำแหน่ง/สังกัด","ประเภท","ระดับ","เลขที่","ตำแหน่ง/สังกัด","ประเภท","ระดับ","เลขที่","เงินเดือน","หมายเหตุ");
		$ws_head_line3 = array("","","","","ตำแหน่ง","","ตำแหน่ง","","ตำแหน่ง","","ตำแหน่ง","","");
