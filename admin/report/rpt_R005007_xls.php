<?
	...
	include ("rpt_R005007_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
...
//	$arr_search_condition[] = "(a.PER_STATUS in (". implode(", ", $search_per_status) ."))";
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("","","","วันที่เกษียณ","วันเข้าสู่ระดับ","วันเข้าสู่ระดับ","ปัจจุบันได้รับเครื่องราชฯ","ปัจจุบันได้รับเครื่องราชฯ");
		$ws_head_line2 = array("หน่วยงาน/ชื่อ","ตำแหน่ง","วันบรรจุ","อายุราชการ","ก่อนปัจจุบัน","ปัจจุบัน","ชั้น","วันที่ได้รับ");
		...
		$ws_width = array(45,45,10,10,10,10,10,10);
