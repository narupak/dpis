...
//	fix head for rpt_R006011
	...
	while($data = $db_dpis->get_array()){ 
		...
		if ($data[LEVEL_NO]=="O2") $LNAME = "ชำนาญ\nงาน";
		elseif ($data[LEVEL_NO]=="O4") $LNAME = "ทักษะ\nพิเศษ";
		elseif ($data[LEVEL_NO]=="K2") $LNAME = "ชำนาญ\nการ";
		elseif ($data[LEVEL_NO]=="K3") $LNAME = "ชำนาญ\nการพิเศษ";
		elseif ($data[LEVEL_NO]=="K4") $LNAME = "เชี่ยว\nชาญ";
		elseif ($data[LEVEL_NO]=="K5") $LNAME = "ทรง\nคุณวุฒิ";
		elseif ($data[LEVEL_NO]=="D1") $LNAME = "อำนวย\nการต้น";
		elseif ($data[LEVEL_NO]=="D2") $LNAME = "อำนวย\nการสูง";
		elseif ($data[LEVEL_NO]=="M1") $LNAME = "บริหาร\nต้น";
		elseif ($data[LEVEL_NO]=="M2") $LNAME = "บริหาร\nสูง";
