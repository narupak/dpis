...
//	$company_name = "รูปแบบการออกรายงาน : $list_type_text";
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
    	$ws_head_line1 = array("ลำดับที่","วันที่/เวลามา","วันที่/เวลากลับ","รอบ","หมายเหตุ");
...
//		print_header();
		...
		// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนข้อมูล
			...
			$wsdata_align_1 = array("C","C","C","C","C");
			$wsdata_align_2 = array("L","L","L","L","L");
