<?
	...
	$lang_code="TH";
	$company_name = "";
	$report_title = "บัญชีรายละเอียดการเลื่อนระดับข้าราชการแนบท้ายคำสั่ง $DEPARTMENT_NAME ที่ $COM_NO ลงวันที่ $COM_DATE";
	$report_code = "";
	$orientation='L';
...
//	session_cache_limiter("nocache");
	...
	function print_header(){
		...
		$pdf->Cell($heading_width[6] ,7,"ที่เลื่อน",'LTR',0,'C',1);
		$pdf->Cell($heading_width[7] ,7,"ก่อนเลื่อน",'LTR',0,'C',1);
