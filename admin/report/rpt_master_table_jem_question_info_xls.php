<?
	...
	function print_header($xlsRow){
		...
		$worksheet->write($xlsRow, 1, "Name", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 2, "Topic", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 3, "Description", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
	} // end if
