...
//	fix head for rpt_R00test
	...
	$heading_text[1] = "ข้อความ";
	$heading_text[2] = "จำนวน";
	$heading_text[3] = "ปริมาณ";
	...
	//									TNUM-xn คือ เปลี่ยนเป็นตัวเลขของไทย  x คือ ไม่มี comma ถ้าไม่มี x แสดงว่ามี comma ทุกหลัก 1,000  n คือ จำนวนทศนิยม ถ้ามีค่าเป็น ศูนย์ จะแสดงเป็น - ถ้าเป็น z ทศนิยมจะตามจริง
	//									TNUM0-xn คือ เปลี่ยนเป็นตัวเลขของไทย   x คือ ไม่มี comma ถ้าไม่มี x แสดงว่ามี comma ทุกหลัก 1,000  n คือ จำนวนทศนิยม ถ้ามีค่าเป็น ศูนย์ จะแสดงเป็น 0 ถ้าเป็น z ทศนิยมจะตามจริง
	//									ENUM-xn คือ แสดงเป็นเลขอาราบิค  x คือ ไม่มี comma ถ้าไม่มี x แสดงว่ามี comma ทุกหลัก 1,000  n คือ จำนวนทศนิยม ถ้ามีค่าเป็น ศูนย์ จะแสดงเป็น - ถ้าเป็น z ทศนิยมจะตามจริง
	//									ENUM0-xn คือ แสดงเป็นเลขอาราบิค  x คือ ไม่มี comma ถ้าไม่มี x แสดงว่ามี comma ทุกหลัก 1,000  n คือ จำนวนทศนิยม ถ้ามีค่าเป็น ศูนย์ จะแสดงเป็น 0 ถ้าเป็น z ทศนิยมจะตามจริง
	//
//	echo "NUMBER_DISPLAY=$NUMBER_DISPLAY<br>";
	...
	$column_function[2] = (($NUMBER_DISPLAY==2)?"TNUM-xz":"ENUM-xz");
