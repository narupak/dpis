...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	//				print_header();
					...
					$pdf->report_title = "$DEPARTMENT_NAME||รายงานการมาปฏิบัติราชการของ$per_type_name $NAME" . (($search_date)?"||":"") . (($search_date)?"ประจำวันที่ $show_date ":"");
					$pdf->AddPage();
	//				print_header();
