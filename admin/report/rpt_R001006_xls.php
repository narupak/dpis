<?
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		...
		$ws_width[] = 50;
		for($i=0; $i<5; $i++) {
			$ws_head_line1[] = "<**1**>ปีงบประมาณ";
			$ws_head_line1[] = "<**1**>ปีงบประมาณ";
			$ws_head_line2[] = "<**".($i+1)."**>".(($NUMBER_DISPLAY==2)?convert2thaidigit($arr_budget_year[$i]):$arr_budget_year[$i]);
			$ws_head_line2[] = "<**".($i+1)."**>".(($NUMBER_DISPLAY==2)?convert2thaidigit($arr_budget_year[$i]):$arr_budget_year[$i]);
			$ws_head_line3[] = "จำนวน";
			$ws_head_line3[] = "ร้อยละ";
			$ws_colmerge_line1[] = 1;
			$ws_colmerge_line1[] = 1;
			$ws_colmerge_line2[] = 1;
			$ws_colmerge_line2[] = 1;
