...
//	fix head for rpt_R008002
	...
	$heading_text[5] = "เลขที่คำสั่งสอบสวน|";
	$heading_text[6] = "ฐานความผิด|";
	$heading_text[7] = "กรณีความผิด|";
	$heading_text[8] = "เลขที่คำสั่งทางวินัย|";
	$heading_text[9] = "โทษที่ได้รับ|";
	$heading_text[10] = "วันที่มีผล|บังคับใช้";
