<?
	...
	function print_header(){
		...
		$worksheet->write($xlsRow, 3, "ตำแหน่งในสายงาน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 4, "ตำแหน่งในทางบริหาร", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
	...
	if($count_data){
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if(array_search($REPORT_ORDER, $arr_rpt_order) !== false  && array_search($REPORT_ORDER, $arr_rpt_order) == 0 && count($arr_rpt_order) > 1){
				...
				$worksheet->write_string($xlsRow, 3, "$PER_LINE", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 0));
				$worksheet->write_string($xlsRow, 4, "$PER_MGT", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 0));
				$worksheet->write_string($xlsRow, 5, "$ORG_NAME", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 0));
			}else{
				$xlsRow++;
				$worksheet->write_string($xlsRow, 0, "$COUNT", set_format("xlsFmtTableDetail", "B", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 1, "$EAF_NAME", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 0));
