...
//	echo "cmd=$cmd<br>";
	...
	include ("rpt_data_salpromote_new_comdtl_xlsN_format.php");	// กำหนดหัวและตัวแปรสำหรับการเปลี่ยนรูปแบบรายงาน
	...
	$ws_head_line1 = array("ลำดับ",$FULLNAME_HEAD,"เลขประจำตัว",$COM_HEAD_01,$COM_HEAD_01,$COM_HEAD_01,$COM_HEAD_01,$COM_HEAD_01,"เงินเดือน","ค่าตอบแทน","ให้ได้รับ","หมายเหตุ");
