<?
	...
	$report_title = "ตารางแสดงรายการผลการประเมินสมรรถนะของข้าราชการ $DEPARTMENT_NAME";
	...
	$report_code = "R_Person_Competency";
...
//			echo "$U_PER_ID != ".$arr_content[$data_count][perid]."<br>";
			if ($U_PER_ID != $arr_content[$data_count][perid]) {
				...
				if ($U_PER_ID == $PER_ID) {
					$U_PER_NAME = "ประเมินตนเอง";
				} else {
					$U_PER_NAME = $arr_content[$data_count][pername];
				}
				$xlsRow++;
				$worksheet->write($xlsRow, 0, "$U_PER_ID : $U_PER_NAME", set_format("xlsFmtSubTitle", "B", "L", "", 1));
				$worksheet->write($xlsRow, 1, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
				$worksheet->write($xlsRow, 2, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
				$worksheet->write($xlsRow, 3, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
				$seq_no=0;
