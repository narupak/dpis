...
//	$arr_search_condition[] = "(a.PER_TYPE in (". implode(", ", $search_per_type) .") and (b.POS_ID >= 0 or e.POEM_ID >= 0))";
	...
	include ("rpt_R004015_format.php");	// กำหนดหัวและตัวแปรสำหรับการเปลี่ยนรูปแบบรายงาน
...
//		if ($level_no==0 && $count_person > 0) echo"1..case 0 : $cmd ($count_person)<br>"; 
//		if ($level_no==0) echo"1..case 0 : $cmd ($count_person)<br>"; 
...
//		if ($level_no==0) echo"2..case 0 : $cmd ($count_person)<br>"; 
//		if ($level_no==0 && $count_person > 0) echo"2..case 0 : $cmd ($count_person)<br>"; 
		return $count_person;
	} // function
...
//						echo "MINISTRY_NAME=$MINISTRY_NAME<br>";
