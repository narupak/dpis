...
//			$LAYER_NO = $arr_content[$data_count][layer_no];
			...
			$arr_data = (array) null;
//			echo "PER_OFFNO=$PER_OFFNO (".convert2thaidigit($PER_OFFNO).") NUMBER_DISPLAY=$NUMBER_DISPLAY<br>";
//			$arr_data[] = (($NUMBER_DISPLAY==2)?convert2thaidigit($PER_OFFNO):$PER_OFFNO);//$PER_OFFNO;
			$arr_data[] = $PER_OFFNO;
			$arr_data[] = $NAME;
			$arr_data[] = $POSITION;
			$arr_data[] = $POS_NO;
