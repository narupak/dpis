...
//	fix head for rpt_R007005
	...
	$heading_text[] = "No./Code|";
	$heading_text[] = "วันที่|";
	$heading_text[] = "รหัสกะ|";
	$heading_text[] = "เข้า-ออก|";
	$heading_text[] = "ขาด (วัน)|";
	$heading_text[] = "ลา (วัน)|";
	$heading_text[] = "สาย (นาที)/(ครั้ง)|";
	$heading_text[] = "<**1**>OT (ชม.)|วันปกติ";
	$heading_text[] = "<**1**>OT (ชม.)|วันหยุด";
	...
	$column_function[] = (($NUMBER_DISPLAY==2)?"TNUM-z":"ENUM-z");
	$column_function[] = (($NUMBER_DISPLAY==2)?"TSTR":"TSTR");
	$column_function[] = (($NUMBER_DISPLAY==2)?"TNUM-z":"ENUM-z");
	$column_function[] = (($NUMBER_DISPLAY==2)?"TNUM-z":"ENUM-z");
	$column_function[] = (($NUMBER_DISPLAY==2)?"TNUM-z":"ENUM-z");
	$column_function[] = (($NUMBER_DISPLAY==2)?"TNUM-z":"ENUM-z");
	...
	$data_align = array("C","C","C","C","C","C","C","C","C","L");
