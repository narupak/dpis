<?php
	...
	$CH_PRINT_SIZE = $dataSIZE[CONFIG_VALUE];
    ...
    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('A2', iconv('TIS-620','UTF-8','ส่วนราชการ'.$CHKORG_LOWER1_NAME.' '.$CHKDEPARTMENT_NAME.' '.$CHKMINIS_NAME.' ประจำเดือน '.$month_full[($search_month + 0)][TH].' พ.ศ. '.$search_yearBgn ))
  ...
  //echo "<pre>".$cmdMain;
   ...
   $objPHPExcel->getActiveSheet()->getStyle('B'.$row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
	...
	header('Content-Disposition: attachment;filename="T0203.xls"');
