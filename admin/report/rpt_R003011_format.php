...
//	fix head for rpt_R003011
	...
	if ($search_mov_code[0]==1 || $search_mov_code[0]==3 || $search_mov_code[1]==3 || $search_mov_code[2]==3 || $search_mov_code[0]==4 || 
		...
		$heading_text[] = "ระดับ|ตำแหน่ง";
		$heading_text[] = "วุฒิการศึกษา|";
		$heading_text[] = "วุฒิการศึกษา|สูงสุด";
		$heading_text[] = "วัน/เดือน/ปี|เกิด ";
		$heading_text[] = "วัน/เดือน/ปี|ที่บรรจุ ";
		$heading_text[] = "วัน/เดือน/ปี|ที่ลาออก";
		$heading_text[] = "เหตุผลใน|การลาออก";
	} else {
		$heading_width[] = "10";
		if($have_pic){
		$heading_width[] = "18";
		...
		$heading_text[] = "ชื่อตำแหน่ง|ในสายงาน";
		$heading_text[] = "ระดับ|ตำแหน่ง";
		$heading_text[] = "วุฒิการศึกษา|ที่ให้โอน";
		$heading_text[] = "วุฒิการศึกษา|สูงสุด";
		$heading_text[] = "วัน/เดือน/ปี|เกิด ";
		$heading_text[] = "วัน/เดือน/ปี|ที่ให้โอน ";
		$heading_text[] = "ส่วนราชการ|ที่รับโอน";
	...
	if($have_pic)
	$data_align = array("C","C","L","L","C","L","L","L","L","C","C","C","L");
	else
	$data_align = array("C","L","L","C","L","L","L","L","C","C","C","L");
