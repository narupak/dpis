<?
	...
	include ("rpt_R003012_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("$heading_name","ตำแหน่ง","วุฒิการศึกษา","วันที่เลื่อนระดับ");
