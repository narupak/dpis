...
//	fix head for rpt_R009006
	...
	$heading_text[1] = "<**1**>ครั้งที่|2";
	$heading_text[2] = "<**1**>ครั้งที่|%";
	$heading_text[3] = "<**1**>ครั้งที่|3";
	$heading_text[4] = "<**1**>ครั้งที่|%";
	$heading_text[5] = "<**1**>ครั้งที่|4";
	$heading_text[6] = "<**1**>ครั้งที่|%";
	$heading_text[7] = "<**1**>ครั้งที่|5";
	$heading_text[8] = "<**1**>ครั้งที่|%";
	$heading_text[9] = "<**2**>รวม|$show_diff_type";
	$heading_text[10] = "<**2**>รวม|%";
	$heading_text[11] = "จำนวนคนซ้ำ|";
	...
	$data_align = array("C","R","R","R","R","R","R","R","R","R","R","C");
