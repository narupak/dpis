<?
	...
	include ("rpt_R004018_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
...
//	$arr_rpt_order = array("MINISTRY", "DEPARTMENT", "ORG", "LINE"); 
	...
	$report_title = "$DEPARTMENT_NAME||จำนวนข้าราชการที่บรรจุใหม่ บรรจุกลับ รับโอน และการสูญเสียในกรณีต่าง ๆ||ประจำปีงบประมาณ พ.ศ. $search_budget_year";
...
//	set_cell_width();
	if($count_data){
		...
		// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนข้อมูล
			...
			$wsdata_fontfmt_1[] = "C";  $wsdata_fontfmt_1[] = "C";
