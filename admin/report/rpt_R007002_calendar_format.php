...
//	fix head for rpt_R007002
	...
	for($i3=0; $i3 < $loop_DATE; $i3++){
		...
		$heading_text[] = "<**2**>วันที่ปฎิบัติงาน|$n|";
	}
	$heading_text[] = "<**3**>ป่วย|(วัน)|";
	$heading_text[] = "<**4**>กิจ|(วัน)|";
	$heading_text[] = "<**5**>ขาด|(วัน)|";
	$heading_text[] = "<**6**>สาย|(วัน)|";
	$heading_text[] = "<**7**>ลาพักผ่อน|งบ $year1|";
	$heading_text[] = "<**7**>ลาพักผ่อน|ลาไป|";
	$heading_text[] = "<**7**>ลาพักผ่อน|คงเหลือ|";
