...
//	fix head for rpt_R007005
	...
	$heading_text[] = "<**1**>ลาป่วย|วันทำการ";
	$heading_text[] = "<**1**>ลาป่วย|จำนวนครั้ง";
	$heading_text[] = "<**2**>ลากิจ|วันทำการ";
	$heading_text[] = "<**2**>ลากิจ|จำนวนครั้ง";
	$heading_text[] = "<**3**>รวมลาป่วย กิจ|วันทำการ";
    $heading_text[] = "<**3**>รวมลาป่วย กิจ|จำนวนครั้ง";
	$heading_text[] = "สาย|(วันทำการ)";
	$heading_text[] = "<**4**>ลาพักผ่อน|วันทำการ";
	$heading_text[] = "<**4**>ลาพักผ่อน|จำนวนครั้ง";
	$heading_text[] = "ลาอื่นๆ|(วันทำการ)";
	...
	$data_align = array("C","L","C","C","C","C","C","C","C","C","C","C","L");
