...
//	$db_dpis->show_error();
	...
	$company_name = "";
	$report_title = "บัญชีคำขอยุบเลิกตำแหน่งเกษียณกรณีพิเศษ||สำนักนายกรัฐมนตรี||(ส่งพร้อมหนังสือสำนักนายกรัฐมนตรี||ที่". str_repeat(".", 40) ." ลงวันที่". str_repeat(".", 40) .")";
	$report_code = "";
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	header("Content-Type: application/x-msexcel; name=\"บัญชีคำขอยุบเลิกตำแหน่งเกษียณกรณีพิเศษ.xls\"");
	header("Content-Disposition: inline; filename=\"บัญชีคำขอยุบเลิกตำแหน่งเกษียณกรณีพิเศษ.xls\"");
	$fh=fopen($fname, "rb");
	fpassthru($fh);
	fclose($fh);
	unlink($fname);
