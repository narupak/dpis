...
//	fix head for rpt_R005002
	...
	$heading_text[1] = "|กรม/ส่วนราชการที่เทียบเท่า|";
	$heading_text[2] = "<**1**>เครื่องราชอิสริยาภรณ์|<**1**>ม.ป.ช.|บุรุษ";
	$heading_text[3] = "<**1**>เครื่องราชอิสริยาภรณ์|<**1**>ม.ป.ช.|สตรี";
	$heading_text[4] = "<**1**>เครื่องราชอิสริยาภรณ์|<**2**>ม.ว.ม.|บุรุษ";
	$heading_text[5] = "<**1**>เครื่องราชอิสริยาภรณ์|<**2**>ม.ว.ม.|สตรี";
	$heading_text[6] = "<**1**>เครื่องราชอิสริยาภรณ์|<**3**>ป.ช.|บุรุษ";
	$heading_text[7] = "<**1**>เครื่องราชอิสริยาภรณ์|<**3**>ป.ช.|สตรี";
	$heading_text[8] = "<**1**>เครื่องราชอิสริยาภรณ์|<**4**>ป.ม.|บุรุษ";
	$heading_text[9] = "<**1**>เครื่องราชอิสริยาภรณ์|<**4**>ป.ม.|สตรี";
	$heading_text[10] = "<**2**>รวม|<**5^**>|บุรุษ";
	$heading_text[11] = "<**2**>รวม|<**5^**>|สตรี";
	$heading_text[12] = "<**2**>รวม|<**5^**>|รวม";
	$heading_text[13] = "|หมายเหตุ|";
