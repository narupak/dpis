...
//	fix head for rpt_R005004
	...
	$heading_text[0] = "(1)||ลำดับ||";
	$heading_text[1] = "(2)||ชื่อตัว - ชื่อสกุล||";
	$heading_text[2] = "<**1**>(3)|<**1**>เป็นข้าราชการ|ชั้น|(ปัจจุบัน)|";
	$heading_text[3] = "<**1**>(3)|<**1**>เป็นข้าราชการ|ตั้งแต่|วัน เดือน ปี|";
	$heading_text[4] = "<**1**>(3)|<**1**>เป็นข้าราชการ|เงินเดือน|(ปัจจุบัน)|";
	$heading_text[5] = "(4)|ตำแหน่ง|ปัจจุบัน และอดีตเฉพาะปีที่ได้รับ|พระราชทานเครื่องราชอิสริยาภรณ์|";
	$heading_text[6] = "<**2**>(5)|<**2**>เครื่องราชอิสริยาภรณ์|ได้รับ|(จากชั้นสูง|ไปชั้นรอง)";
	$heading_text[7] = "<**2**>(5)|<**2**>เครื่องราชอิสริยาภรณ์|วัน เดือน ปี|(5 ธ.ค. ...)|";
	$heading_text[8] = "<**2**>(5)|<**2**>เครื่องราชอิสริยาภรณ์|ขอครั้งนี้||";
	$heading_text[9] = "(6)|หมายเหตุ|||";
	...
	$data_align = array("C", "L", "L", "C", "R", "L", "C", "C", "C", "L");
