...
//	fix head for P0406 xls
		...
		$heading_text = array("ลำดับ|ที่",$FULLNAME_HEAD."|","เลขประจำตัว|ประชาชน",$COM_HEAD_01."สังกัด",$COM_HEAD_01."ตำแหน่ง","<**1**>ประเภท|ตำแหน่ง","<**1**>|ระดับตำแหน่ง","<**1**>|เลขที่","เงินเดือน","ค่าตอบแทน|พิเศษ","ให้ได้รับ|เงินเดือน","หมายเหตุ|");
