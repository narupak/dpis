...
//	fix head for rpt_R006005
	...
	$heading_text[1] = "จำนวน|อัตราที่มี|ผู้ครองอยู่|ณ 1 มี.ค.";
	$heading_text[2] = "<**1**>เลื่อน 1 เมษายน ". ($search_budget_year - 1)."|ร้อยละ|15|";
	$heading_text[3] = "<**1**>เลื่อน 1 เมษายน ". ($search_budget_year - 1)."|1 ขั้น||";
	$heading_text[4] = "<**1**>เลื่อน 1 เมษายน ". ($search_budget_year - 1)."|ค่า|ตอบแทน|4 %";
	$heading_text[5] = "อัตรา|เงินเดือน|รวม ณ|1 ก.ย.";
	$heading_text[6] = "วงเงิน|เลื่อนขั้น|ร้อยละ 6|";
	$heading_text[7] = "เงินเลื่อน|ขั้นที่ใช้|ณ 1 เม.ย.|";
	$heading_text[8] = "วงเงิน|เลื่อนขั้น|คงเหลือ|";
	$heading_text[9] = "<**2**>เลื่อน 1 ตุลาคม ". ($search_budget_year - 1)."|ร้อยละ|15|";
	$heading_text[10] = "<**2**>เลื่อน 1 ตุลาคม ". ($search_budget_year - 1)."|1 ขั้น||";
	$heading_text[11] = "<**2**>เลื่อน 1 ตุลาคม ". ($search_budget_year - 1)."|1.5 ขั้น||";
	$heading_text[12] = "<**2**>เลื่อน 1 ตุลาคม ". ($search_budget_year - 1)."|ค่า|ตอบแทน|4 %";
	$heading_text[13] = "รวม|ทั้งปี|2 ขั้น|";
	...
	$data_align = array("L", "R", "R", "R", "R", "R", "R", "R", "R", "R", "R", "R", "R", "R");
