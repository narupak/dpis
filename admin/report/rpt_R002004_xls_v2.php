...
//			$list_type_text .= " - $MINISTRY_NAME";
	...
	include ("rpt_R002004_format_v2.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		...
		if ($SESS_DEPARTMENT_NAME!="กรมการปกครอง")
			...
			$ws_width = array(45,8,8,8,8,8,8,8); //$ws_width = array(45,8,8,8,8,8);
...
//		echo "af..ws_width=".implode(",",$ws_width)."<br>";
	...
	function print_header(){
		...
		global $heading_name, $arr_age_duration, $SESS_DEPARTMENT_NAME, $heading_column, $NUMBER_DISPLAY;
...
//			คิดตามอายุจริง (ถ้ายังไม่ถึงวันเกิดจะไม่นับเป็นปี)
			$birthdate_min = date_adjust($search_effective_date, "y", -21);
...
//			คิดตามอายุจริง (ถ้ายังไม่ถึงวันเกิดจะไม่นับเป็นปี)
			$birthdate_max = date_adjust($search_effective_date, "y", -60);
