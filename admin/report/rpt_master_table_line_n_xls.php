<?
	...
	$worksheet = &$workbook->addworksheet("ข้อมูลชื่อตำแหน่งในสายงาน(ใหม่)");
	...
	function print_header($xlsRow){
		...
		$worksheet->write($xlsRow, 2, "ชื่อตำแหน่งในสายงาน (ใหม่)", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
