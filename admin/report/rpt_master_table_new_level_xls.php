<?
	...
	function print_header($xlsRow){
		...
		$worksheet->write($xlsRow, 0, "รหัสประเภท / ระดับตำแหน่ง (ใหม่)", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 1, "ชื่อประเภท / ระดับตำแหน่ง (ใหม่)", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
...
//	$db_dpis->show_error();
	...
	if($count_data){
		...
		while($data = $db_dpis->get_array()){
			...
			$$arr_fields[0] = $data[$arr_fields[1]];
			$$arr_fields[1] = $data[$arr_fields[2]];
			$$arr_fields[2] = ($data[$arr_fields[3]]==1)?"../images/checkbox_check.bmp":"../images/checkbox_blank.bmp";
