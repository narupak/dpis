<?
	...
	$heading_text[1] = "ชื่อ-ชื่อสกุล";//"<**1**>ถือครอง|ตำแหน่ง";
	$heading_text[2] = "เวลามา";
	$heading_text[3] = "เวลากลับ";
	$heading_text[4] = "หมายเหตุ";
	
	$column_function[0] = "TSTR";//(($NUMBER_DISPLAY==2)?"TNUM":"ENUM");
	$column_function[1] = "TSTR";//(($NUMBER_DISPLAY==2)?"TNUM-n":"ENUM-n");
	$column_function[2] = "TSTR";//(($NUMBER_DISPLAY==2)?"TNUM-2":"ENUM-2");
	$column_function[3] = "TSTR";//(($NUMBER_DISPLAY==2)?"TNUM-n":"ENUM-n");
	$column_function[4] = "TSTR";//(($NUMBER_DISPLAY==2)?"TNUM-2":"ENUM-2");
