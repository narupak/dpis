...
//	session_cache_limiter("nocache");
	...
	include ("rpt_R010036_format.php");	// กำหนดหัวและตัวแปรสำหรับการเปลี่ยนรูปแบบรายงาน
...
//				echo "data-".implode(",",$arr_data)."<br>";
			...
			$arr_data = (array) null;
//			$arr_data[] = " ";	$data_align[0]="C";
//			$arr_data[] = "รวมทั้งหมด";	$data_align[1]="C";
			...
			$arr_data[] = "<**2**>".$GRAND_TOTAL;
			$arr_data[] = "<**2**>".$GRAND_TOTAL;
//			$arr_data[] = $GRAND_TOTAL_M;
//			$arr_data[] = $GRAND_TOTAL_F;
//			echo "รวม-".implode(",",$arr_data)."<br>";
