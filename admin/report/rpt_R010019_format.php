...
//	fix head for rpt_R010019
	...
	$heading_text[] = "วุฒิการศึกษาสูงสุด";
	$heading_text[] = "วันเข้าสู่ระดับ|ปัจจุบัน";
	$heading_text[] = "วันดำรงตำแหน่ง|ปัจจุบัน";
	$heading_text[] = "เงินเดือน";
	$heading_text[] = "วันบรรจุ";
    $heading_text[] ="<**1**>เครื่องราชอิสริยาภรณ์|ชั้น";
	$heading_text[] = "<**1**>เครื่องราชอิสริยาภรณ์|วันที่ได้รับ";
	$heading_text[] = "วันเกษียณอายุ|(1 ต.ค.) ";
	...
	if($have_pic)
		$data_align = array("C","C","L","C","L","L","C","C","C","C","C","C","C");
	else
		$data_align = array("C","L","L","C","L","C","C","C","C","C","C","C");
