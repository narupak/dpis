<?
	...
	include ("rpt_R010023_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
...
//	$report_title .= " ประจำปีงบประมาณ  พ.ศ. $search_year";
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ลำดับ","ชื่อ - นามสกุล","$CARDNO_TITLE","วันเริ่ม","$PM_TITLE","$PL_TITLE","ระดับ","$MINISTRY_TITLE","$DEPARTMENT_TITLE","$ORG_TITLE","วันเดือนปีเกิด","อายุ","ระดับการศึกษา","วันเริ่ม","วันสิ้นสุด","ระยะเวลา","$PM_TITLE","$PL_TITLE","ระดับ","$MINISTRY_TITLE","$DEPARTMENT_TITLE","$ORG_TITLE");
		$ws_head_line2 = array("","","","","","","","","","","","","(ในตำแหน่ง)","","","","","","","","","");
...
//	$db_dpis->show_error();
	...
	while($data = $db_dpis->get_array()){		
		...
		while($data2 = $db_dpis2->get_array()){		
			...
			if (($POH_LEVEL_NO=='08' || $POH_LEVEL_NO=='09') && $PT_GROUP != 3 && substr($POH_PM_NAME,0,11)!="ผู้อำนวยการ") $loop = 1;
			else break;
		}
