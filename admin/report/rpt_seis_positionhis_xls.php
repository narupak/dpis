<?
	...
	$cmd = " SELECT POH_ID, PER_ID, POH_EFFECTIVEDATE, MOV_CODE, POH_ENDDATE, POH_DOCNO, POH_DOCDATE, 
						...
						where POH_ID >= 550000 and POH_ID < 580000
						ORDER BY POH_ID ";
//						where POH_ID < 350000
//						where POH_ID >= 350000 and POH_ID < 365000
//						where POH_ID >= 365000 and POH_ID < 375000
//						where POH_ID >= 375000 and POH_ID < 378000
//						where POH_ID >= 378000 and POH_ID < 395000
//						where POH_ID >= 395000 and POH_ID < 399000
//						where POH_ID >= 399000 and POH_ID < 401000
//						where POH_ID >= 401000 and POH_ID < 440000
//						where POH_ID >= 440000 and POH_ID < 490000
//						where POH_ID >= 490000 and POH_ID < 520000
//						where POH_ID >= 520000 and POH_ID < 550000
//						where POH_ID >= 550000 and POH_ID < 580000
