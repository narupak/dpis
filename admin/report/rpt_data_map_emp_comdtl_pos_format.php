<?
//	fix head for rpt_data_map_emp_comdtl_pos_format.php
	...
	$heading_text[1] = "ตำแหน่ง|เลขที่";
	$heading_text[2] = "<**1**>สังกัด/พื้นที่ปฏิบัติงาน|กลาง/ภูมิภาค";
	$heading_text[3] = "<**1**>|จังหวัด";
	$heading_text[4] = "<**1**>|สำนัก/เขต/แขวง/ศูนย์";
	$heading_text[5] = "<**2**>ตำแหน่งตามระบบเดิม|หมวด";
	$heading_text[6] = "<**2**>|ชื่อตำแหน่ง";
	$heading_text[7] = "<**2**>|ชั้น";
	$heading_text[8] = "<**2**>|ชื่อผู้ครองตำแหน่ง";
	$heading_text[9] = "<**3**>ตำแหน่งตามระบบใหม่|กลุ่มงาน";
	$heading_text[10] = "<**3**>|รหัส";
	$heading_text[11] = "<**3**>|ชื่อตำแหน่ง";
	$heading_text[12] = "<**3**>|ระดับ";
	$heading_text[13] = "หมายเหตุ|";

	$data_align = array("C", "C", "L", "L", "L", "L", "L", "L", "L", "L", "C", "L", "L", "L");
