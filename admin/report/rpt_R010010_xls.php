<?
	...
	include ("rpt_R010010_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
  ...
  $report_title .= " ประจำปีงบประมาณ  พ.ศ. ".$search_budget_year;   
   $report_title = (($NUMBER_DISPLAY==2)?convert2thaidigit($report_title):$report_title);
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ลำดับที่","ชื่อ-นามสกุล","$PL_TITLE","$PM_TITLE","ส่วนราชการ","ตำแหน่งประเภท","วัน เดือน ปีเกิด");
		...
		$ws_width = array(10,40,30,30,40,20,20);
...
//				echo "$i-map[".$arr_column_map[$i]."], width=".$ws_width[$arr_column_map[$i]]."<br />";
	...
	$arr_content[$data_count][per_name] = str_repeat(" ", ($rpt_order_index * 6)) .$PERSON_TYPE[$search_per_type] ;
	$data_count++;
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	if($count_data){
		...
		// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนข้อมูล
			...
			$wsdata_align_1 = array("C","L","L","L","L","C","C");
