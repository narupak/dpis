...
//	fix head for rpt_R001002
	...
	$heading_text[1] = "<**1**>ทั่วไป|ตำแหน่ง";
	$heading_text[2] = "<**1**>ทั่วไป|ร้อยละ";
	$heading_text[3] = "<**2**>วิชาชีพเฉพาะ|ตำแหน่ง";
	$heading_text[4] = "<**2**>วิชาชีพเฉพาะ|ร้อยละ";
	$heading_text[5] = "<**3**>บริหาร|ตำแหน่ง";
	$heading_text[6] = "<**3**>บริหาร|ร้อยละ";
	...
	$column_function[1] = (($NUMBER_DISPLAY==2)?"TNUM-n":"ENUM-n");
	$column_function[2] = (($NUMBER_DISPLAY==2)?"TNUM-2":"ENUM-2");
	$column_function[3] = (($NUMBER_DISPLAY==2)?"TNUM-n":"ENUM-n");
	$column_function[4] = (($NUMBER_DISPLAY==2)?"TNUM-2":"ENUM-2");
	$column_function[5] = (($NUMBER_DISPLAY==2)?"TNUM-n":"ENUM-n");
	$column_function[6] = (($NUMBER_DISPLAY==2)?"TNUM-2":"ENUM-2");
	$column_function[7] = (($NUMBER_DISPLAY==2)?"TNUM-n":"ENUM-n");
