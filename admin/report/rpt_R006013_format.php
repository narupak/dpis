...
//	fix head for rpt_R001001
	...
	$heading_text[2] = "<**1**>ระดับ|1";
	$heading_text[3] = "<**1**>ระดับ|2";
	$heading_text[4] = "<**1**>ระดับ|3";
	$heading_text[5] = "<**1**>ระดับ|4";
	$heading_text[6] = "<**1**>ระดับ|5";
	$heading_text[7] = "<**1**>ระดับ|6";
	$heading_text[8] = "<**1**>ระดับ|7";
	$heading_text[9] = "<**1**>ระดับ|8";
	$heading_text[10] = "รวมทั้งสิ้น|(คน)";
	$heading_text[11] = "จำนวนคนที่|ไม่ได้เลื่อน";
	$heading_text[12] = "คงเหลือ|(คน)";
	$heading_text[13] = "โควตา|ร้อยละ $SALQ_PERCENT";
	$heading_text[14] = "จัดสรร|(ร้อยละ)";
	...
	$data_align = array("C", "L", "R", "R", "R", "R", "R", "R", "R", "R", "R", "R", "R", "R", "R");
