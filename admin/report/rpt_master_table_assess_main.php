...
//	session_cache_limiter("nocache");
	...
	if ($FLAG_RTF) {
		...
		$fname= "rpt_master_table_assess_main.rtf";
	...
	$heading_text[2] = "$CODE_TITLE";
	$heading_text[3] = "$NAME_TITLE";
	$heading_text[4] = "ช่วงคะแนน";
	$heading_text[5] = "$PER_TYPE_TITLE";
	$heading_text[6] = "$ACTIVE_TITLE";
...
//	echo "<pre>";		print_r($field_list);		echo "</pre>";
	...
	if($count_data){
		...
		while($data = $db_dpis->get_array()){
			...
			$arr_data = (array) null;
			$arr_data[] = $data[AM_YEAR];
			$arr_data[] = $data[AM_CYCLE];
			$arr_data[] = $data[AM_CODE];
			$arr_data[] = $data[AM_NAME];
			$arr_data[] = $data[AM_POINT_MIN] . ' - ' . $data[AM_POINT_MAX];
			$arr_data[] = $PERSON_TYPE[$data[PER_TYPE]];
			$arr_data[] = "<*img*".(($data[AM_ACTIVE]==1)?"../images/checkbox_check.jpg":"../images/checkbox_blank.jpg")."*img*>";
