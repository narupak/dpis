...
//	session_cache_limiter("nocache");
	...
	function print_header(){
		...
		$pdf->Cell($heading_width[2] ,7,"ประวัติ",'LTR',0,'C',1);
		...
		$pdf->Cell($heading_width[6] ,7,"ประวัติ",'LTR',1,'C',1);

		$pdf->Cell($heading_width[0] ,7,"",'LBR',0,'C',1);
		$pdf->Cell($heading_width[1] ,7,"",'LBR',0,'C',1);
		$pdf->Cell($heading_width[2] ,7,"การศึกษา",'LBR',0,'C',1);
		$pdf->Cell($heading_width[3] ,7,"",'LBR',0,'C',1);
		$pdf->Cell($heading_width[4] ,7,"",'LBR',0,'C',1);
		$pdf->Cell($heading_width[5] ,7,"ระดับ",'LBR',0,'C',1);
		$pdf->Cell($heading_width[6] ,7,"การอบรม/ดูงาน",'LBR',1,'C',1);
...
if($count_data){
		...
		$pdf->Cell(($heading_width[0] + $heading_width[1] + $heading_width[2] + $heading_width[3] + $heading_width[4] + $heading_width[5] + $heading_width[6]), 7, " ", $border, 1, 'L', 0);
	}else{
