...
//	fix head for rpt_R005003
	...
	$heading_width[16] = "10";
	$heading_width[17] = "10";
	$heading_width[18] = "10";	// รวม
	$heading_width[19] = "10";	// รวม
	$heading_width[20] = "10";	// รวม
	$heading_width[21] = "20";	// หมายเหตุ
	
	$heading_text[0] = "|ลำดับ|";
	$heading_text[1] = "กรม/ส่วนราชการ|ที่เทียบเท่า|";
	$heading_text[2] = "<**1**>เครื่องราชอิสริยาภรณ์|<**1**>ท.ช.|บุรุษ";
	$heading_text[3] = "<**1**>เครื่องราชอิสริยาภรณ์|<**1**>ท.ช.|สตรี";
	$heading_text[4] = "<**1**>เครื่องราชอิสริยาภรณ์|<**2**>ท.ม.|บุรุษ";
	$heading_text[5] = "<**1**>เครื่องราชอิสริยาภรณ์|<**2**>ท.ม.|สตรี";
	$heading_text[6] = "<**1**>เครื่องราชอิสริยาภรณ์|<**3**>ต.ช.|บุรุษ";
	$heading_text[7] = "<**1**>เครื่องราชอิสริยาภรณ์|<**3**>ต.ช.|สตรี";
	$heading_text[8] = "<**1**>เครื่องราชอิสริยาภรณ์|<**4**>ต.ม.|บุรุษ";
	$heading_text[9] = "<**1**>เครื่องราชอิสริยาภรณ์|<**4**>ต.ม.|สตรี";
	$heading_text[10] = "<**1**>เครื่องราชอิสริยาภรณ์|<**5**>จ.ช.|บุรุษ";
	$heading_text[11] = "<**1**>เครื่องราชอิสริยาภรณ์|<**5**>จ.ช.|สตรี";
	$heading_text[12] = "<**1**>เครื่องราชอิสริยาภรณ์|<**6**>จ.ม.|บุรุษ";
	$heading_text[13] = "<**1**>เครื่องราชอิสริยาภรณ์|<**6**>จ.ม.|สตรี";
	$heading_text[14] = "<**1**>เครื่องราชอิสริยาภรณ์|<**7**>บ.ช.|บุรุษ";
	$heading_text[15] = "<**1**>เครื่องราชอิสริยาภรณ์|<**7**>บ.ช.|สตรี";
	$heading_text[16] = "<**1**>เครื่องราชอิสริยาภรณ์|<**8**>บ.ม.|บุรุษ";
	$heading_text[17] = "<**1**>เครื่องราชอิสริยาภรณ์|<**8**>บ.ม.|สตรี";
	$heading_text[18] = "<**2**>รวม|<**9**>|บุรุษ";
	$heading_text[19] = "<**2**>รวม|<**9**>|สตรี";
	$heading_text[20] = "<**2**>รวม|<**9**>|รวม";
	$heading_text[21] = "|หมายเหตุ|";
