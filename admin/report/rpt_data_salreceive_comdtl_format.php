...
//	fix head for P0407
	...
	$heading_text[6] = $COM_HEAD_01."|เงิน|เดือน";
	$heading_text[7] ="ดำรง|ตำแหน่ง|ปัจจุบันเมื่อ";
	if ($BKK_FLAG==1)
		$heading_text[8] = "วุฒิที่ได้รับเพิ่มขึ้น/|วันที่สำเร็จการศึกษา";
	else
		$heading_text[8] = "วุฒิที่ได้รับเพิ่มขึ้น/สถานศึกษา|วันสำเร็จการศึกษา";
	$heading_text[9] = "วันกลับเข้า|ปฏิบัติ|ราชการ";
	$heading_text[10] = "ปรับให้ได้รับ|เงินเดือน";
	...
	$data_align = array("C","L","L","C","C","C","R","C","L","C","R","C","L");
