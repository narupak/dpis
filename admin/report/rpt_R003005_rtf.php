...
//	echo "default font_id::".$RTF->dfl_FontID."<br>";	
	...
	function list_person($search_condition, $addition_condition){
		...
		if($DPISDB=="odbc"){
			...
			$cmd = " select			a.PER_ID,a.PN_CODE, a.PER_NAME, a.PER_SURNAME, a.LEVEL_NO, b.PL_CODE, b.PT_CODE, b.POS_CHANGE_DATE,
												d.PN_NAME, e.PL_NAME, f.PT_NAME, g.POSITION_LEVEL
							 from			PER_PERSONAL a, PER_POSITION b, PER_ORG c, PER_PRENAME d, PER_LINE e, PER_TYPE f, PER_LEVEL g, PER_ORG e
							 where		a.POS_ID=b.POS_ID and b.ORG_ID=c.ORG_ID(+) 
							 					and a.PN_CODE=d.PN_CODE(+) and b.PL_CODE=e.PL_CODE(+) and b.PT_CODE=f.PT_CODE(+) and a.LEVEL_NO=g.LEVEL_NO(+) and a.DEPARTMENT_ID=e.ORG_ID(+)
												$search_condition
