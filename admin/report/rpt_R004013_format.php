...
//	fix head for rpt_R004013
	...
	$heading_text[] = "สังกัด";
        $heading_text[] = "ชื่อหลักสูตร";
	$heading_text[] = "รุ่นที่";	
	$heading_text[] = "หน่วยงานที่จัด";		
	$heading_text[] = "วันเข้ารับการอบรม";
	$heading_text[] = "วันสิ้นสุดการอบรม";
	...
	if ($have_pic)
	$data_align = array("C","C","L","L","C","L","C","L","C","C","C");
	else	
	$data_align = array("C","L","L","C","L","C","L","C","C","C");
