<?
	$report_code = "data พนักงานราชการ Flow In";
	...
	$cmd = " select 	PER_ID, PER_GENDER, PER_BIRTHDATE, PER_STARTDATE, LEVEL_NO, 
					...
					ORG_ID, MOV_CODE, POEMS_ID, PER_OCCUPYDATE 
			from		PER_PERSONAL  
			where	PER_TYPE=3 and PER_OCCUPYDATE >= '$budget_year_from' and PER_OCCUPYDATE <= '$budget_year_to' ";
