...
//	fix head for rpt_R010016
	...
	if ($have_pic) {
		$heading_text[] = "รูป|";
		$heading_text[] = "ส่วนราชการ/| ชื่อ - นามสกุล";
	} else {
		$heading_text[] = "ส่วนราชการ/| ชื่อ - นามสกุล";
	}
	$heading_text[] = "ตำแหน่ง";
	$heading_text[] = "วันดำรงตำแหน่ง|ปัจจุบัน";
	$heading_text[] = "วันครบกำหนด| ".(($NUMBER_DISPLAY==2)?convert2thaidigit($search_pos_year):$search_pos_year)." ปี";
	$heading_text[] = "วันเกษียณ|อายุ (1 ต.ค.)";
	...
	if($have_pic)
	$data_align = array("C","C","L","L","C","C","C");
	else
