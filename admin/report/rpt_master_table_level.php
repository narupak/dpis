...
//	session_cache_limiter("nocache");
	...
	session_start();
		...
		$fname= "rpt_master_table_level.rtf";
...
//	$db_dpis->show_error();
	...
	if($count_data){
		...
		while($data = $db_dpis->get_array()){
			...
			$arr_data[] = $PERSON_TYPE[$data[$arr_fields[5]]];
			$arr_data[] = "<*img*".(($data[$arr_fields[1]]==1)?"../images/checkbox_check.jpg":"../images/checkbox_blank.jpg")."*img*>";
