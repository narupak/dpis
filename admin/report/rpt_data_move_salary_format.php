...
//	fix head for P0408
	...
	$heading_text[3] = "<**1**>อัตราเงินเดือนเดิม|ตำแหน่ง/สังกัด";
	$heading_text[4] = "<**1**>อัตราเงินเดือนเดิม|ตำแหน่ง|ประเภท";
	$heading_text[5] = "<**1**>อัตราเงินเดือนเดิม|ระดับ";
	$heading_text[6] = "<**1**>อัตราเงินเดือนเดิม|เลขที่";
	$heading_text[7] = "<**2**>อัตราเงินเดือนที่ตัดโอนไปตั้งจ่ายใหม่|ตำแหน่ง/สังกัด";
	$heading_text[8] = "<**2**>อัตราเงินเดือนที่ตัดโอนไปตั้งจ่ายใหม่|ตำแหน่ง|ประเภท";
	$heading_text[9] = "<**2**>อัตราเงินเดือนที่ตัดโอนไปตั้งจ่ายใหม่|ระดับ";
	$heading_text[10] = "<**2**>อัตราเงินเดือนที่ตัดโอนไปตั้งจ่ายใหม่|เลขที่";
	$heading_text[11] = "เงินเดือน";	
