...
//	session_cache_limiter("nocache");
	...
	function print_header(){
		...
		if($COM_PER_TYPE == 1){
			$pdf->Cell(($heading_width[5] + $heading_width[6]) ,7,"เงินเดือนก่อนเลื่อน",'LTR',0,'C',1);
			$pdf->Cell(($heading_width[7] + $heading_width[8]) ,7,"ให้ได้รับเงินเดือน",'LTR',0,'C',1);
			$pdf->Cell($heading_width[9] ,7,"เงิน",'LTR',0,'C',1);
			$pdf->Cell($heading_width[10] ,7,"หมายเหตุ",'LTR',1,'C',1);
		}else{
			$pdf->Cell(($heading_width[5] + $heading_width[6]) ,7,"อัตราค่าจ้าง (บาท)",'LTR',0,'C',1);
			$pdf->Cell($heading_width[7],7,"เงินเลื่อนขั้น",'LTR',0,'C',1);
		...
		if($COM_PER_TYPE == 1){
			...
			$pdf->Cell($heading_width[7] ,7,"อันดับ",'LTBR',0,'C',1);
			$pdf->Cell($heading_width[8] ,7,"ขั้น",'LTBR',0,'C',1);
			$pdf->Cell($heading_width[9] ,7,"เลื่อนขั้น",'LBR',0,'C',1);
			$pdf->Cell($heading_width[10] ,7,"",'LBR',1,'C',1);
		}else{
			$pdf->Cell($heading_width[5] ,7,"ก่อนเลื่อน",'LTBR',0,'C',1);
			$pdf->Cell($heading_width[6] ,7,"ให้ได้รับ",'LTBR',0,'C',1);
