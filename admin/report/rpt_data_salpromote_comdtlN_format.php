...
//	fix head for P0406
	if ($COM_LEVEL_SALP==9) {
		...
		$heading_text[2] = $COM_HEAD_01."|สังกัด/ตำแหน่ง";
		$heading_text[3] = $COM_HEAD_01."|ระดับ";
		$heading_text[5] = $COM_HEAD_01."|เลขที่ตำแหน่ง";
		$heading_text[6] = "เงินเดือน|";
		$heading_text[7] = "ค่าตอบแทน|พิเศษ";
		$heading_text[8] = "เงินเดือน|ที่ได้รับ";
		...
		$heading_text[2] = $COM_HEAD_01."|สังกัด/ตำแหน่ง";
		$heading_text[3] = $COM_HEAD_01."|ระดับ";
		$heading_text[4] = $COM_HEAD_01."|เลขที่";
		$heading_text[5] = "เงินเดือนเดิม|";
		$heading_text[6] = "เงินเดือนที่ได้รับ|";
