...
//	$report_title = "บัญชีรายละเอียดการแต่งตั้งข้าราชการพลเรือนสามัญให้ดำรงตำแหน่งใหม่ตามพระราชบัญญัติระเบียบข้าราชการพลเรือน พ.ศ.2551 $DEPARTMENT_NAME ที่ $COM_NO ลงวันที่ $COM_DATE";
	...
	function print_header(){
		...
		$worksheet->write($xlsRow, 6, "เลขที่ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TR", 1));
		$worksheet->write($xlsRow, 7, "ส่วนราชการและตำแหน่งที่ ก.พ.กำหนดใหม่", set_format("xlsFmtTableHeader", "B", "C", "T", 1));
		...
		$worksheet->write($xlsRow, 11, "หมายเหตุ", set_format("xlsFmtTableHeader", "B", "C", "TR", 0));
		...
		$worksheet->write($xlsRow, 7, "ชื่อตำแหน่งในการบริหารงาน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 8, "ชื่อตำแหน่งในสายงาน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 9, "ประเภทตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 10, "ระดับตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
