...
//	fix head for rpt_R004098
	...
	$heading_text[] = "<**1**>ส่วนราชการและตำแหน่งที่กำหนดใหม่|ชื่อตำแหน่งในการบริหารงาน";
	$heading_text[] = "<**1**>ส่วนราชการและตำแหน่งที่กำหนดใหม่|ประเภทตำแหน่ง";
	$heading_text[] = "<**1**>ส่วนราชการและตำแหน่งที่กำหนดใหม่|ระดับตำแหน่ง";
	$heading_text[] = "วันเลื่อนระดับ|";
	$heading_text[] = "เงินเดือน|";
	$heading_text[] = "วันบรรจุ|";
	$heading_text[] = "วันเกิด|";
    $heading_text[] = "อายุข้าราชการ|";
    $heading_text[] = "อายุราชการ(อายุงาน)|";
	$heading_text[] = "เกษียณ|พ.ศ.";
	$heading_text[] = "ดำรงตำแหน่ง|ปัจจุบัน|";
	$heading_text[] = "<**2**>วุฒิการศึกษา|ปริญญาตรี";
	$heading_text[] = "<**2**>วุฒิการศึกษา|ปริญญาโท";
	$heading_text[] = "<**2**>วุฒิการศึกษา|ปริญญาเอก";
	...
	if($have_pic)
	$data_align = array("R","C","L","L","L","C","C","C","R","C","C","C","L","L","L","L");
	else
	$data_align = array("R","L","L","L","C","C","C","R","C","C","C","L","L","L","L","L","L");
