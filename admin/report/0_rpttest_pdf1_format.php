<?
//	fix head for 0_rpttest_excel_format
	...
	$heading_text = array("คำอธิบาย|","<**1**>ชุด 1|คอลัมน์ 1","<**1**>ชุด 1|คอลัมน์ 2","<**2**>ชุด 2|คอลัมน์ 3","<**2**>ชุด 2|คอลัมน์ 4","<**2**>ชุด 2|คอลัมน์ 5","<**2**>ชุด 2|คอลัมน์ 6","รวม|");
	...
	$column_function[7] = (($NUMBER_DISPLAY==2)?"SUM-1-2-3-4-5-6|TNUM":"SUM-1-2-3-4-5-6|ENUM");
