...
//	fix head for rpt_R003006
	...
	$heading_text[1] = "<**1**>จำนวน$PERSON_TYPE[$search_per_type]|ต้นปี";
	$heading_text[2] = "<**1**>จำนวน$PERSON_TYPE[$search_per_type]|เข้า";
	$heading_text[3] = "<**1**>จำนวน$PERSON_TYPE[$search_per_type]|ออก";
	$heading_text[4] = "<**1**>จำนวน$PERSON_TYPE[$search_per_type]|สิ้นปี";
	$heading_text[5] = "<**2**>อัตรา (ร้อยละ)|เข้า";
	$heading_text[6] = "<**2**>อัตรา (ร้อยละ)|ออก";
