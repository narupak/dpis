...
//	echo "default font_id::".$RTF->dfl_FontID."<br>";	
	...
	$report_title = "$DEPARTMENT_NAME||จำนวนข้าราชการ ประจำปีงบประมาณ พ.ศ. $search_budget_year||จำแนกตามตำแหน่งในการบริหารงาน และระดับตำแหน่ง";
...
//				echo "arr_count[$data_count][$pm_seq][$arr_pm[$pm_seq][code]]=".$arr_count[$data_count][$pm_seq][$arr_pm[$pm_seq][code]]."|";
				//$pdf->Cell($heading_width[2], 7, ($arr_count[$data_count][$pm_seq][$arr_pm[$pm_seq][code]]?(($NUMBER_DISPLAY==2)?convert2thaidigit(number_format($arr_count[$data_count][$pm_seq][$arr_pm[$pm_seq][code]])):number_format($arr_count[$data_count][$pm_seq][$arr_pm[$pm_seq][code]])):"-"), $border, 0, 'R', 0);
