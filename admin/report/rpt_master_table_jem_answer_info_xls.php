<?
	...
	function print_header($xlsRow){
		...
		$worksheet->write($xlsRow, 1, "Question No.", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 2, "Answer information", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
