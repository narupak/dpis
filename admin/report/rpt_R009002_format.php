...
//	fix head for rpt_R009002
            ...
            /*ปรับเปลี่ยน http://dpis.ocsc.go.th/Service/node/1697*/
        
            $heading_text[] = "ความรู้ ทักษะ สมรรถนะที่ต้องได้รับการพัฒนา";
            $heading_text[] = "วิธีการพัฒนา";
            $heading_text[] = "ช่วงเวลาที่ต้องการพัฒนา";
            $heading_text[] = "วิธีการวัดผลในการพัฒนา";
	...
	if($have_pic)
        $data_align = array("R","C","C","C","C","C","C","C");
	else
        $data_align = array("R","C","C","C","C","C","C");
