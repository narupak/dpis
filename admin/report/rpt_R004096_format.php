...
//	fix head for rpt_R004096
	...
	$heading_text[] = "ชื่อ|";
	$heading_text[] = "สกุล|";
	$heading_text[] = "<**1**>ข้อมูลตำแหน่งที่ได้รับแต่งตั้ง|ตำแหน่ง";
	$heading_text[] = "<**1**>ข้อมูลตำแหน่งที่ได้รับแต่งตั้ง|ประเภท";
	$heading_text[] = "<**1**>ข้อมูลตำแหน่งที่ได้รับแต่งตั้ง|ระดับ";
	$heading_text[] = "<**1**>ข้อมูลตำแหน่งที่ได้รับแต่งตั้ง|เงินเดือน";
	$heading_text[] = "<**1**>ข้อมูลตำแหน่งที่ได้รับแต่งตั้ง|กลุ่ม/ฝ่าย/สำนัก";
	$heading_text[] = "<**1**>ข้อมูลตำแหน่งที่ได้รับแต่งตั้ง|จังหวัด";
	$heading_text[] = "<**1**>ข้อมูลตำแหน่งที่ได้รับแต่งตั้ง|สังกัด";
	$heading_text[] = "<**1**>ข้อมูลตำแหน่งที่ได้รับแต่งตั้ง|$DEPARTMENT_TITLE";
	$heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|ตำแหน่ง";
	$heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|ประเภท";
	$heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|ระดับ";
	$heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|กลุ่ม/ฝ่าย/สำนัก";
	$heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|จังหวัด";
	$heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|สังกัด";
	$heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|$DEPARTMENT_TITLE";
	$heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|กรมเดียวกัน/ต่างกรม";
	$heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|ตั้งแต่วันที่";
    $heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|ตั้งแต่วันที่";
    $heading_text[] = "<**2**>ข้อมูลการไปช่วยราชการของข้าราชการ|ตั้งแต่วันที่";
	...
	if ($have_pic)
	$heading_align = array("C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C");
	else
