...
//	fix head for P03011
	...
	$heading_text[1] = $FULLNAME_HEAD."|(เลขประจำตัวประชาชน)";
	$heading_text[2] = "วุฒิ/สาขา/|สถานศึกษา";
	$heading_text[3] = $COM_HEAD_01."เดิม|ตำแหน่ง";
	$heading_text[4] = $COM_HEAD_01."เดิม|สังกัด";
	$heading_text[5] = $COM_HEAD_01."เดิม|เลขที่";
	$heading_text[6] = $COM_HEAD_01."เดิม|เงินเดือน";
	$heading_text[7] = $COM_HEAD_02."ที่ย้าย|ตำแหน่ง";
	$heading_text[8] = $COM_HEAD_02."ที่ย้าย|สังกัด";
	$heading_text[9] = $COM_HEAD_02."ที่ย้าย|เลขที่";
	$heading_text[10] = $COM_HEAD_02."ที่ย้าย|เงินเดือน";
	...
	$data_align = array("C", "L", "L", "L", "L", "C", "R", "L", "L", "C", "R", "C", "L");
