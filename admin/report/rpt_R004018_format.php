...
//	fix head for rpt_R0040018
	...
	$heading_text[] = "||ลำดับ||";
	$heading_text[] = "||ส่วนราชการ||";
	for($i=0; $i<count($ARR_LEVEL_GROUP); $i++){
		$LEVEL_GROUP = $ARR_LEVEL_GROUP[$i];
		for($j=0; $j<count($ARR_LEVEL[$LEVEL_GROUP]); $j++){
			$LEVEL_NO = $ARR_LEVEL[$LEVEL_GROUP][$j];
			$heading_text[] = "<**1**>ตำแหน่งประเภท|<**$i**>".$ARR_LEVEL_GROUP_NAME[$LEVEL_GROUP]."|<**$j**>".$ARR_LEVEL_NAME[$LEVEL_NO][0]."|<**$j^**>".$ARR_LEVEL_NAME[$LEVEL_NO][1]."|ชาย";
			$heading_text[] = "<**1**>ตำแหน่งประเภท|<**$i**>".$ARR_LEVEL_GROUP_NAME[$LEVEL_GROUP]."|<**$j**>".$ARR_LEVEL_NAME[$LEVEL_NO][0]."|<**$j^**>".$ARR_LEVEL_NAME[$LEVEL_NO][1]."|หญิง";
		} // loop for
	} // loop for
	$heading_text[] = "<**2**>|<**99^**>รวม|<**99^**>|<**99^**>|ชาย";
	$heading_text[] = "<**2**>|<**99^**>รวม|<**99^**>|<**99^**>|หญิง";
