	...
	//		echo "$head_text1<br>";
		...
		if($count_data){
			for($data_count=0; $data_count<count($arr_content); $data_count++){
				...
				$fontformat1 = array("b", "b", "b", "", "", "", "biu");
				$fontformat2 = array("", "", "", "", "", "", "biu");
				...
				if(array_search($REPORT_ORDER, $arr_rpt_order) !== false  && array_search($REPORT_ORDER, $arr_rpt_order) == 0 && count($arr_rpt_order) > 1){
					if ($FLAG_RTF)
						...
						$result = $pdf->add_data_tab($arr_data, 7, "TRHBL", $data_align, "", "14", $fontformat1, "000000", "");
				}else{
					if ($FLAG_RTF)
						$result = $RTF->add_data_tab($arr_data, 7, "TRHBL", $data_align, "", "14", $fontformat2, $fmtTableDetail_col_idx, $fmtTableDetail_bgcol_idx);
					else
						$result = $pdf->add_data_tab($arr_data, 7, "TRHBL", $data_align, "", "14", $fontformat2, "000000", "");
				} // end if
