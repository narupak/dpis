<?
	...
	include ("../../PDF/pdf_extends_DPIS_2.php");
	...
	$lang_code="TH";
	$company_name = "";
	$report_title = "บัญชีรายละเอียดการย้ายข้าราชการแนบท้ายคำสั่ง $DEPARTMENT_NAME ที่ $COM_NO ลงวันที่ $COM_DATE";
	$report_code = "";
	$orientation='L';
...
//			$CMD_NOTE = $arr_content[$data_count][cmd_note];
			...
			if($CONTENT_TYPE=="ORG" || $CONTENT_TYPE=="ORG_1" || $CONTENT_TYPE=="ORG_2"){
				...
				$border = "";
				if($CONTENT_TYPE == "ORG") $pdf->SetFont('angsab','',14);
