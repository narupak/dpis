...
//	fix head for rpt_R006017
	...
	$heading_text[] = "ชื่อ-นามสกุล|ร้อยละ";
	if($search_per_type == 1){
		$heading_text[] = "ตำแหน่ง และส่วนราชการ|สังกัด/ตำแหน่ง";
	}else{
		$heading_text[] = "ตำแหน่ง/สังกัด|";
	}
	$heading_text[] = "เลขที่|ตำแหน่ง";
	$heading_text[] = "เงินเดือน|";
	$heading_text[] = "ค่าตอบแทน|พิเศษชั่วคราว";
	$heading_text[] = "ให้ได้รับ|";
