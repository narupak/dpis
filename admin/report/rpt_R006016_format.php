...
//	fix head for rpt_R006016
	...
	$total_show_width = 0;	// หาความกว้างรวมเฉพาะที่แสดงจริง
	$column_show_cnt = 0;		// หาจำนวน column ที่แสดงจริง
	for($iii=0; $iii < count($arr_column_width); $iii++) 	if ($arr_column_sel[$iii]==1) { $total_show_width += (int)$arr_column_width[$iii]; $column_show_cnt++; }
?>