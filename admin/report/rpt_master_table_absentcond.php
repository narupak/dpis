...
//	session_cache_limiter("nocache");
	...
	session_start();
		...
		$fname= "rpt_master_absentcond.rtf";
	...
	$heading_text[2] = "จำนวนปีที่รับราชการ";
	$heading_text[3] = "จำนวนวันที่ลาได้";
	$heading_text[4] = "จำนวนวันสะสมไม่เกิน";
...
//			$arr_data[] = $data[$arr_fields[2]];
			...
			$arr_data[] = $data[$arr_fields[5]];
			$arr_data[] = "<*img*".(($data[$arr_fields[7]]==1)?"../images/checkbox_check.jpg":"../images/checkbox_blank.jpg")."*img*>";

			$data_align = array("C", "L", "C", "C", "C", "C");
		      if ($FLAG_RTF)
