	...
	for($rpt_order_index=0; $rpt_order_index<count($arr_rpt_order); $rpt_order_index++){
		...
		switch($REPORT_ORDER){
			case "MINISTRY" :
				...
				$select_list .= "e.ORG_ID_REF as MINISTRY_ID";	//e. => rpt_R002001N.php
...
//				$order_by .= "d.EN_CODE";
	...
	if($select_org_structure==0) {  
		if(!trim($order_by)) $order_by = "c.ORG_SEQ_NO, c.ORG_CODE, b.ORG_ID, b.ORG_ID_1, b.ORG_ID_2";
		if(!trim($select_list)) $select_list = "c.ORG_SEQ_NO, c.ORG_CODE, b.ORG_ID, b.ORG_ID_1, b.ORG_ID_2";  
	} elseif($select_org_structure==1)  { 
		if(!trim($order_by)) $order_by = "c.ORG_SEQ_NO, c.ORG_CODE, a.ORG_ID, a.ORG_ID_1, a.ORG_ID_2";
		if(!trim($select_list)) $select_list = "c.ORG_SEQ_NO, c.ORG_CODE, a.ORG_ID, a.ORG_ID_1, a.ORG_ID_2"; 
	}
	
	if(!is_array($search_per_status) || empty($search_per_status))	$search_per_status[] = "1";
	$search_condition = "";
