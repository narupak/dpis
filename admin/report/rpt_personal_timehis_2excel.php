<?	
	...
	$header_width[0] = 15; $header_text[0] = "รหัสเวลาทวีคูณ";		//	TIMEH_ID;
	$header_width[1] = 30; $header_text[1] = "ชื่อ";							//	PER_NAME+PER_SURNAME;
	$header_width[2] = 40; $header_text[2] = "เวลาทวีคูณ";				//	TIME_CODE;
	$header_width[3] = 20; $header_text[3] = "จำนวนวันที่ไม่นับทวีคูณ";	//	TIMEH_MINUS; 
	$header_width[4] = 20; $header_text[4] = "เลขหนังสือ";				//	TIMEH_BOOK_NO; 
	$header_width[5] = 20; $header_text[5] = "วันที่หนังสือ";				//	TIMEH_BOOK_DATE; 
	$header_width[6] = 40; $header_text[6] = "หมายเหตุ";				//	TIMEH_REMARK;
