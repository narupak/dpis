...
//		elseif($DPISDB=="oci8") $arr_search_condition[] = "(SUBSTR(trim(a.INV_DATE), 1, 10) <= '$search_date_max')";
	...
	$ws_head_line1 = array("ลำดับที่","ชื่อ - สกุล","$CARDNO_TITLE","ตำแหน่ง","$ORG_TITLE","เลขที่คำสั่งสอบสวน","ฐานความผิด","กรณีความผิด","เลขที่คำสั่งทางวินัย","โทษที่ได้รับ","วันที่มีผลบังคับใช้","หมายเหตุ");
