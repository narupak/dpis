<?
	...
	function print_header($xlsRow){
		global $worksheet, $report_type, $search_per_cooperative, $search_per_member, $search_tr_code, $search_per_status;
		...
		if ($report_type==1) {
			...
			$worksheet->write($xlsRow, 10, "ตำแหน่ง (ก.พ.7)", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));		
			$worksheet->write($xlsRow, 11, "สังกัด (ก.พ.7)", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		} else {
			$worksheet->set_column(0, 0, 6);
			$worksheet->set_column(1, 1, 25);
			$worksheet->set_column(2, 2, 18);
			...
			$worksheet->write($xlsRow, 9, "ตำแหน่ง (ก.พ.7)", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));		
			$worksheet->write($xlsRow, 10, "สังกัด (ก.พ.7)", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
	...
	if(count($arr_search_positionhis_condition)){
		...
		elseif($DPISDB=="oci8") $order_str = "to_number(POS_NO)";
...
//		echo $cmd;
	...
	if(trim($search_sah_effectivedate)){
		...
		elseif ($SAL_DATE_CHECK==2) {
			$cmd = " select PER_ID from PER_PERSONAL where PER_ID not in (select distinct a.PER_ID from PER_SALARYHIS a, PER_PERSONAL b 
							where a.PER_ID = b.PER_ID and a.SAH_EFFECTIVEDATE = '$search_sah_effectivedate' and b.PER_TYPE = 1 and b.PER_STATUS = 1) ";
			$db_dpis->send_cmd($cmd);
	//		$db_dpis->show_error();
	//		echo $cmd;
			...
			if (count($arr_sal_date16)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")) or (a.PER_ID in (". implode(",", $arr_sal_date8) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date9) .")) or (a.PER_ID in (". implode(",", $arr_sal_date10) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date11) .")) or (a.PER_ID in (". implode(",", $arr_sal_date12) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date13) .")) or (a.PER_ID in (". implode(",", $arr_sal_date14) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date15) .")) or (a.PER_ID in (". implode(",", $arr_sal_date16) .")))";
			elseif (count($arr_sal_date15)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")) or (a.PER_ID in (". implode(",", $arr_sal_date8) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date9) .")) or (a.PER_ID in (". implode(",", $arr_sal_date10) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date11) .")) or (a.PER_ID in (". implode(",", $arr_sal_date12) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date13) .")) or (a.PER_ID in (". implode(",", $arr_sal_date14) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date15) .")))";
			elseif (count($arr_sal_date14)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")) or (a.PER_ID in (". implode(",", $arr_sal_date8) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date9) .")) or (a.PER_ID in (". implode(",", $arr_sal_date10) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date11) .")) or (a.PER_ID in (". implode(",", $arr_sal_date12) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date13) .")) or (a.PER_ID in (". implode(",", $arr_sal_date14) .")))";
			elseif (count($arr_sal_date13)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")) or (a.PER_ID in (". implode(",", $arr_sal_date8) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date9) .")) or (a.PER_ID in (". implode(",", $arr_sal_date10) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date11) .")) or (a.PER_ID in (". implode(",", $arr_sal_date12) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date13) .")))";
			elseif (count($arr_sal_date12)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")) or (a.PER_ID in (". implode(",", $arr_sal_date8) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date9) .")) or (a.PER_ID in (". implode(",", $arr_sal_date10) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date11) .")) or (a.PER_ID in (". implode(",", $arr_sal_date12) .")))";
			elseif (count($arr_sal_date11)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")) or (a.PER_ID in (". implode(",", $arr_sal_date8) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date9) .")) or (a.PER_ID in (". implode(",", $arr_sal_date10) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date11) .")))";
			elseif (count($arr_sal_date10)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")) or (a.PER_ID in (". implode(",", $arr_sal_date8) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date9) .")) or (a.PER_ID in (". implode(",", $arr_sal_date10) .")))";
			elseif (count($arr_sal_date9)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")) or (a.PER_ID in (". implode(",", $arr_sal_date8) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date9) .")))";
			elseif (count($arr_sal_date8)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")) or (a.PER_ID in (". implode(",", $arr_sal_date8) .")))";
			elseif (count($arr_sal_date7)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")) or 
																														(a.PER_ID in (". implode(",", $arr_sal_date7) .")))";
			elseif (count($arr_sal_date6)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																																(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																																(a.PER_ID in (". implode(",", $arr_sal_date5) .")) or (a.PER_ID in (". implode(",", $arr_sal_date6) .")))";
			elseif (count($arr_sal_date5)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																																(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")) or 
																																(a.PER_ID in (". implode(",", $arr_sal_date5) .")))";
			elseif (count($arr_sal_date4)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																																(a.PER_ID in (". implode(",", $arr_sal_date3) .")) or (a.PER_ID in (". implode(",", $arr_sal_date4) .")))";
			elseif (count($arr_sal_date3)) $arr_search_salaryhis_condition[] = "((a.PER_ID in (". implode(",", $arr_sal_date) .")) or (a.PER_ID in (". implode(",", $arr_sal_date2) .")) or 
																																(a.PER_ID in (". implode(",", $arr_sal_date3) .")))";
