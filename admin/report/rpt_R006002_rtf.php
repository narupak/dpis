...
//	echo "default font_id::".$RTF->dfl_FontID."<br>";	
	...
	function count_promote($search_budget_year, $PER_ID){
		...
		switch($search_layer_no){
			case "0.5" :
				$search_condition = "(MOV_SUB_TYPE in ('45') or SM_CODE = '1' or (SAH_PERCENT_UP > 0 and SAH_PERCENT_UP <= 1))";
				break;
			case "1" :
				$search_condition = "(MOV_SUB_TYPE in ('46') or SM_CODE = '2' or (SAH_PERCENT_UP > 1 and SAH_PERCENT_UP <= 2))";
				break;
			case "1.5" :
				$search_condition = "(MOV_SUB_TYPE in ('47') or SM_CODE = '3' or (SAH_PERCENT_UP > 2 and SAH_PERCENT_UP <= 3))";
				break;
			case "2" :
				$search_condition = "(MOV_SUB_TYPE in ('48') or SM_CODE = '4' or (SAH_PERCENT_UP > 3 and SAH_PERCENT_UP <= 4))";
				break;
			case "3" :
