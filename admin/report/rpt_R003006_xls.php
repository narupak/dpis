<?php
	...
	include ("rpt_R003006_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
        $ws_head_line1 = array("$heading_name","<**1**>จำนวน$PERSON_TYPE[$search_per_type]","<**1**>","<**1**>","<**1**>","<**2**>อัตรา (ร้อยละ)","<**2**>อัตรา (ร้อยละ)");
        $ws_head_line2 = array("","ต้นปี","เข้า","ออก","สิ้นปี","เข้า","ออก");
