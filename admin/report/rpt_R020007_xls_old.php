...
//	$arr_search_condition[] = "(a.PER_STATUS in (". implode(", ", $search_per_status) ."))";
	...
	function print_header(){
		...
		$worksheet->write($xlsRow, 6, "วัน/เดือน/ปี", set_format("xlsFmtTableHeader", "B", "C", "LTR", 0));
		...
		$worksheet->write($xlsRow, 9, "สาเหตุ", set_format("xlsFmtTableHeader", "B", "C", "LTR", 0));
		$xlsRow++;
		...
		$worksheet->write($xlsRow, 6, "เกิด", set_format("xlsFmtTableHeader", "B", "C", "LBR", 0));
		$worksheet->write($xlsRow, 7, "ที่บรรจุ", set_format("xlsFmtTableHeader", "B", "C", "LBR", 0));
		$worksheet->write($xlsRow, 8, "ที่เสียชีวิต", set_format("xlsFmtTableHeader", "B", "C", "LBR", 0));
		$worksheet->write($xlsRow, 9, "ที่เสียชีวิต", set_format("xlsFmtTableHeader", "B", "C", "LBR", 0));
	} // function		
