...
//	fix head for rpt_R007002
	...
	$heading_text[] = "<**1**>ป่วย|วันที่ลา|";
	$heading_text[] = "<**1**>ป่วย|(รวม)วัน|ทำการ";
	$heading_text[] = "<**1**>ป่วย|จำนวน|(ครั้ง)";
	$heading_text[] = "<**2**>กิจ|วันที่ลา|";
	$heading_text[] = "<**2**>กิจ|(รวม)วัน|ทำการ";
	$heading_text[] = "<**2**>กิจ|จำนวน|(ครั้ง)";
	$heading_text[] = "รวม|ป่วย/กิจ|(ครั้ง)";
	$heading_text[] = "<**3**>สาย|วันที่|สาย";
	$heading_text[] = "<**3**>สาย|(รวม)วัน|";
	$heading_text[] = "<**4**>พักผ่อน|วันที่ลา|";
	$heading_text[] = "<**4**>พักผ่อน|(รวม)วัน|";
	$heading_text[] = "<**5**>อื่น ๆ|วันที่|";
	$heading_text[] = "<**5**>อื่น ๆ|(รวม)วัน|";
	...
	if($have_pic)
	$data_align = array("C","C","C","L","L","R","R","L","R","R","R","L","R","L","R","L","R","L");
	else
	$data_align = array("C","C","L","L","R","R","L","R","R","R","L","R","L","R","L","R","L");
