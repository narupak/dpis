<?
	...
	include ("rpt_R004097_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ลำดับ", "ชื่อ - นามสกุล", "ประวัติ", "ชื่อตำแหน่ง", "ระดับ", "วันเข้าสู่", "ประวัติ") ;
		$ws_head_line2 = array("", "", "การศึกษา", "", "", "ระดับ", "การอบรม/ดูงาน");
		...
		$ws_width = array(5,30,50,30,15,15,50);
	...
	********************************/	
	...
	if($count_data){
		...
		// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนข้อมูล
			...
			$wsdata_align_1 = array("R","L","L","C","C","C","L");
