...
/*	if($select_org_structure==0){ $list_type_text .= " โครงสร้างตามกฏหมาย"; 	}
	...
	if(in_array(1, $search_per_type)) $report_title = "$DEPARTMENT_NAME||รายชื่อข้าราชการ (ตามมอบหมายงาน)";
	$report_code = "R0495";
	...
	function print_header(){
		...
		$worksheet->write($xlsRow, 4, "ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
		$worksheet->write($xlsRow, 5, "ประเภท", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
		$worksheet->write($xlsRow, 6, "ระดับ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
		$worksheet->write($xlsRow, 7, "เงินเดือน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
		$worksheet->write($xlsRow, 8, "หน่วยงานตามกฎหมาย", set_format("xlsFmtTableHeader", "B", "C", "TLB", 1));
		...
		$worksheet->write($xlsRow, 12, "หน่วยงานตามมอบหมายงาน", set_format("xlsFmtTableHeader", "B", "C", "TLB", 1));
		...
		$worksheet->write($xlsRow, 16, "กรมเดียวกัน/", set_format("xlsFmtTableHeader", "B", "C", "LTR", 1));
		...
		$worksheet->write($xlsRow, 11, "กรม", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 12, "กลุ่ม/ผ่าย/สำนัก", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 13, "จังหวัด", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 14, "สังกัด", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 15, "กรม", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 16, "ต่างกรม", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
	} // function		
