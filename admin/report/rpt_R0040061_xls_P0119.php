...
//	$arr_history_name = array("POSITIONHIS", "SALARYHIS", "EXTRA_INCOMEHIS", "EDUCATE", "TRAINING", "ABILITY", "HEIR", "ABSENTHIS", "PUNISHMENT", "TIMEHIS", "REWARDHIS", "MARRHIS", "NAMEHIS", "DECORATEHIS", "SERVICEHIS", "SPECIALSKILLHIS"); 
	...
	if(in_array("SELECT", $list_type)){
                //$SELECTED_PER_ID =  "16400,14335,14211,14411,14123,14113,14258,14370,14168,14237,14317,16031,15997,14371,16149,14432,16109,16117,16050,16378,16385,16004,16005,14384,16435,14078,14188,16407,15953,15950,14404,14423,14135,16111,14433,16064,16472,16449,16450,14127,16218,15947,14366,16090,14372,14203,14202,14490,16184,16220,15863,13957,15973,14508,15420,16112,16103,14505,14410,16306,14194,14353,14182,14164,15920,15865,14398,14333,14408,14331,14459,14337,14300,16215,16174,16335,16070,16277,16176,16284,16298,16468,13991,14117,14492,14132,14427,15868,14052,15932,16296,14376,16475,16453,15873,16012,16145,16283,14119,14516,
                //                     14488,16118,16310,16460,16399,14509,14026,16167,14031,16368,14320,14033,14318,14512,14014,14489,14341,14375,16110,14478,16126,16307,15984,14443,16137,16377,16380,16461,15983,14446,14161,14388,14310,14442,16131,14449,16301,14101,14186,16371,13980,16416,16171,16142,14153,16402,16438,14098,14179,14527,15948,15995,16384,14399,15869,14417,14473,16376,15982,14102,16127,16057,16212,15879,16150,13984,16317,13967,14345,16363,14465,14439,15936,15956,16361,15985,15988,16175,16129,15990,15991,16423,16086,16424,14324,16230,16469,16259,16023,16473,16189,16282,14403,16382,16474,14518,16381,16051,14526,16331,
                //                     16365,14056,16327,15958,14321,16362,16252,15955,14409,16442,16392,16401,16465,16463,15980,16027,16238,16302,16300,16297,16068,14004,16330,16250,16130,16000,16165,16084,16235,14313,13987,14378,13983,16066,13985,16010,14402,14431,16067,16290,16433,16294,13962,14361";
                //$SELECTED_PER_ID =  "16400,14335,14211,14411,14123,14113,14258,14370,14168,14237,14317,16031,15997,14371,16149,14432,16109,16117,16050,16378,16385,16004,16005,14384,16435,14078,14188,16407,15953,15950,14404,14423,14135,16111,14433,16064,16472,16449,16450,14127,16218,15947,14366,16090,14372,14203,14202,14490,16184,16220,15863,13957,15973,14508,15420,16112,16103,14505,14410,16306,14194,14353,14182,14164,15920,15865,14398,14333,14408,14331,14459,14337,14300,16215,16174,16335,16070,16277,16176,16284,16298,16468,13991,14117,14492,14132,14427,15868,14052,15932,16296,14376,16475,16453,15873,16012,16145,16283,14119,14516,14488,16118,16310,16460,16399,14509,14026,16167,14031,16368,14320,14033,14318,14512,14014,14489,14341,14375,16110,14478,16126,16307,15984,14443,16137,16377,16380,16461,15983,14446,14161,14388,14310,14442,16131,14449,16301,14101,14186,16371,13980,16416,16171,16142,14153,16402,16438,14098,14179,14527,15948,15995,16384,14399,15869,14417,14473,16376,15982,14102,16127,16057,16212,15879,16150,13984,16317,13967,14345,16363,14465,14439,15936,15956,16361,15985,15988,16175,16129,15990,15991,16423,16086,16424,14324,16230,16469,16259,16023,16473,16189,16282,14403,16382,16474,14518,16381,16051,14526,16331,16365,14056,16327,15958,14321,16362,16252,15955,14409,16442,16392,16401,16465,16463,15980,16027,16238,16302,16300,16297,16068,14004,16330,16250,16130,16000,16165,16084,14313,16235,13987,14378,13983,16066,13985,16010,14402,13962,16294,16433,16290,16067,14431,14361,16441";
		if($SELECTED_PER_ID){	
                    $cnt = 0;
...
/*	$list_type_text = $ALL_REPORT_TITLE;
	...
	$heading_width[POSITIONHIS][10] = "25";
	$heading_width[POSITIONHIS][11] = "30";
	$heading_width[POSITIONHIS][12] = "25";
	...
	function print_header($HISTORY_NAME,$data_count){
		global ${"worksheet".$data_count}, $xlsRow;
		global $heading_width, $DEPARTMENT_TITLE, $ORG_TITLE, $REMARK_TITLE, $PL_TITLE;
                
		switch($HISTORY_NAME){
			case "POSITIONHIS" :
				${"worksheet".$data_count}->set_column(0, 0,$heading_width[POSITIONHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[POSITIONHIS][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[POSITIONHIS][2]);
				${"worksheet".$data_count}->set_column(3,3,$heading_width[POSITIONHIS][3]);
				${"worksheet".$data_count}->set_column(4,4,$heading_width[POSITIONHIS][4]);
				${"worksheet".$data_count}->set_column(5,5,$heading_width[POSITIONHIS][5]);
				${"worksheet".$data_count}->set_column(6,6,$heading_width[POSITIONHIS][6]);
				${"worksheet".$data_count}->set_column(7,7,$heading_width[POSITIONHIS][7]);
				${"worksheet".$data_count}->set_column(8,8,$heading_width[POSITIONHIS][8]);
				${"worksheet".$data_count}->set_column(9,9,$heading_width[POSITIONHIS][9]);
				${"worksheet".$data_count}->set_column(10,10,$heading_width[POSITIONHIS][10]);
				${"worksheet".$data_count}->set_column(11,11,$heading_width[POSITIONHIS][11]);
				${"worksheet".$data_count}->set_column(12,12,$heading_width[POSITIONHIS][12]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"วัน เดือน ปี", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,1,"ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,2,"ประเภทการเคลื่อนไหว", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,3,"เลขที่", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,4,"ระดับ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,5,"อัตรา", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,6,"เอกสาร", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,7,"$DEPARTMENT_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,8,"$ORG_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,9,"ต่ำกว่าสำนัก/กอง 1 ระดับ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,10,"$ORG_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,11,"ต่ำกว่าสำนัก/กอง 1 ระดับ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,12,"$REMARK_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,1,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,2,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,3,"ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,4,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,5,"เงินเดือน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,6,"อ้างอิง", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,7,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,8,"ตามกฏหมาย", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,9,"ตามกฏหมาย", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,10,"ตามมอบหมายงาน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,11,"ตามมอบหมายงาน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,12,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				break;	
			case "EDUCATE" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[EDUCATE][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[EDUCATE][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[EDUCATE][2]);
                                ${"worksheet".$data_count}->set_column(3,3,$heading_width[EDUCATE][3]);
                                ${"worksheet".$data_count}->set_column(4,4,$heading_width[EDUCATE][4]);
                                ${"worksheet".$data_count}->set_column(5,5,$heading_width[EDUCATE][5]);

				$xlsRow++;	
				${"worksheet".$data_count}->write($xlsRow,0,"สถานศึกษา", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,1,"ตั้งแต่ - ถึง", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				${"worksheet".$data_count}->write($xlsRow,2,"วุฒิที่ได้รับ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
                                ${"worksheet".$data_count}->write($xlsRow,3,"ประเทศ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
                                ${"worksheet".$data_count}->write($xlsRow,4,"เกียรตินิยม", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
                                ${"worksheet".$data_count}->write($xlsRow,5,"ทุนการศึกษา", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
				
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));	//ฝึกอบรม และดูงาน
				${"worksheet".$data_count}->write($xlsRow,1,"(เดือน ปี)", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				${"worksheet".$data_count}->write($xlsRow,2,"ระบุสาขาวิชาเอก (ถ้ามี)", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
                                ${"worksheet".$data_count}->write($xlsRow,3,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
                                ${"worksheet".$data_count}->write($xlsRow,4,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
                                ${"worksheet".$data_count}->write($xlsRow,5,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
				break;			
		case "TRAINING" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[TRAINING][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[TRAINING][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[TRAINING][2]);
				${"worksheet".$data_count}->set_column(3,3,$heading_width[TRAINING][3]);
				${"worksheet".$data_count}->set_column(4,4,$heading_width[TRAINING][4]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"สถานที่ฝึกอบรม", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"ตั้งแต่ - ถึง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,2,"โครงการ, หลักสูตร", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,3,"หน่วยงานที่จัด", set_format("xlsFmtTableHeader", "B", "C", "TLRB",1));
				${"worksheet".$data_count}->write($xlsRow,4,"ได้รับ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;				
                case "SALARYHIS" :
                    ${"worksheet".$data_count}->set_column(0, 0, $heading_width[POSITIONHIS][0]);
                    ${"worksheet".$data_count}->set_column(1,1,$heading_width[POSITIONHIS][1]);
                    ...
                    ${"worksheet".$data_count}->write($xlsRow,7,"$DEPARTMENT_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
                    ${"worksheet".$data_count}->write($xlsRow,8,"$ORG_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
                    ${"worksheet".$data_count}->write($xlsRow,9,"$ORG_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
                    ${"worksheet".$data_count}->write($xlsRow,10,"$REMARK_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
                    ...
                    ${"worksheet".$data_count}->write($xlsRow,7,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
                    ${"worksheet".$data_count}->write($xlsRow,8,"ตามกฏหมาย", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
                    ${"worksheet".$data_count}->write($xlsRow,9,"ตามมอบหมายงาน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
                    ${"worksheet".$data_count}->write($xlsRow,10,"", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
                    break;	
                case "EXTRAHIS" :
                    ${"worksheet".$data_count}->set_column(0,0,$heading_width[EXTRA_INCOMEHIS][0]);
                    ${"worksheet".$data_count}->set_column(1,1,$heading_width[EXTRA_INCOMEHIS][1]);
                    ${"worksheet".$data_count}->set_column(2,2,$heading_width[EXTRA_INCOMEHIS][2]);
                    ${"worksheet".$data_count}->set_column(3,3,$heading_width[EXTRA_INCOMEHIS][3]);

                    $xlsRow++;
                    ${"worksheet".$data_count}->write($xlsRow,0,"วันที่", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
                    ${"worksheet".$data_count}->write($xlsRow,1,"ถึงวันที่", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
                    ${"worksheet".$data_count}->write($xlsRow,2,"ประเภทเงิน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
                    ${"worksheet".$data_count}->write($xlsRow,3,"จำนวน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
                    break;    
		case "EXTRA_INCOMEHIS" :
				...
				${"worksheet".$data_count}->write($xlsRow,0,"วันที่", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"ถึงวันที่", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,2,"ประเภทเงินเพิ่มพิเศษ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,3,"เงินเพิ่มพิเศษ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "ABILITY" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[ABILITY][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[ABILITY][1]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"ด้านความสามารถพิเศษ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"ความสามารถพิเศษ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "HEIR" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[HEIR][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[HEIR][1]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"ความสัมพันธ์", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"ชื่อ - สกุล", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "ABSENTHIS" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[ABSENTHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[ABSENTHIS][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[ABSENTHIS][2]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"วันที่ลา", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"จำนวนวัน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,2,"ประเภทการลา", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "PUNISHMENT" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[PUNISHMENT][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[PUNISHMENT][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[PUNISHMENT][2]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"ฐานความผิด", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"กรณีความผิด", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,2,"วันที่รับโทษ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "TIMEHIS" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[TIMEHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[TIMEHIS][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[TIMEHIS][2]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"เวลาทวีคูณ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"จำนวนวัน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,2,"จำนวนวันที่ไม่นับ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "REWARDHIS" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[REWARDHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[REWARDHIS][1]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"วันที่ได้รับความดีความชอบ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"ความดีความชอบ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "MARRHIS" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[MARRHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[MARRHIS][1]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"ชื่อคู่สมรส", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"วันที่สมรส", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "NAMEHIS" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[NAMEHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[NAMEHIS][1]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"วันที่เปลี่ยนแปลง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"คำนำหน้า - ชื่อ - สกุล", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "DECORATEHIS" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[DECORATEHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[DECORATEHIS][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[DECORATEHIS][2]);
				${"worksheet".$data_count}->set_column(3,3,$heading_width[DECORATEHIS][3]);
				${"worksheet".$data_count}->set_column(4,4,$heading_width[DECORATEHIS][4]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"(1)", set_format("xlsFmtTableHeader", "B", "C", "LTR", 0));
				${"worksheet".$data_count}->write($xlsRow,1,"(2)", set_format("xlsFmtTableHeader", "B", "C", "LTR", 0));
				${"worksheet".$data_count}->write($xlsRow,2,"(3)", set_format("xlsFmtTableHeader", "B", "C", "LTR", 0));
				${"worksheet".$data_count}->write($xlsRow,3,"(4)", set_format("xlsFmtTableHeader", "B", "C", "LTR", 0));
				${"worksheet".$data_count}->write($xlsRow,4,"(5)", set_format("xlsFmtTableHeader", "B", "C", "LTR", 0));
				
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"ตำแหน่ง (อดีต-ปัจจุบัน", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				${"worksheet".$data_count}->write($xlsRow,1,"ลำดับเครื่องราชฯ ที่ได้รับ", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				${"worksheet".$data_count}->write($xlsRow,2,"ว.ด.ป.", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				${"worksheet".$data_count}->write($xlsRow,3,"เครื่องราชฯ", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				${"worksheet".$data_count}->write($xlsRow,4,"เครื่องราชฯ", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"เฉพาะปีที่ได้รับ", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				${"worksheet".$data_count}->write($xlsRow,1,"พระราชทานแล้ว", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				${"worksheet".$data_count}->write($xlsRow,2,"ที่ได้รับ", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				${"worksheet".$data_count}->write($xlsRow,3,"ตาม (2)", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				${"worksheet".$data_count}->write($xlsRow,4,"ตาม (2)", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
				
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"พระราชทานเครื่องราชฯ)", set_format("xlsFmtTableHeader", "B", "C", "LBR", 0));
				${"worksheet".$data_count}->write($xlsRow,1,"จากชั้นรองไปชั้นสูงตาม (1)", set_format("xlsFmtTableHeader", "B", "C", "LBR", 0));
				${"worksheet".$data_count}->write($xlsRow,2,"พระราชทานตาม (2)", set_format("xlsFmtTableHeader", "B", "C", "LBR", 0));
				${"worksheet".$data_count}->write($xlsRow,3,"รับมอบเมื่อ ", set_format("xlsFmtTableHeader", "B", "C", "LBR", 0));
				${"worksheet".$data_count}->write($xlsRow,4,"ส่งคืนเมื่อ ", set_format("xlsFmtTableHeader", "B", "C", "LBR", 0));
				break;			
			case "SERVICEHIS" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[SERVICEHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[SERVICEHIS][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[SERVICEHIS][2]);
				${"worksheet".$data_count}->set_column(3,3,$heading_width[SERVICEHIS][3]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"วัน เดือน ปี", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"ประเภทราชการพิเศษ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,2,"หัวข้อราชการพิเศษ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,3,"หนังสือ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;			
			case "SPECIALSKILLHIS" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[SPECIALSKILLHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[SPECIALSKILLHIS][1]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"ด้านความเชี่ยวชาญพิเศษ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"เน้นทาง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;	
			case "ACTINGHIS" :
				${"worksheet".$data_count}->set_column(0, 0, $heading_width[ACTINGHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[ACTINGHIS][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[ACTINGHIS][2]);
				${"worksheet".$data_count}->set_column(3,3,$heading_width[ACTINGHIS][3]);
				${"worksheet".$data_count}->set_column(4,4,$heading_width[ACTINGHIS][4]);
				${"worksheet".$data_count}->set_column(5,5,$heading_width[ACTINGHIS][5]);
				${"worksheet".$data_count}->set_column(6,6,$heading_width[ACTINGHIS][6]);
				${"worksheet".$data_count}->set_column(7,7,$heading_width[ACTINGHIS][7]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"ประเภทการเคลื่อนไหว", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
				${"worksheet".$data_count}->write($xlsRow,1,"เลขที่คำสั่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
				${"worksheet".$data_count}->write($xlsRow,2,"ตั้งแต่วันที่", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
				${"worksheet".$data_count}->write($xlsRow,3,"ถึงวันนี้", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
				${"worksheet".$data_count}->write($xlsRow,4,"เลขที่ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
				${"worksheet".$data_count}->write($xlsRow,5,"$PL_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
				${"worksheet".$data_count}->write($xlsRow,6,"$DEPARTMENT_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
				${"worksheet".$data_count}->write($xlsRow,7,"$ORG_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
			break;	
		case "LICENSEHIS" :
				${"worksheet".$data_count}->set_column(0,0,$heading_width[LICENSEHIS][0]);
				${"worksheet".$data_count}->set_column(1,1,$heading_width[LICENSEHIS][1]);
				${"worksheet".$data_count}->set_column(2,2,$heading_width[LICENSEHIS][2]);
				${"worksheet".$data_count}->set_column(3,3,$heading_width[LICENSEHIS][3]);
				${"worksheet".$data_count}->set_column(4,4,$heading_width[LICENSEHIS][4]);
			
				$xlsRow++;
				${"worksheet".$data_count}->write($xlsRow,0,"ใบอนุญาตประกอบวิชาชีพ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,1,"ประเภท/ระดับของใบอนุญาต", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,2,"สาขา", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				${"worksheet".$data_count}->write($xlsRow,3,"เลขที่ใบอนุญาต", set_format("xlsFmtTableHeader", "B", "C", "TLRB",1));
				${"worksheet".$data_count}->write($xlsRow,4,"วันที่หมดอายุ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
				break;				
		} // end switch case
	} // function		
	...
	if($DPISDB=="odbc"){
		...
		$cmd = "select			a.ORG_ID_1 as ORG_ID_1_ASS ,a.ORG_ID_2 as ORG_ID_2_ASS,a.ORG_ID as ORG_ID_ASS, a.PER_ID, a.LEVEL_NO, f.LEVEL_NAME, b.PN_NAME, a.PER_NAME, a.PER_SURNAME, a.PER_BIRTHDATE, 
						...
						where		trim(a.PN_CODE)=trim(b.PN_CODE) and 
											...
											$search_condition
						order by	to_number(replace(c.POS_NO,'-','')),to_number(replace(d.POEM_NO,'-','')),to_number(replace(e.POEMS_NO,'-','')),a.PER_NAME, a.PER_SURNAME ";
	}elseif($DPISDB=="mysql"){
		$cmd = " select			a.PER_ID, a.LEVEL_NO, f.LEVEL_NAME, b.PN_NAME, a.PER_NAME, a.PER_SURNAME, a.PER_BIRTHDATE, 
											a.PER_SALARY, a.PER_MGTSALARY, a.PER_STARTDATE, a.PER_RETIREDATE,a.PER_OCCUPYDATE,
											a.PER_TYPE, a.PER_CARDNO,a.POS_ID, a.POEM_ID, a.POEMS_ID,
...
//	$db_dpis->show_error();
	if($count_data){
		...
		while($data = $db_dpis->get_array()){
                        $data_count++;
                        $POS_NO_SHEET = 'P0119_'.$data_count;
                        if($search_per_type==1){
                            $POS_NO_SHEET = $data[POS_NO];
                        }else if($search_per_type==2){
                            $POS_NO_SHEET = $data[EMP_POS_NO];
                        }else if($search_per_type==3){
                            $POS_NO_SHEET = $data[EMPSER_POS_NO];
                        }
                        ${"worksheet".$data_count} = &$workbook->addworksheet("$POS_NO_SHEET");
                        ${"worksheet".$data_count}->set_margin_right(0.50);
                        ${"worksheet".$data_count}->set_margin_bottom(1.10);
                        ...
                        for($i=0; $i<count($arr_title); $i++){
                                $xlsRow = $i;
                                ${"worksheet".$data_count}->write($xlsRow, 0, $arr_title[$i], set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 1, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 2, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 3, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 4, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 5, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 6, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 7, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 8, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 9, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 10,"", set_format("xlsFmtTitle", "B", "C", "", 1));
                        }

                        if($company_name){
                                $xlsRow++;
                                ${"worksheet".$data_count}->write($xlsRow, 0, $company_name, set_format("xlsFmtSubTitle", "B", "L", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 1, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 2, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 3, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 4, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 5, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 6, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 7, "", set_format("xlsFmtTitle", "B", "C", "", 1));
                                ${"worksheet".$data_count}->write($xlsRow, 8, "", set_format("xlsFmtTitle", "B", "C", "", 1));
...
//			 $db_dpis2->show_error();
	...
	//		$db_dpis2->show_error();
			...
			${"worksheet".$data_count}->set_column(0, 0, 50);
			${"worksheet".$data_count}->set_column(1,1, 50);
			${"worksheet".$data_count}->set_column(2,2, 75);
			
			$xlsRow++;
			${"worksheet".$data_count}->write($xlsRow, 0, "", set_format("xlsFmtTitle", "B", "C", "", 1));
			${"worksheet".$data_count}->write($xlsRow, 1, "", set_format("xlsFmtTitle", "B", "C", "", 1));
			${"worksheet".$data_count}->write($xlsRow, 2, "", set_format("xlsFmtTitle", "B", "C", "", 1));
			$xlsRow++;
			${"worksheet".$data_count}->write($xlsRow, 0, "", set_format("xlsFmtTitle", "B", "C", "", 1));
			...
			$xlsRow++;
			${"worksheet".$data_count}->write_string($xlsRow, 0, "ชื่อ  ".$FULLNAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			${"worksheet".$data_count}->write_string($xlsRow, 1,"ชื่อคู่สมรส ".($SHOW_SPOUSE?$SHOW_SPOUSE:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			${"worksheet".$data_count}->write_string($xlsRow, 2,"วันสั่งบรรจุ  ".($PER_STARTDATE?$PER_STARTDATE:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			${"worksheet".$data_count}->write($xlsRow, 3, "", set_format("xlsFmtTitle", "B", "L", "TBR", 0));
	//		if($img_file){
	//			$image_x = ($pdf->x + 155);		$image_y = $pdf->y;		$image_w = 30;			$image_h = 35;
	//			${"worksheet".$data_count}->write($xlsRow, 4, "", set_format("xlsFmtTitle", "B", "C", "TL", 0));
	//			${"worksheet".$data_count}->insertBitmap($xlsRow, 4, "$img_file", 20, 10, $image_w, $image_h);
	//			${"worksheet".$data_count}->write($xlsRow, 5, "", set_format("xlsFmtTitle", "B", "C", "TL", 0));
	//		} else {
				${"worksheet".$data_count}->write($xlsRow, 4, "", set_format("xlsFmtTitle", "B", "C", "", 0));
				${"worksheet".$data_count}->write($xlsRow, 5, "", set_format("xlsFmtTitle", "B", "C", "", 0));
	//		} // end if
		
			$xlsRow++;
			${"worksheet".$data_count}->write_string($xlsRow, 0,"วัน เดือน ปี เกิด  ".($PER_BIRTHDATE?$PER_BIRTHDATE:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			${"worksheet".$data_count}->write_string($xlsRow, 1,"ชื่อบิดา  ".($FATHERNAME?$FATHERNAME:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			${"worksheet".$data_count}->write_string($xlsRow, 2,"วันเริ่มปฏิบัติราชการ  ".($PER_STARTDATE?$PER_STARTDATE:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			${"worksheet".$data_count}->write($xlsRow, 3, "", set_format("xlsFmtTitle", "B", "L", "TBR", 0));
			${"worksheet".$data_count}->write($xlsRow, 4, "", set_format("xlsFmtTitle", "B", "L", "", 0));
			${"worksheet".$data_count}->write($xlsRow, 5, "", set_format("xlsFmtTitle", "B", "L", "", 0));
			
			$xlsRow++;
			${"worksheet".$data_count}->write_string($xlsRow, 0,"วันเกษียณอายุ ".($PER_RETIREDATE?$PER_RETIREDATE:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			${"worksheet".$data_count}->write_string($xlsRow, 1,"ชื่อมารดา  ".($MOTHERNAME?$MOTHERNAME:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			${"worksheet".$data_count}->write_string($xlsRow, 2,"ประเภท".($OT_NAME?$OT_NAME:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			${"worksheet".$data_count}->write($xlsRow, 3, "", set_format("xlsFmtTitle", "B", "L", "TBR", 0));
			${"worksheet".$data_count}->write($xlsRow, 4, "", set_format("xlsFmtTitle", "B", "L", "", 0));
			${"worksheet".$data_count}->write($xlsRow, 5, "", set_format("xlsFmtTitle", "B", "L", "", 0));
...
//		$pdf->AutoPageBreak = false;
			...
			if($DPISDB=="odbc"){
				...
				$cmd = "select a.POH_ORG2 as ORG_NAME_1, a.POH_ORG3 as ORG_NAME_2, a.POH_UNDER_ORG1, a.POH_ASS_ORG, a.POH_ASS_ORG1, a.POH_EFFECTIVEDATE, a.MOV_CODE, d.PL_NAME, i.PN_NAME, 
                                            a.LEVEL_NO, g.LEVEL_NAME, a.POH_POS_NO_NAME, a.POH_POS_NO, a.POH_SALARY, a.POH_DOCNO, a.PT_CODE, e.PT_NAME, a.PM_CODE, f.PM_NAME,
...
//							$db_dpis2->show_error();
			...
			for($history_index=0; $history_index<count($arr_history_name); $history_index++){
				...
				for($hw=0;	 $hw < count($heading_width[$HISTORY_NAME]); $hw++){
					${"worksheet".$data_count}->set_column($hw, $hw, $heading_width[$HISTORY_NAME][$hw]);
					//เพิ่มช่องว่างบรรทัดใหม่
					${"worksheet".$data_count}->write($xlsRow,$hw, "", set_format("xlsFmtTitle", "B", "C", "", 1));
				}
			switch($HISTORY_NAME){
				case "POSITIONHIS" : //รวมประวัติรับราชการ + เลื่อนขั้นเงินเดือนเข้าด้วยกัน
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการรับราชการ ", set_format("xlsFmtSubTitle", "B", "L", "", 0));	// 0 สุดท้ายทำให้หัวข้อชิดซ้าย
							print_header($HISTORY_NAME,$data_count);
						...
						if(is_array($POH_SAH_HIS)  && !empty($POH_SAH_HIS)){
							...
							$positionhis_count=0;
							 for($in=0; $in < count($POH_SAH_HIS[$PER_ID]);$in++){
									...
									//--------------------------------------------------------------------
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$DATE_POH_SAH, set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); //$POH_SAH_HIS[$PER_ID][$in]['DATE']
									//${"worksheet".$data_count}->write_string($xlsRow,1,$POH_SAH_HIS[$PER_ID][$in]['POS_NAME']." ".$LEVEL_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 	//ตำแหน่ง   /*เดิม*/
                                                                        ${"worksheet".$data_count}->write_string($xlsRow,1,$POH_SAH_HIS[$PER_ID][$in]['POS_NAME'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 	//ตำแหน่ง /*Release 5.2.1.8 */
									${"worksheet".$data_count}->write_string($xlsRow,2,$POH_SAH_HIS[$PER_ID][$in]['MOVE'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));//$POH_SAH_HIS[$PER_ID][$in]['MOVE'] //ประเภทการเคลื่อนไหว
									${"worksheet".$data_count}->write_string($xlsRow,3,$POH_SAH_HIS[$PER_ID][$in]['POS_NO'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));									
									${"worksheet".$data_count}->write_string($xlsRow,4,($LEVEL_NAME?$LEVEL_NAME:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
									${"worksheet".$data_count}->write_string($xlsRow,5,$POH_SAH_HIS[$PER_ID][$in]['SALARY'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
									${"worksheet".$data_count}->write_string($xlsRow,6,$POH_SAH_HIS[$PER_ID][$in]['DOC_NO'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 
									${"worksheet".$data_count}->write_string($xlsRow,7,$POH_SAH_HIS[$PER_ID][$in]['POH_ORG_NAME_2'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
									${"worksheet".$data_count}->write_string($xlsRow,8,$POH_SAH_HIS[$PER_ID][$in]['POH_ORG_NAME_3'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
									${"worksheet".$data_count}->write_string($xlsRow,9,$POH_SAH_HIS[$PER_ID][$in]['POH_UNDER_ORG1'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
									${"worksheet".$data_count}->write_string($xlsRow,10,$POH_SAH_HIS[$PER_ID][$in]['POH_ORGASS_NAME_3'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 
									${"worksheet".$data_count}->write_string($xlsRow,11,$POH_SAH_HIS[$PER_ID][$in]['POH_ASS_ORG1'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 
									${"worksheet".$data_count}->write_string($xlsRow,12,$POH_SAH_HIS[$PER_ID][$in]['REMARK'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 
								} //end for
                                                                unset($data2);
							}
							if($positionhis_count<=0){	//}else{
								//$xlsRow = 0;
								$xlsRow++;
								${"worksheet".$data_count}->write($xlsRow, 0, "***** ไม่มีข้อมูล *****", set_format("xlsFmtTitle", "B", "C", "", 1));
								${"worksheet".$data_count}->write($xlsRow, 1, "", set_format("xlsFmtTitle", "B", "C", "", 1));
								${"worksheet".$data_count}->write($xlsRow, 2, "", set_format("xlsFmtTitle", "B", "C", "", 1));
								${"worksheet".$data_count}->write($xlsRow, 3, "", set_format("xlsFmtTitle", "B", "C", "", 1));
								${"worksheet".$data_count}->write($xlsRow, 4, "", set_format("xlsFmtTitle", "B", "C", "", 1));
								...
								${"worksheet".$data_count}->write($xlsRow, 9, "", set_format("xlsFmtTitle", "B", "C", "", 1));
								${"worksheet".$data_count}->write($xlsRow, 10, "", set_format("xlsFmtTitle", "B", "C", "", 1));
								${"worksheet".$data_count}->write($xlsRow, 11, "", set_format("xlsFmtTitle", "B", "C", "", 1));
								${"worksheet".$data_count}->write($xlsRow, 12, "", set_format("xlsFmtTitle", "B", "C", "", 1));
							} // end if	
						break;
				case "EDUCATE" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow, 0,($no_index)."  ประวัติการศึกษา ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_educatehis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$INS_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
									${"worksheet".$data_count}->write_string($xlsRow,1,"$EDU_PERIOD", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
									${"worksheet".$data_count}->write_string($xlsRow,2,"$EN_NAME  $EM_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                                                        ${"worksheet".$data_count}->write_string($xlsRow,3,"$CT_NAME ", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                                                        ${"worksheet".$data_count}->write_string($xlsRow,4,"$EDU_HONOR ", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                                                        ${"worksheet".$data_count}->write_string($xlsRow,5,"$ST_NAME ", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
			...
			case "TRAINING" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)." ประวัติการฝึกอบรม/สัมมนา/ดูงาน ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_traininghis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$TRN_PLACE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$TRN_DURATION, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,2,$TR_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,3,$TRN_ORG?$TRN_ORG:"-", set_format("xlsFmtTableDetail", "", "L", "TLRB",1));
									${"worksheet".$data_count}->write_string($xlsRow,4,$TRN_FUND?$TRN_FUND:"-",set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));//ทุน
								} // end while
                                                                unset($data2);
							}else{
								//$xlsRow = 0;
                        ...
                        case "SALARYHIS" :
                            $no_index++;
                            $xlsRow++;
                            ${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการเลื่อนขั้นเงินเดือน ", set_format("xlsFmtSubTitle", "B", "L", "", 0));	// 0 สุดท้ายทำให้หัวข้อชิดซ้าย
                            print_header($HISTORY_NAME,$data_count);
                            if(is_array($POH_SALARYHIS)  && !empty($POH_SALARYHIS)){
                                ...
                                for($in=0; $in < count($POH_SALARYHIS[$PER_ID]);$in++){
                                    ...
                                    //--------------------------------------------------------------------
                                    $xlsRow++;
                                    ${"worksheet".$data_count}->write_string($xlsRow,0,$DATE_POH_SAH, set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); //$POH_SALARYHIS[$PER_ID][$in]['DATE']
                                    //${"worksheet".$data_count}->write_string($xlsRow,1,$POH_SALARYHIS[$PER_ID][$in]['POS_NAME']." ".$LEVEL_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 	//ตำแหน่ง   /*เดิม*/
                                    ${"worksheet".$data_count}->write_string($xlsRow,1,$POH_SALARYHIS[$PER_ID][$in]['POS_NAME'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 	//ตำแหน่ง /*Release 5.2.1.8 */
                                    ${"worksheet".$data_count}->write_string($xlsRow,2,$POH_SALARYHIS[$PER_ID][$in]['MOVE'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));//$POH_SALARYHIS[$PER_ID][$in]['MOVE'] //ประเภทการเคลื่อนไหว
                                    ${"worksheet".$data_count}->write_string($xlsRow,3,$POH_SALARYHIS[$PER_ID][$in]['POS_NO'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));									
                                    ${"worksheet".$data_count}->write_string($xlsRow,4,($LEVEL_NAME?$LEVEL_NAME:"-"), set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                    ${"worksheet".$data_count}->write_string($xlsRow,5,$POH_SALARYHIS[$PER_ID][$in]['SALARY'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                    ${"worksheet".$data_count}->write_string($xlsRow,6,$POH_SALARYHIS[$PER_ID][$in]['DOC_NO'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 
                                    ${"worksheet".$data_count}->write_string($xlsRow,7,$POH_SALARYHIS[$PER_ID][$in]['POH_ORG_NAME_2'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                    ${"worksheet".$data_count}->write_string($xlsRow,8,$POH_SALARYHIS[$PER_ID][$in]['POH_ORG_NAME_3'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                    ${"worksheet".$data_count}->write_string($xlsRow,9,$POH_SALARYHIS[$PER_ID][$in]['POH_ORGASS_NAME_3'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 
                                    ${"worksheet".$data_count}->write_string($xlsRow,10,$POH_SALARYHIS[$PER_ID][$in]['REMARK'], set_format("xlsFmtTableDetail", "", "L", "TLRB", 0)); 
                                } //end for
                                unset($data2);
                            }
                            if($positionhis_count<=0){	//}else{
                        ...
                        case "EXTRAHIS" : 
                            $no_index++;
                            $xlsRow++;
                            ${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการรับเงินตามตำแหน่ง ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
                            print_header($HISTORY_NAME,$data_count);
                            ...
                            if($count_extrahis){
                                    ...
                                    while($data2 = $db_dpis2->get_array()){
                                            ...
                                            $xlsRow++;
                                            ${"worksheet".$data_count}->write_string($xlsRow,0,$PMH_EFFECTIVEDATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
                                            ${"worksheet".$data_count}->write_string($xlsRow,1,$PMH_ENDDATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
                                            ${"worksheet".$data_count}->write_string($xlsRow,2,$EX_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
                                            ${"worksheet".$data_count}->write_string($xlsRow,3,number_format($PMH_AMT), set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
                                    } // end while
                                    unset($data2);
                            }else{								
                                    //$xlsRow = 0;
			...
			case "EXTRA_INCOMEHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการรับเงินเพิ่มพิเศษ ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_extrahis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$EXH_EFFECTIVEDATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$EXH_ENDDATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,2,$EX_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,3,number_format($EXH_AMT), set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
					...
					case "ABILITY" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ความสามารถพิเศษ ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_abilityhis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$AL_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$ABI_DESC, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
					...
					case "HEIR" :
                                                         $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ข้อมูลทายาท ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_heirhis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$HR_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB",1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$HEIR_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB",1));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
					...
					case "ABSENTHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการลา สาย ขาด ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_absenthis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$ABS_DURATION, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,($ABS_DAY?$ABS_DAY:""), set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,2,$AB_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
					...
					case "PUNISHMENT" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติทางวินัย ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_punishmenthis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$CR_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$CRD_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,2,$PUN_DURATION, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
					...
					case "TIMEHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติเวลาทวีคูณ ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_timehis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,($TIME_DAY?$TIME_DAY:""), set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,($TIMEH_MINUS?$TIMEH_MINUS:""), set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
					...
					case "REWARDHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการรับความดีความชอบ ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_rewardhis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$REH_DATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$REW_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
					...
					case "MARRHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการสมรส ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_marryhis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$MAH_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$MAH_MARRY_DATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
					...
					case "NAMEHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการเปลี่ยนแปลงชื่อ-สกุล ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_namehis){
								...
								$xlsRow++;				
								${"worksheet".$data_count}->write_string($xlsRow,0,$NH_DATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								${"worksheet".$data_count}->write_string($xlsRow,1,$FULLNAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
					...
					case "DECORATEHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการรับเครื่องราชฯ ", set_format("xlsFmtSubTitle", "B", "L", "",0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_decoratehis){
								...
								$xlsRow++;
								${"worksheet".$data_count}->write_string($xlsRow,0,$DEH_PL_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB",1));
								${"worksheet".$data_count}->write_string($xlsRow,1,$DC_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								${"worksheet".$data_count}->write_string($xlsRow,2,$DEH_DATE1, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								${"worksheet".$data_count}->write_string($xlsRow,3,$DEH_GAZETTE?$DEH_GAZETTE:"-", set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								${"worksheet".$data_count}->write_string($xlsRow,4,"-", set_format("xlsFmtTableDetail", "", "L", "TLRB",1));
								} // end while
                                                                unset($data2);
                                                                unset($data3);
							}else{								
					...
					case "SERVICEHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการปฏิบัติราชการพิเศษ ",set_format("xlsFmtSubTitle", "B", "L", "",0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_servicehis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$SRH_STARTDATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$SV_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,2,$SRT_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,3,$SRH_DOCNO, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{								
								//$xlsRow = 0;
					...
					case "SPECIALSKILLHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ความเชี่ยวชาญพิเศษ ",set_format("xlsFmtSubTitle", "B", "L", "",0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_specialskillhis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$SS_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$SPS_EMPHASIZE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{
								//$xlsRow = 0;
					...
					case "ACTINGHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)."  ประวัติการรักษาราชการ/มอบหมายงาน",set_format("xlsFmtSubTitle", "B", "L", "",0));
							print_header($HISTORY_NAME,$data_count);
	...
	//				$db_dpis2->show_error();
					if($count_actinghis){
								...
								while($data = $db_dpis2->get_array()){
									...
									if (!$TMP_PL_NAME) $TMP_PL_NAME = trim($data[ACTH_PL_NAME]);
										...
										$xlsRow++;
										${"worksheet".$data_count}->write_string($xlsRow,0,"$actinghis_count.) $TMP_MOV_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB",1));
										${"worksheet".$data_count}->write_string($xlsRow,1,$TMP_ACTH_DOCNO, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
										${"worksheet".$data_count}->write_string($xlsRow,2,$TMP_ACTH_EFFECTIVEDATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
										${"worksheet".$data_count}->write_string($xlsRow,3,$TMP_ACTH_ENDDATE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
										${"worksheet".$data_count}->write_string($xlsRow,4,$TMP_ACTH_POS_NO, set_format("xlsFmtTableDetail", "", "L", "TLRB",1));
										${"worksheet".$data_count}->write_string($xlsRow,5,$TMP_PL_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
										${"worksheet".$data_count}->write_string($xlsRow,6,$TMP_ORG_NAME_2, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
										${"worksheet".$data_count}->write_string($xlsRow,7,$TMP_ORG_NAME_3, set_format("xlsFmtTableDetail", "", "L", "TLRB",1));
								} // end while
                                                                unset($data);
                                                                unset($data2);
							}else{
			...
			case "LICENSEHIS" :
                                                        $no_index++;
							$xlsRow++;
							${"worksheet".$data_count}->write_string($xlsRow,0,($no_index)." ประวัติใบอนุญาตประกอบวิชาชีพ", set_format("xlsFmtSubTitle", "B", "L", "", 0));
							print_header($HISTORY_NAME,$data_count);
...
//							$db_dpis2->show_error();
							if($count_licensehis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$xlsRow++;
									${"worksheet".$data_count}->write_string($xlsRow,0,$LT_NAME, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,1,$LH_SUB_TYPE, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,2,$LH_MAJOR, set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
									${"worksheet".$data_count}->write_string($xlsRow,3,$LH_LICENSE_NO, set_format("xlsFmtTableDetail", "", "L", "TLRB",1));
									${"worksheet".$data_count}->write_string($xlsRow,4,$LH_EXPIRE_DATE,set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
								} // end while
                                                                unset($data2);
							}else{
								//$xlsRow = 0;
