...
//	fix head for rpt_R004003
    ...
    $heading_text[0] = "อาวุโส";
    $heading_text[1] = "ชื่อ - สกุล";
	$heading_text[2] = "ระดับ 10";
	$heading_text[3] = "ระดับ 9";
	$heading_text[4] = "ระดับ 8";
	$heading_text[5] = "เงินเดือน";
	$heading_text[6] = "เข้ารับราชการ";
	$heading_text[7] = "เครื่องราชฯ";
	$heading_text[8] = "วันเดือนปีเกิด";
	$heading_text[9] = "เกษียณ";
	$heading_text[10] = "สังกัด (อดีต - ปัจจุบัน)";
	...
	$data_align = array("C","L","C","C","C","R","C","L","C","C","L","L");
