<?
	...
	include ("rpt_R010012_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
...
*/	
	function print_header(){
		...
		global $MINISTRY_TITLE, $DEPARTMENT_TITLE, $ORG_TITLE, $PL_TITLE;
...
//	set_cell_width();
	if($count_data){
		...
		$xlsRow = 0;
		$worksheet->write($xlsRow, 0, "***** ไม่มีข้อมูล *****", set_format("xlsFmtTitle", "fontFormat=B&alignment=&border=&isMerge=1&fgColor=&bgColor=&setRotation=0&valignment=&fontSize=&wrapText=1"));
		for($j=1; $j<=14; $j++) $worksheet->write($xlsRow, $j, "", set_format("xlsFmtTitle", "fontFormat=B&alignment=&border=&isMerge=1&fgColor=&bgColor=&setRotation=0&valignment=&fontSize=&wrapText=1"));
	} // end if
