...
//	fix head for rpt_R003013
	...
	$heading_text[] = "เลขที่|ตำแหน่งเดิม";
	$heading_text[] = "ตำแหน่งเดิม/สังกัด|";
	$heading_text[] = "เลขที่|ตำแหน่งใหม่";
	$heading_text[] = "ตำแหน่งใหม่/สังกัด|";
	$heading_text[] = "วันที่ย้าย|";
	...
	if ($have_pic)
	$data_align = array("C","L","C","L","C","L","C");
	else
