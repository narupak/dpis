<?
	...
	function print_header($xlsRow){
		...
		$worksheet->write($xlsRow, 1, "กลุ่มวันหยุด", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
...
//	echo "<pre>";		print_r($field_list);		echo "</pre>";
	...
	if($DPISDB=="odbc"){
		$cmd = "	select	$data_per_page   $arr_fields[0], $arr_fields[1], $arr_fields[2], $arr_fields[3],$arr_fields[4]
							from		$table
											$search_condition
...
//	$db_dpis->show_error();
	...
	if($count_data){
		...
		while($data = $db_dpis->get_array()){
			...
			$xlsRow = $data_count;
			$worksheet->write_string($xlsRow, 0, $$arr_fields[1], set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
			...
			$worksheet->insert_bitmap($xlsRow, 2, $$arr_fields[4], 35, 4, 1, 0.8);			
		} // end while
