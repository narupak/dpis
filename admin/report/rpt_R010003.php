...
//	session_cache_limiter("nocache");
	...
	$heading_text[3] = "วันเลื่อนระดับ";
	$heading_text[4] = "วันดำรง|ตำแหน่งปัจจุบัน";
	$heading_text[5] = "วันดำรงตำแหน่ง|ปัจจุบัน";
	...
	if($DPISDB=="odbc"){
		...
		$cmd = " select			a.PER_ID, i.PN_NAME, a.PER_NAME, a.PER_SURNAME, a.LEVEL_NO, b.PT_CODE, g.PT_NAME, 
				   ...
				   where		l.DC_TYPE in (1, 2)
				   				$search_condition
				   group by		a.PER_ID, i.PN_NAME, a.PER_NAME, a.PER_SURNAME, a.LEVEL_NO, a.LEVEL_NAME ,b.PT_CODE, g.PT_NAME, 
								b.PL_CODE, f.PL_NAME, b.PM_CODE, h.PM_NAME, LEFT(trim(a.PER_BIRTHDATE), 10), 
								LEFT(trim(a.PER_STARTDATE), 10), LEFT(trim(a.PER_RETIREDATE), 10), 
								a.PER_SALARY, b.ORG_ID, c.ORG_NAME, a.DEPARTMENT_ID, d.ORG_NAME, 
								d.ORG_ID_REF, e.ORG_NAME
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			$RETIREYEAR = $arr_content[$data_count][retireyear];
				...
				$arr_data[] =(($NUMBER_DISPLAY==2)?convert2thaidigit($LEVEL_EFFECTIVEDATE):$LEVEL_EFFECTIVEDATE);       
			   	$arr_data[] =(($NUMBER_DISPLAY==2)?convert2thaidigit($POSITION_EFFECTIVEDATE):$POSITION_EFFECTIVEDATE);       
	    		$arr_data[] =(($NUMBER_DISPLAY==2)?convert2thaidigit($RETIREYEAR):$RETIREYEAR);       
