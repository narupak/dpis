<?
	...
	if (!$CARDNO_FLAG==1) $CARDNO_TITLE = "";
		if ($BKK_FLAG==1) {
			...
			$ws_head_line2 = array("ที่","$CARDNO_TITLE","ตำแหน่ง/สังกัด","ตำแหน่งประเภท","ระดับ","เลขที่","เงินเดือน","ปัจจุบันเมื่อ","วันที่สำเร็จการศึกษา","ปฏิบัติราชการ","เงินเดือน","","");
		} else {
			...
			$ws_head_line2 = array("ที่","$CARDNO_TITLE","ตำแหน่ง/สังกัด","ตำแหน่งประเภท","ระดับ","เลขที่","เงินเดือน","ปัจจุบันเมื่อ","วันสำเร็จการศึกษา","ปฏิบัติราชการ","เงินเดือน","","");
		}
...
//			$CMD_NOTE = $arr_content[$data_count][cmd_note];
			...
			$ws_data_align = array("C", "L", "L", "C", "C", "C", "R", "C", "L", "C", "R", "C", "L");
