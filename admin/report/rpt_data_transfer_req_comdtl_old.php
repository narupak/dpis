...
//	session_cache_limiter("nocache");
	...
	function print_header(){
		...
		if($COM_TYPE=="0101"){
			...
			$pdf->Cell($heading_width[1] ,7,"ชื่อ (วันเดือนปี เกิด)",'LTR',0,'C',1);
			$pdf->Cell($heading_width[2] ,7,"วุฒิ/สาขา/สถานศึกษา",'LTR',0,'C',1);
			$pdf->Cell(($heading_width[3] + $heading_width[4] + $heading_width[5]) ,7,"สอบแข่งขันได้",'LTBR',0,'C',1);
			$pdf->Cell(($heading_width[6] + $heading_width[7] + $heading_width[8]) ,7,"ตำแหน่งที่บรรจุ",'LTBR',0,'C',1);
			...
			$pdf->Cell($heading_width[4] ,7,"ลำดับที่",'LTBR',0,'C',1);
			$pdf->Cell($heading_width[5] ,7,"ประกาศผลการสอบของ",'LTBR',0,'C',1);
			...
			$pdf->Cell($heading_width[1] ,7,"ชื่อ (วันเดือนปี เกิด)",'LTR',0,'C',1);
			$pdf->Cell($heading_width[2] ,7,"วุฒิ/สาขา/สถานศึกษา",'LTR',0,'C',1);
			$pdf->Cell(($heading_width[3] + $heading_width[4] + $heading_width[5]) ,7,"ตำแหน่งที่บรรจุ",'LTBR',0,'C',1);
			$pdf->Cell($heading_width[6] ,7,"ตั้งแต่วันที่",'LTBR',0,'C',1);
			...
			$pdf->Cell(($heading_width[5] + $heading_width[6] + $heading_width[7]) ,7,"ตำแหน่งที่รับโอน",'LTBR',0,'C',1);
			$pdf->Cell($heading_width[8] ,7,"ตั้งแต่วันที่",'LTBR',0,'C',1);
			$pdf->Cell($heading_width[9] ,7,"หมายเหตุ",'LTBR',1,'C',1);
			...
			$pdf->Cell($heading_width[6] ,7,"เลขที่",'LTBR',0,'C',1);
