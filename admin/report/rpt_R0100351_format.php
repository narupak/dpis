...
//	fix head for rpt_R0100351
	...
	$heading_width[7] = "40";
		...
		$heading_text[1] = "<**1**>ชาย|ชื่อ";
		$heading_text[2] = "<**1**>ชาย|";
		$heading_text[3] = "<**1**>ชาย|ตำแหน่ง";
		$heading_text[4] = "ลำดับ|";
		$heading_text[5] = "<**1**>หญิง|ชื่อ";
		$heading_text[6] = "<**1**>หญิง|";
		$heading_text[7] = "<**1**>หญิง|ตำแหน่ง";

	$heading_align = array("C","C","C","C","C","C","C","C");
	
	$data_align = array("C","L","C","L","C","L","C","L");
