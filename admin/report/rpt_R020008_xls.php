	...
	if($count_data){
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if(array_search($REPORT_ORDER, $arr_rpt_order) !== false  && array_search($REPORT_ORDER, $arr_rpt_order) == 0 && count($arr_rpt_order) > 1){
				$xlsRow++;
				$worksheet->write($xlsRow, 0, "$ORDER", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 0));
				...
				$worksheet->write($xlsRow, 4, "$LEVEL_NAME", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 0));
				...
				$worksheet->write_string($xlsRow, 7, "$BIRTHDATE", set_format("xlsFmtTableDetail", "B", "C", "TLRB", 0));
