...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	//		echo "$head_text1<br>";
			$result = $pdf->open_tab($head_text1, $head_width1, 7, "TRHBL", $head_align1, "", "14", "b", "0066CC", "EEEEFF", $COLUMN_FORMAT, $col_function, false); 
		}
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if ($have_pic) $IMAGE = $arr_content[$data_count][image];
