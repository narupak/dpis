<?php
	...
	function print_header(){
		...
		$worksheet->write($xlsRow, 8, "ระยะเวลาที่ดำรงตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
                $worksheet->write($xlsRow, 9, "วันที่ระยะเวลาที่ดำรงตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 10, "อายุราชการ(ปี)", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
                $worksheet->write($xlsRow, 11, "วันที่อายุราชการ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 12, "ระยะเวลาที่อยู่ในระดับ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
                $worksheet->write($xlsRow, 13, "วันที่ระยะเวลาที่อยู่ในระดับ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 14, "ระยะเวลาที่อยู่ในเลขที่ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
                $worksheet->write($xlsRow, 15, "วันที่ระยะเวลาที่อยู่ในเลขที่ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 16, "ระยะเวลาที่อยู่ใน$ORG_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
                $worksheet->write($xlsRow, 17, "วันที่ระยะเวลาที่อยู่ใน$ORG_TITLE", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
	} // function		
