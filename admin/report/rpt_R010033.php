...
//		echo "".implode(",",$org).",".count($org)."<br>";
	...
	//		$pdf->Cell(100,2,"",0,1,'C');
			...
			$pdf->Cell($heading_width[1] ,7,"ตำแหน่งในการบริหารงาน",'LTBR',0,'C',1);
			if(!$idx)	$idx = 2;
			foreach($org_seq as $key => $val) {
				$heading_width[$idx] = "10";
				$pdf->Cell($heading_width[$idx] ,7,$org[$val][name],'LTBR',0,'C',1);
			 $idx++;
			}
			$pdf->Cell($heading_width[$idx] ,7,"รวม",'LTBR',1,'C',1);
		}
	} // function
