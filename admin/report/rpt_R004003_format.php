...
//	fix head for rpt_R004003
	...
	$heading_text[] = "ระดับ|";
        $heading_text[] = "สังกัด|(โครงสร้างตามกฎหมาย)";
        
        $heading_text[] = "สังกัด|(โครงสร้างตามมอบหมายงาน)"; //ADD NEW RECORD
        $heading_text[] = "ตำแหน่งทางการบริหารงานภายใน|"; //ADD NEW RECORD
        $heading_text[] = "รักษาราชการแทน(หน่วยงาน)|"; //ADD NEW RECORD
        $heading_text[] = "ใบอนุญาตประกอบวิชาชีพ|"; //ADD NEW RECORD
        
	$heading_text[] = "เลขที่|ตำแหน่ง";
	$heading_text[] = "วุฒิ|";
	$heading_text[] = "สาขา|วิชาเอก";
        
        $heading_text[] = "ระดับปัจจุบัน|(ใช้เรียงอาวุโส)";//new
        $heading_text[] = "วันที่เข้าสู่ระดับ|(ใช้เรียงอาวุโส)";//new
	...
	$heading_text[] = "วันเกษียณ|";
        //$heading_text[] = "หมายเหตุ|";
         if($have_manage){
            $heading_text[] = "ตำแหน่งทางการบริหาร";
        }
        if($have_competency){
            $heading_text[] = "พิมพ์ผลการประเมินย้อนหลัง 3 ปี|";
            $heading_text[] = "พิมพ์ผลการประเมินย้อนหลัง 3 ปี|";
            $heading_text[] = "พิมพ์ผลการประเมินย้อนหลัง 3 ปี|";
            $heading_text[] = "พิมพ์ผลการประเมินย้อนหลัง 3 ปี|";
            $heading_text[] = "พิมพ์ผลการประเมินย้อนหลัง 3 ปี|";
