...
//		$pdf->Cell(100,2,"",0,1,'C');
		...
		$pdf->Cell(($heading_width[1] + $heading_width[2]) ,7,"ทั่วไป",'LTBR',0,'C',1);
		$pdf->Cell(($heading_width[3] + $heading_width[4]) ,7,"วิชาชีพเฉพาะ",'LTBR',0,'C',1);
		$pdf->Cell(($heading_width[5] + $heading_width[6]) ,7,"บริหาร",'LTBR',0,'C',1);
