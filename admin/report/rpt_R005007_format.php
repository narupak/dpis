...
//	fix head for rpt_R005007
	...
	$heading_text[0] = "|หน่วยงาน/ชื่อ";
	$heading_text[1] = "|ตำแหน่ง";
	$heading_text[2] = "|วันบรรจุ";
	$heading_text[3] = "วันที่เกษียณ|อายุราชการ";
	$heading_text[4] = "วันเข้าสู่ระดับ|ก่อนปัจจุบัน";
	$heading_text[5] = "วันเข้าสู่ระดับ|ปัจจุบัน";
	$heading_text[6] = "ปัจจุบันได้รับเครื่องราชฯ|ชั้น";
	$heading_text[7] = "ปัจจุบันได้รับเครื่องราชฯ|วันที่ได้รับ";
