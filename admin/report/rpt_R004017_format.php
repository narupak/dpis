...
//	fix head for rpt_R004017
	...
	$heading_text[] = "|ชื่อ / สังกัด|";
	$heading_text[] = "|ตำแหน่ง|";
	$heading_text[] = "|วุฒิ|";
	$heading_text[] = "วันเข้าสู่|ระดับ|ปัจจุบัน";
	$heading_text[] = "วันเข้าสู่|ระดับ|ก่อนปัจจุบัน";
	$heading_text[] = "|เงินเดือน|";
	$heading_text[] = "|วันบรรจุ|";
	$heading_text[] = "|เครื่อง|ราชฯ";
	$heading_text[] = "|วันเดือนปี|เกิด";
	$heading_text[] = "|เกษียณ|อายุ";
	$heading_text[] = "|การดำรงตำแหน่ง|ที่สำคัญ";
	...
	if ($have_pic)
	$data_align = array("R","C","C","L","L","L","C","C","R","C","L","C","C","L");
	else
