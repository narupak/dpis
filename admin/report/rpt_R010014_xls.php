<?
	...
	include ("rpt_R010014_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
...
//	$list_type_text = $ALL_REPORT_TITLE;
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ส่วนราชการ     ชื่อ - สกุล","ตำแหน่ง","ตำแหน่งประเภท","ระดับ", "ปีเกษียณอายุ");
	...
	if($DPISDB=="odbc"){
		...
		$cmd = " select			a.PER_ID, i.PN_NAME, a.PER_NAME, a.PER_SURNAME, a.LEVEL_NO, f.PL_NAME, h.PM_SEQ_NO, h.PM_NAME,
				   ...
				   group by		a.PER_ID, i.PN_NAME, a.PER_NAME, a.PER_SURNAME, a.LEVEL_NO, f.PL_NAME, h.PM_SEQ_NO, h.PM_NAME,
								...
								b.ORG_ID, b.ORG_ID_1, c.ORG_NAME, $group_by, m.LEVEL_NAME,m.POSITION_TYPE,m.POSITION_LEVEL, m.LEVEL_SEQ_NO
				   order by $order_by, m.LEVEL_SEQ_NO desc, h.PM_SEQ_NO, NLSSORT(a.PER_NAME,'NLS_SORT=THAI_DICTIONARY'), NLSSORT(a.PER_SURNAME,'NLS_SORT=THAI_DICTIONARY'), MIN(SUBSTR(trim(j.POH_EFFECTIVEDATE), 1, 10)), 
