...
//	session_cache_limiter("nocache");
	...
	function print_header(){
		...
		$pdf->Cell($heading_width[5] ,7,"ดำรงตำแหน่ง",'LTR',0,'C',1);
		$pdf->Cell(($heading_width[6] + $heading_width[7]) ,7,"เงินเดือน",'LTBR',0,'C',1);
		$pdf->Cell(($heading_width[8] + $heading_width[9] + $heading_width[10]) ,7,"ตำแหน่งและส่วนราชการที่เลื่อน",'LTBR',0,'C',1);
		...
		$pdf->Cell($heading_width[5] ,7,"ระดับปัจจุบัน",'LR',0,'C',1);
		$pdf->Cell($heading_width[6] ,7,"ปีงบประมาณ",'LTR',0,'C',1);
		$pdf->Cell($heading_width[7] ,7,"ปีงบประมาณ",'LTR',0,'C',1);
		$pdf->Cell($heading_width[8] ,7,"ตำแหน่ง/สังกัด",'LTR',0,'C',1);
		$pdf->Cell($heading_width[9] ,7,"เลขที่",'LTR',0,'C',1);
		$pdf->Cell($heading_width[10] ,7,"เงินเดือน",'LTR',0,'C',1);
		...
		$pdf->Cell($heading_width[5] ,7,"เมื่อ",'LBR',0,'C',1);
		$pdf->Cell($heading_width[6] ,7,"ที่เลื่อน",'LBR',0,'C',1);
		$pdf->Cell($heading_width[7] ,7,"ก่อนเลื่อน",'LBR',0,'C',1);
