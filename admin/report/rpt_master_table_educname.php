...
//	session_cache_limiter("nocache");
	...
	if ($FLAG_RTF) {
		...
		$fname= "rpt_master_table_educname.rtf";
	...
	$heading_text[1] = "ชื่อย่อ";
	$heading_text[2] = "ชื่อวุฒิการศึกษา";
	$heading_text[3] = "ระดับการศึกษา";
	$heading_text[4] = "รหัสกรมบัญชีกลาง";
...
//	$db_dpis->show_error();
	...
	if($count_data){
		...
		while($data = $db_dpis->get_array()){
			...
			$arr_data[] = $data[EL_NAME];
			$arr_data[] = $data[EN_CGD_CODE];
