...
//	echo "COLUMN_FORMAT=$COLUMN_FORMAT , COM_TYPE=$COM_TYPE<br>";
	if($COM_TYPE=="0202" || $COM_TYPE=="5022"){
		...
		$heading_text[2] = "วุฒิที่เพิ่มขึ้น/|สถานศึกษา/วันที่|สำเร็จการศึกษา";
		...
		$heading_text[7] = $COM_HEAD_01."เดิม|เงิน|เดือน";
		...
		$heading_text[15] = $COM_HEAD_03."ที่รับโอน|เงิน|เดือน";
		$heading_text[16] = "ตั้งแต่|วันที่|";	
		$heading_text[17] = "หมาย|เหตุ|";		
		...
		$heading_text[8] = $COM_HEAD_02."ที่$head_txt|ตำแหน่ง/สังกัด";
		$heading_text[9] = $COM_HEAD_02."ที่$head_txt|ตำแหน่ง|ประเภท";
		$heading_text[10] = $COM_HEAD_02."ที่$head_txt|ระดับ";
		$heading_text[11] = $COM_HEAD_02."ที่$head_txt|เลขที่";
		$heading_text[12] = $COM_HEAD_02."ที่$head_txt|เงินเดือน";
