<?
//	fix head for rpt_R002003

	$heading_width[0] = "160";
	$heading_width[1] = "20";
	$heading_width[2] = "20";
	
	$heading_text[0] = "ประเทศที่สำเร็จการศึกษา|";
	$heading_text[1] = "<**1**>จำนวน$PERSON_TYPE[$search_per_type]|คน";
	$heading_text[2] = "<**1**>จำนวน$PERSON_TYPE[$search_per_type]|ร้อยละ";
