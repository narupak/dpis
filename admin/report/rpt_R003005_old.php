...
//	session_cache_limiter("nocache");
	...
	//new***************************************************
    $heading_text[0] = "$heading_name|รายชื่อข้าราชการ";
	$heading_text[1] = "ตำแหน่ง";
	$heading_text[2] = "วันที่ดำรงตำแหน่ง";
	$heading_text[3] = "ระยะเวลาที่ดำรงตำแหน่ง";
...
//new*****************************************************************
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			$POS_DURATION = $arr_content[$data_count][pos_duration];
				...
				$arr_data[] = $PL_NAME;
				$arr_data[] = (($NUMBER_DISPLAY==2)?convert2thaidigit($POS_CHANGE_DATE):$POS_CHANGE_DATE);
				$arr_data[] = (($NUMBER_DISPLAY==2)?convert2thaidigit($POS_DURATION):$POS_DURATION);
				
	
				$data_align = array("L", "L", "C", "C");
