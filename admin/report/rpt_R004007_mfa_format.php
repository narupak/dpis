...
//	fix head for rpt_R004007_mfa
	...
	$heading_text[0] = "ตำแหน่ง";
	$heading_text[1] = "ผู้ครองตำแหน่ง";
	$heading_text[2] = "วันเข้ารับหน้าที่";
	$heading_text[3] = "ปฏิบัติงาน";
	$heading_text[4] = "เกษียณ";
