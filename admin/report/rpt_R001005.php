...
//		$sum_w = array_sum($heading_width);
	...
	function count_position($level_no, $search_condition, $addition_condition){
		...
		//global $position_table, $position_select,$position_join;/*เดิม*/
                global $position_table, $position_select,$position_join,$search_per_type;/*Release 5.1.0.6 */
...
//PER_LEVEL
		if($DPISDB=="odbc"){
			$cmd = " select	 	count($position_select ) as count_position
                   ...
                   //PER_EMPSER_POS_NAME,PER_POS_NAME
                    /*Release 5.1.0.6*/
...
//echo "<pre>$search_per_type :  $cmd </pre>";
