...
//	$db_dpis->show_error();
	...
	function print_header(){
		...
		$worksheet->write($xlsRow, 1, "ส่วนราชการและตำแหน่งเดิม", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		...
		$worksheet->write($xlsRow, 6, "ส่วนราชการและตำแหน่งใหม่", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	if($count_data){
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if($CONTENT_TYPE=="ORG"){
				...
				$worksheet->write_string($xlsRow, 7, "$REQ_ORG_NAME", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 0));
				...
				$worksheet->write_string($xlsRow, 4, "$CL_NAME", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 5, "$PT_NAME", set_format("xlsFmtTableDetail", "", "R", "TLRB", 0));
				$worksheet->write_string($xlsRow, 6, "$REQ_POS_NO", set_format("xlsFmtTableDetail", "", "R", "TLRB", 0));
				$worksheet->write_string($xlsRow, 7, "$REQ_PM_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				$worksheet->write_string($xlsRow, 8, "$REQ_PL_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				$worksheet->write_string($xlsRow, 9, "$REQ_CL_NAME", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 10, "$REQ_PT_NAME", set_format("xlsFmtTableDetail", "", "R", "TLRB", 0));
				$worksheet->write_string($xlsRow, 11, "", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
			} // end if
		} // end for				
	}else{
	...
	header("Content-Type: application/x-msexcel; name=\"บัญชีขอปรับปรุงตำแหน่ง.xls\"");
	header("Content-Disposition: inline; filename=\"บัญชีขอปรับปรุงตำแหน่ง.xls\"");
	$fh=fopen($fname, "rb");
	fpassthru($fh);
	fclose($fh);
	unlink($fname);
