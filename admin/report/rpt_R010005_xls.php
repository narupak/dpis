...
///	if(count($arr_search_condition)) $search_condition = " and ". implode(" and ", $arr_search_condition);
	...
	if ($have_remark) {	
    	$ws_head_line1 = array("$MINISTRY_TITLE / $DEPARTMENT_TITLE","$PM_TITLE","$PL_TITLE","ประเภทตำแหน่ง","ระดับตำแหน่ง","วันเข้าสู่ระดับ","วันดำรงตำแหน่ง","ปีเกษียณอายุ","$REMARK_TITLE");
    	$ws_head_line2 = array("ชื่อ - สกุล","","","","","ปัจจุบัน","ปัจจุบัน","","");
    	...
    	$ws_head_line1 = array("$MINISTRY_TITLE / $DEPARTMENT_TITLE","$PM_TITLE","$PL_TITLE","ประเภทตำแหน่ง","ระดับตำแหน่ง","วันเข้าสู่ระดับ","วันดำรงตำแหน่ง","ปีเกษียณอายุ");
    	$ws_head_line2 = array("ชื่อ - สกุล","","","","","ปัจจุบัน","ปัจจุบัน","");
