...
//		$db_dpis2->show_error();
		...
		if ($FLAG_RTF)
			$arr_content[$data_count][old_position] = $OLD_PL_NAME ."*Enter*". $OLD_ORG_NAME;
		else
			$arr_content[$data_count][old_position] = $OLD_PL_NAME ."\n". $OLD_ORG_NAME;
		$arr_content[$data_count][new_posno] = $POS_NO;
		if ($FLAG_RTF)
			$arr_content[$data_count][new_position] = $PL_NAME ."*Enter*". $POH_ORG;
		else
			$arr_content[$data_count][new_position] = $PL_NAME ."\n". $POH_ORG;
