<?
	...
	$report_title = "รายงานสถานะของการประเมินที่เสร็จแล้วของแต่ละบุคคล ของ $DEPARTMENT_NAME";
...
//				$cmd = " select PER_ID from PER_KPI_FORM where ORG_ID_KPI=$ORG_ID_KPI ";
			...
			if ($f_complete) { // ถ้า complete ก็สั่งพิมพ์	คือพิมพ์ เฉพาะรายการที่ประเมินเสร็จแล้ว
				$data_count++;
				$xlsRow = $data_count;
