...
//	fix head for rpt_R007003
	...
	$heading_text[0] = "|ลำดับ|ที่||"; //"|ลำดับที่|||";
	$heading_text[1] = "|วันเดือนปี|ที่เริ่มลา||";
	$heading_text[2] = "|วันเดือนปี|ที่สิ้นสุด|การลา|";
	$heading_text[3] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|ลาป่วย|||";
	$heading_text[4] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|ลากิจ|||";
	$heading_text[5] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|มาสาย|||";
	$heading_text[6] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|ลา|พักผ่อน||";//"<**1**>ประเภทของการลา (จำนวนวันที่ลา)|ลาพักผ่อน|||";
	$heading_text[7] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|ขาดราชการ|||";
	$heading_text[8] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ลา|คลอด|";//"<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ลาคลอด||";
	$heading_text[9] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|อุปสมบท/|พิธีฮัจย์|";
	$heading_text[10] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ตรวจเลือก/|รวมพล|";
	$heading_text[11] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ลาศึกษา/|ดูงาน|";
	$heading_text[12] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ปฏิบัติงาน|ระหว่าง|ประเทศ";
	$heading_text[13] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ติดตาม|คู่สมรส|";
	$heading_text[14] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ช่วยเหลือ|ภริยาที่|คลอดบุตร";
	$heading_text[15] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ฟื้นฟู|สมรรถภาพ|ด้านอาชีพ";
	$heading_text[16] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ลากิจ|ส่วนตัว|เลี้ยงดูบุตร";
        $heading_text[17] = "<**1**>ประเภทของการลา (จำนวนวันที่ลา)|<**2**>ลาอื่น ๆ|ลาป่วย|จำเป็น";
