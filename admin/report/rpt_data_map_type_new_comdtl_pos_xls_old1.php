...
//	$report_title = "บัญชีรายละเอียดการแต่งตั้งข้าราชการพลเรือนสามัญให้ดำรงตำแหน่งใหม่ตามพระราชบัญญัติระเบียบข้าราชการพลเรือน พ.ศ.2551 $DEPARTMENT_NAME ที่ $COM_NO ลงวันที่ $COM_DATE";
	$report_title = "บัญชีจัดตำแหน่งข้าราชการพลเรือนสามัญเข้าประเภทตำแหน่ง สายงาน และระดับตำแหน่งตามพระราชบัญญัติระเบียบข้าราชการพลเรือน พ.ศ.2551<br>ใน$DEPARTMENT_NAME  $MINISTRY_NAME";
	$report_code = "";
	...
	function print_header(){
		...
		$worksheet->write($xlsRow, 2, "ส่วนราชการและตำแหน่งที่ ก.พ.กำหนดไว้เดิม", set_format("xlsFmtTableHeader", "B", "C", "T", 1));
		...
		$worksheet->write($xlsRow, 8, "ส่วนราชการและตำแหน่งที่ ก.พ.กำหนดใหม่", set_format("xlsFmtTableHeader", "B", "C", "T", 1));
		$worksheet->write($xlsRow, 9, "", set_format("xlsFmtTableHeader", "B", "C", "T", 1));
		$worksheet->write($xlsRow, 10, "", set_format("xlsFmtTableHeader", "B", "C", "T", 1));
		...
		$worksheet->write($xlsRow, 13, "", set_format("xlsFmtTableHeader", "B", "C", "TR", 0));
		...
		$worksheet->write($xlsRow, 5, "สายงาน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 6, "ระดับตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 7, "เลขที่ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 8, "ชื่อตำแหน่งในการบริหารงาน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 9, "ชื่อตำแหน่งในสายงาน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 10, "ประเภทตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 11, "สายงาน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 12, "ระดับตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 13, "หมายเหตุ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
	} // function		
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if($CONTENT_TYPE=="ORG" || $CONTENT_TYPE=="ORG_1" || $CONTENT_TYPE=="ORG_2"){
				...
				if($CONTENT_TYPE=="ORG"){
					...
					$worksheet->write($xlsRow, 8, "$NEW_ORG_NAME", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 0));
					...
					$worksheet->write($xlsRow, 8, "$NEW_ORG_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				...
				if($CMD_NOTE2){
					...
					$worksheet->write_string($xlsRow, 5, "$CMD_LG_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 6, "$CMD_LEVEL", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
					$worksheet->write_string($xlsRow, 7, "$NEW_POS_NO", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 8, "$NEW_PM_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 9, "$NEW_PL_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 10, "$NEW_PT_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 11, "$NEW_LG_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 12, "$NEW_LEVEL_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 13, "$CMD_REMARK", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				} // end if
			} // end if
		} // end for				
