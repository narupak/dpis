...
//				$heading_name .= " $ORG_TITLE";
	...
	$data_date = "ข้อมูล ณ วันที่ ".date("d/m/").(date("Y")+543);
...
//	$report_title .= " $list_type_text";	
	...
	$report_code = "H22";
	include ("rpt_R010022_format.php");	// กำหนดหัวและตัวแปรสำหรับการเปลี่ยนรูปแบบรายงาน
...
//	echo "list_position-cmd=$cmd<br>";
	...
	//$db_dpis->show_error();
//	echo "<br>main-cmd=$cmd  ($count_data)<br>";
	...
	//		echo "$head_text1<br>";
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if($REPORT_ORDER == "DEPARTMENT"){
				...
				if ($have_pic && $img_file)
				$data_align = array("C","C","L","L","L","C","C","C");
				else
