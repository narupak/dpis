...
//	fix head for rpt_R004003
	...
	$heading_width[] = "60";
        ...
        $heading_width[] = "30";//ระดับปัจจุบัน|(ใช้เรียงอาวุโส)
	$heading_width[] = "30";//วันเข้าสู่ระดับ
        
        $heading_width[] = "30";//ระดับ|ก่อนหน้า
	$heading_width[] = "30";//วันเข้าสู่ระดับก่อนหน้า
	...
	$heading_text[] = "วันเข้าสู่ระดับ|ปัจจุบัน";
	$heading_text[] = "ระดับ|";
	$heading_text[] = "สังกัด|";
	$heading_text[] = "เลขที่|ตำแหน่ง";
	$heading_text[] = "วุฒิ|";
	$heading_text[] = "สาขา|วิชาเอก";
        
        $heading_text[] = "ระดับปัจจุบัน|(ใช้เรียงอาวุโส)";
        $heading_text[] = "วันที่เข้าสู่ระดับ|(ใช้เรียงอาวุโส)";
        
	$heading_text[] = "ระดับ|ก่อนหน้า";
        $heading_text[] = "วันเข้าสู่ระดับก่อนหน้า|";
	
	$heading_text[] = "เงินเดือน|";
	$heading_text[] = "เครื่องราชฯ|";
	$heading_text[] = "วันบรรจุ|(อายุราชการ)";
	$heading_text[] = "วันเดือนปีเกิด|(อายุตัว)";
	$heading_text[] = "วันเกษียณ|";
	...
	if ($have_pic)
	$heading_align = array("C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C");
	else
	$heading_align = array("C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C");
	
	if ($have_pic)
	$data_align = array("C","C","L","L","L","L","L","C","L","L","C","L","C","C","C","C","C","C","C");
	else
	$data_align = array("C","L","L","L","L","L","C","L","L","L","L","L","L","C","C","C","C","C");
