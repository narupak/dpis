...
//exit;
	...
	$cmd = " select SCORE, CONSISTENCY, ISPASSED, TESTER_ID, TEST_TIME from JOB_EVALUATION where JOB_EVA_ID=$JOB_EVA_ID and POS_ID=$POS_ID ";
	$db_dpis->send_cmd($cmd);
	$data = $db_dpis->get_array();
	...
	$xlsRow = 0;
	$worksheet->set_row($xlsRow, 20);
	$worksheet->write($xlsRow, 0, "ตารางแสดงผลคะแนนของการประเมินค่างานโดยละเอียด", set_format_new("xlsFmtTableDetail", "fontFormat=B&alignment=C&border=&isMerge=0&fgColor=black&bgColor=43&setRotation=0&valignment=&fontSize=&wrapText=1"));
	...
	$worksheet->write($xlsRow, 1, "$LEVEL_NAME", set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=L&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=&fontSize=&wrapText=1"));
	$worksheet->write($xlsRow, 2, "", set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=L&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=&fontSize=&wrapText=1"));
	$worksheet->write($xlsRow, 3, "", set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=L&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=&fontSize=&wrapText=1"));
	$worksheet->write($xlsRow, 4, "", set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=L&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=&fontSize=&wrapText=1"));
	$worksheet->write($xlsRow, 5, "", set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=L&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=&fontSize=&wrapText=1"));
	...
	$xlsRow++;
	$worksheet->write($xlsRow, 0, "ผลการประเมิน  ", set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=R&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=&fontSize=&wrapText=1"));
	$worksheet->write($xlsRow, 1, "", set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=C&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=&fontSize=&wrapText=1"));
	$worksheet->write($xlsRow, 2, "", set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=C&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=&fontSize=&wrapText=1"));
	$worksheet->write($xlsRow, 3, "", set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=C&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=&fontSize=&wrapText=1"));
	$worksheet->merge_cells($xlsRow, 0, $xlsRow, 3);
	...
	$worksheet = &$workbook->addworksheet("เหตุผลประกอบ");
	$worksheet->set_margin_right(0.50);
	$worksheet->set_margin_bottom(1.10);
	...
	for($i=1; $i<=20; $i++){
		$xlsRow++;
		$worksheet->write($xlsRow, 0, ($i.". ".$ARR_QUESTION_TOPIC[$i]), set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=L&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=T&fontSize=&wrapText=1"));	
		$worksheet->write($xlsRow, 1, ($ARR_ANSWER_INFO[$i]), set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=L&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=T&fontSize=&wrapText=1"));	
		$worksheet->write($xlsRow, 2, ($ARR_ANSWER_DESCRIPTION[$i]), set_format_new("xlsFmtTableDetail", "fontFormat=&alignment=L&border=TLRB&isMerge=0&fgColor=black&bgColor=white&setRotation=0&valignment=T&fontSize=&wrapText=1"));	
	} // loop for
...
?>r=black&bgColor=white&setRotation=0&valignment=T&fontSize=&wrapText=1"));	
	} // loop for
