...
//echo "format.. ไม่ใช่กรมการปกครอง...COM_LEVEL_SALP=$COM_LEVEL_SALP<br>";
    if ($COM_LEVEL_SALP == 6) {
        ...
        if ($BKK_FLAG == 1) {
            $heading_width = array(6, 30, 45, 12, 10, 10, 10, 10, 10, 45);
            $heading_text = array("ลำดับ|ที่", $FULLNAME_HEAD . "|", $COM_HEAD_01 . "|สังกัด/ตำแหน่ง", "<**1**>|ตำแหน่ง|ประเภท", "<**1**>|ระดับ", "<**1**>|เลขที่", "เงินเดือนฐาน", "<**2**>เงินค่าตอบแทนพิเศษ|ร้อยละ 2", "ให้ได้รับ|เงินเดือน","<**2**>|ร้อยละ 4", "หมายเหตุ|");
            $heading_align = array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C');
            $column_function = array((($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), 
                                     (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), 
                                     (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), 
            ...
            if ($CARDNO_FLAG == 1) {
                $heading_width = array(6, 30, 20,50, 15, 15, 15, 20, 20, 20, 20, 20, 20, 50);
                $heading_text = array("ลำดับ|ที่", $FULLNAME_HEAD . "|", "เลขประจำตัว|ประชาชน", $COM_HEAD_01 . "|สังกัด / ตำแหน่ง", "<**1**>|เลขที่", "<**1**>|ระดับตำแหน่ง", "เงินเดือนเดิม","อัตราเงินเดือนที่เต็มขั้น","ฐานในการคำนวน","ร้อยละที่ได้","จำนวนเงินที่ได้เลื่อน","จำนวนค่าตอบแทน", "ให้ได้รับ|เงินเดือน", "หมายเหตุ");
                $heading_align = array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C');
                $column_function = array((($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), 
                                         (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"),
                                         (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), 
                ...
                $heading_width = array(6, 30, 50, 15, 15, 15, 20, 20, 20, 20, 20, 20, 50);
                $heading_text = array("ลำดับ|ที่", $FULLNAME_HEAD . "|$CARDNO_TITLE", $COM_HEAD_01 . "|สังกัด / ตำแหน่ง", "<**1**>|เลขที่", "<**1**>|ระดับตำแหน่ง", "เงินเดือนเดิม","อัตราเงินเดือนที่เต็มขั้น","ฐานในการคำนวน","ร้อยละที่ได้","จำนวนเงินที่ได้เลื่อน","จำนวนค่าตอบแทน", "ให้ได้รับ|เงินเดือน", "หมายเหตุ");
                $heading_align = array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C');
                $column_function = array((($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), 
                                         (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), 
                                         (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), 
        ...
        if ($BKK_FLAG == 1) {
            ...
            if ($CARDNO_FLAG == 1) {
                ...
                $ws_head_line2 = array("ที่", "", "ประชาชน", "ตำแหน่ง/สังกัด", "เลขที่", "ระดับตำแหน่ง", "ก่อนเลื่อน", "เงินเดือน", "ที่เลื่อน", "ที่เลื่อน", "คำนวณ", "ประเมิน", "");
                $heading_text = array("ลำดับ|ที่", $FULLNAME_HEAD . "|", "เลขประจำตัว|ประชาชน", $COM_HEAD_01 . "|สังกัด / ตำแหน่ง", "<**1**>|เลขที่", "<**1**>|ระดับตำแหน่ง", "เงินเดือน|ก่อนเลื่อน", "ให้ได้รับ|เงินเดือน", "จำนวนเงิน|ที่เลื่อน", "เปอร์เซ็นต์|ที่เลื่อน", "ฐานในการ|คำนวณ", "ผลการ|ประเมิน", "หมายเหตุ|");
                $heading_align = array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C');
                $column_function = array((($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"));
                $data_align = array("C", "L", "C",  "L", "C", "L", "R", "R", "R", "R", "R", "R", "L");
            } else {
                $heading_width = array(6, 30, 50, 10, 15, 15, 15, 15, 10, 10, 10, 50);
                ...
                $ws_head_line2 = array("ที่", "$CARDNO_TITLE",  "ตำแหน่ง/สังกัด", "เลขที่", "ระดับตำแหน่ง", "ก่อนเลื่อน", "เงินเดือน", "ที่เลื่อน", "ที่เลื่อน", "คำนวณ", "ประเมิน", "");
                $heading_text = array("ลำดับ|ที่", $FULLNAME_HEAD . "|$CARDNO_TITLE", "",  $COM_HEAD_01 . "|สังกัด / ตำแหน่ง", "<**1**>|เลขที่", "<**1**>|ระดับตำแหน่ง", "เงินเดือน|ก่อนเลื่อน", "ให้ได้รับ|เงินเดือน", "จำนวนเงิน|ที่เลื่อน", "เปอร์เซ็นต์|ที่เลื่อน", "ฐานในการ|คำนวณ", "ผลการ|ประเมิน", "หมายเหตุ|");
                $heading_align = array('C', 'C',  'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C');
                $column_function = array((($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"),  (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-x" : "ENUM-x"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"), (($NUMBER_DISPLAY == 2) ? "TNUM-2" : "ENUM-2"), (($NUMBER_DISPLAY == 2) ? "TNUM" : "ENUM"));
                $data_align = array("C", "L", "C", "L", "C", "L", "R", "R", "R", "R", "R", "R", "L");
            }
