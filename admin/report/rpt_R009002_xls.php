...
//	$company_name = "รูปแบบการออกรายงาน : $list_type_text";
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ลำดับ","ชื่อ - สกุล","ตำแหน่ง","ความรู้ ทักษะ สมรรถนะที่ต้องได้รับการพัฒนา","วิธีการพัฒนา","ช่วงเวลาที่ต้องการพัฒนา","วิธีการวัดผลในการพัฒนา");
		...
		$ws_width = array(10,50,70,30,30,30,30);
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	if($count_data){
		...
		// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนข้อมูล
			...
			$wsdata_align_1 = array("C","L","L","L","L","L","L");
