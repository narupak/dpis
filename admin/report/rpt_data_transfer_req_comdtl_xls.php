<?
	...
	function print_header(){
		...
		if($COM_TYPE=="0101"){
			...
			$worksheet->write($xlsRow, 1, "ชื่อ (วันเดือนปี เกิด)", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
			$worksheet->write($xlsRow, 2, "วุฒิ/สาขา/สถานศึกษา", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			$worksheet->write($xlsRow, 3, "สอบแข่งขันได้", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			...
			$worksheet->write($xlsRow, 6, "ตำแหน่งที่บรรจุ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			...
			$worksheet->write($xlsRow, 4, "ลำดับที่", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
			$worksheet->write($xlsRow, 5, "ประกาศผลการสอบของ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
			...
			$worksheet->write($xlsRow, 1, "ชื่อ (วันเดือนปี เกิด)", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
			$worksheet->write($xlsRow, 2, "วุฒิ/สาขา/สถานศึกษา", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			$worksheet->write($xlsRow, 3, "ตำแหน่งที่บรรจุ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			$worksheet->write($xlsRow, 4, "", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			$worksheet->write($xlsRow, 5, "", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			$worksheet->write($xlsRow, 6, "ตั้งแต่วันที่", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
			...
			$worksheet->write($xlsRow, 4, "", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			$worksheet->write($xlsRow, 5, "ตำแหน่งที่รับโอน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			$worksheet->write($xlsRow, 6, "", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			$worksheet->write($xlsRow, 7, "", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
			$worksheet->write($xlsRow, 8, "ตั้งแต่วันที่", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
			$worksheet->write($xlsRow, 9, "หมายเหตุ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
			...
			$worksheet->write($xlsRow, 5, "ตำแหน่ง/สังกัด", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
			$worksheet->write($xlsRow, 6, "เลขที่", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
			$worksheet->write($xlsRow, 7, "เงินเดือน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
...
//	$db_dpis->show_error();
	...
	while($data = $db_dpis->get_array()){
		...
		if(in_array($COM_TYPE, array("0101", "0102", "0103", "0105", "0106", "0107", "0108", "0504", "0604", "0704", "0803")))
			$arr_content[$data_count][name] = $PN_NAME . $PER_NAME ." ". $PER_SURNAME ." ". $PER_BIRTHDATE;
		else
...
//			$CMD_NOTE = $arr_content[$data_count][cmd_note];
			...
			if($COM_TYPE=="0101"){
				if($CMD_NOTE2){
					...
					$worksheet->write_string($xlsRow, 4, "$CMD_ACC_NO", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
					$worksheet->write_string($xlsRow, 5, "$CMD_ACCOUNT", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				...
				if($CMD_NOTE2){
					$xlsRow++;
					$worksheet->write_string($xlsRow, 0, "หมายเหตุ : $CMD_NOTE2", set_format("xlsFmtTableDetail", "", "L", "", 0));
					...
					$worksheet->write_string($xlsRow, 6, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
					$worksheet->write_string($xlsRow, 7, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
				}else{
					$xlsRow++;
					$worksheet->write_string($xlsRow, 0, "$ORDER", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
					$worksheet->write_string($xlsRow, 1, "$NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 2, "$EDUCATE", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 3, "$NEW_POSITION", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 4, "$NEW_POS_NO", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
					$worksheet->write($xlsRow, 5, "$CMD_SALARY", set_format("xlsFmtTableDetail", "", "R", "TLRB", 0));
					$worksheet->write_string($xlsRow, 6, "$CMD_DATE", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
					$worksheet->write_string($xlsRow, 7, "$CMD_NOTE1", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				} // end if
			}else{
				if($CMD_NOTE2){
					$xlsRow++;
					...
					$worksheet->write_string($xlsRow, 6, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
					$worksheet->write_string($xlsRow, 7, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
					$worksheet->write_string($xlsRow, 8, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
					$worksheet->write_string($xlsRow, 9, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
				}else{
					$xlsRow++;
					$worksheet->write_string($xlsRow, 0, "$ORDER", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
					$worksheet->write_string($xlsRow, 1, "$NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					...
					$worksheet->write_string($xlsRow, 5, "$NEW_POSITION", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
					$worksheet->write_string($xlsRow, 6, "$NEW_POS_NO", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
					$worksheet->write($xlsRow, 7, "$CMD_SALARY", set_format("xlsFmtTableDetail", "", "R", "TLRB", 0));
					$worksheet->write_string($xlsRow, 8, "$CMD_DATE", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
					$worksheet->write_string($xlsRow, 9, "$CMD_NOTE1", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				} // end if
			} // end if
		} // end for
