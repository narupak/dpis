...
//	$arr_rpt_order = array("ORG"); 
	...
	function print_header(){
		...
		if($search_per_type==1) { $worksheet->write($xlsRow, 13, "ขรก.", set_format("xlsFmtTableHeader", "B", "C", "LR", 0)); }
		else if($search_per_type==2) { $worksheet->write($xlsRow, 13, "ลูกจ้าง", set_format("xlsFmtTableHeader", "B", "C", "LR", 0)); }
		else if($search_per_type==3) { $worksheet->write($xlsRow, 13, "พนักงาน", set_format("xlsFmtTableHeader", "B", "C", "LR", 0)); }
