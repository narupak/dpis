...
//	session_cache_limiter("nocache");
	...
	session_start();
		...
		$fname= "rpt_master_table_com_note.rtf";
...
//	$db_dpis->show_error();
	...
	if($count_data){
		...
		while($data = $db_dpis->get_array()){
			...
			if ($data[$arr_fields[2]] == 1) 	 $$arr_fields[2] = "หมายเหตุ 1";
			elseif ($data[$arr_fields[2]] == 2) 	 $$arr_fields[2] = "หมายเหตุ 2";
			elseif ($data[$arr_fields[2]] == 3) 	 $$arr_fields[2] = "หมายเหตุแนบท้ายคำสั่ง";
