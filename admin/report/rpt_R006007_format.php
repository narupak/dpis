...
//	fix head for rpt_R006007
	...
	$heading_text[1] = "|วงเงินเลื่อนขั้น|ร้อยละ 6|";
	$heading_text[2] = "|รวมเงินเลื่อน 0.5 ขั้น|1 ขั้น 1.5 ขั้น|(เม.ย./ต.ค.)";
	$heading_text[3] = "|ค่าตอบแทน|2 % และ 4 %|(ต.ค.)";
	$heading_text[4] = "|รวมเงินเลื่อนขั้น|ทั้งสิ้น|";
	$heading_text[5] = "กลุ่มข้าราชการระดับ $search_level_min - $search_level_max||หมายเหตุ|";
