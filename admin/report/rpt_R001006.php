<?
	...
	$report_code = "R0401";
	include ("rpt_R004001_format.php");	// กำหนดหัวและตัวแปรสำหรับการเปลี่ยนรูปแบบรายงาน
...
//			$RTF->close_section(); 
		...
		$arr_content_map = array("","count_1","percent_1","count_2","percent_2","count_3","percent_3","count_4","percent_4","count_5","percent_5","count_total",""); // ชื่อ column ใน content ที่ map ให้ตรงกับ head pdf
		...
		$arr_series_caption[] = "จำนวนรวม";
		$arr_series_caption[] = "ร้อยละ";
