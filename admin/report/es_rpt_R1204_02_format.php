<?php
    ...
    $heading_text[1] = 'ประจำปี';
    $heading_text[2] = 'รอบ';
    $heading_text[3] = 'วันที่';
    $heading_text[4] = '<**1**>ลาพักผ่อน|สะสม';
    $heading_text[5] = '<**1**>ลาพักผ่อน|ลา';
    $heading_text[6] = '<**1**>ลาพักผ่อน|คงเหลือ';
    $heading_text[7] = 'ลาป่วย';
    $heading_text[8] = 'ลากิจส่วนตัว';
    $heading_text[9] = 'ลาอื่นๆ';
    $heading_text[10] = 'มาสาย';
    $heading_text[11] = 'ขาด|ราชการ';
