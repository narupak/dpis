<?
	...
	$company_name = "";
	$report_title = "บัญชีรายละเอียดการเลื่อนตำแหน่ง$PERSON_TYPE[$COM_PER_TYPE]แนบท้ายคำสั่ง $DEPARTMENT_NAME ที่ $COM_NO ลงวันที่ $COM_DATE";
	$report_code = "";
	...
	function print_header(){
		...
		$worksheet->set_column(8, 8, 65);
		$worksheet->set_column(9, 9, 6);
		$worksheet->set_column(10, 10, 10);
		$worksheet->set_column(11, 11, 10);
		$worksheet->set_column(12, 12, 100);
		...
		$worksheet->write($xlsRow, 2, "วุฒิ/สาขา/สถานศึกษา", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
		...
		$worksheet->write($xlsRow, 5, "ดำรงตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 6, "เงินเดือน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
		$worksheet->write($xlsRow, 7, "", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
		$worksheet->write($xlsRow, 8, "ตำแหน่งและส่วนราชการที่เลื่อน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 1));
		...
		$worksheet->write($xlsRow, 11, "ตั้งแต่วันที่", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		...
		$worksheet->write($xlsRow, 5, "ระดับปัจจุบัน", set_format("xlsFmtTableHeader", "B", "C", "LR", 0));
		$worksheet->write($xlsRow, 6, "ปีงบประมาณ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 7, "ปีงบประมาณ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 8, "ตำแหน่ง/สังกัด", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 9, "เลขที่", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 10, "เงินเดือน", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		...
		$worksheet->write($xlsRow, 5, "เมื่อ", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 6, "ที่เลื่อน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 7, "ก่อนเลื่อน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
...
//		$arr_content[$data_count][cmd_note] = $CMD_NOTE1;
		...
		if ($print_order_by==1) {
			...
			$arr_content[$data_count][new_position] = $NEW_ORG_NAME_1." ".$NEW_ORG_NAME_1;
		}
...
//			$CMD_NOTE = $arr_content[$data_count][cmd_note];
			...
			if ($print_order_by==2) {
				if($CONTENT_TYPE=="ORG" || $CONTENT_TYPE=="ORG_1" || $CONTENT_TYPE=="ORG_2"){
					...
					if($CONTENT_TYPE=="ORG"){
						...
						$worksheet->write($xlsRow, 8, "$NEW_ORG_NAME ", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 1));
						$worksheet->write($xlsRow, 9, "", set_format("xlsFmtTableDetail", "B", "L", "TLRB", 1));
						...
						$worksheet->write($xlsRow, 8, "$NEW_ORG_NAME ", set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
						$worksheet->write($xlsRow, 9, "", set_format("xlsFmtTableDetail", "", "L", "TLRB", 1));
			...
			if($CONTENT_TYPE=="CONTENT"){
				if($CMD_NOTE2){
					...
					$worksheet->write_string($xlsRow, 4, "$CMD_POS_NO", set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
					$worksheet->write_string($xlsRow, 5, "$LEVEL_EFFECTIVEDATE", set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
					...
					$worksheet->write_string($xlsRow, 8, "$NEW_POSITION", set_format("xlsFmtTableDetail", "", "L", "LTRB", 0));
					$worksheet->write_string($xlsRow, 9, "$NEW_POS_NO", set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
					$worksheet->write($xlsRow, 10, "$CMD_SALARY", set_format("xlsFmtTableDetail", "", "R", "LTRB", 0));
					$worksheet->write_string($xlsRow, 11, "$CMD_DATE", set_format("xlsFmtTableDetail", "", "C", "LTRB", 0));
