...
//	$company_name = "รูปแบบการออกรายงาน : $list_type_text";
	...
	function print_header(){
		...
		$xlsRow++;
		$worksheet->write($xlsRow, 0, "วันเดือนปี", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 1, "ตำแหน่ง", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 2, "กรมหรือกระทรวง", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 3, "อายุ", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		...
		$xlsRow++;
		$worksheet->write($xlsRow, 0, "ที่รับราชการ", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
...
//				$worksheet->write_string($xlsRow, 2, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
				$worksheet->write_string($xlsRow, 3, "ตำแหน่ง  $POSITION", set_format("xlsFmtTableDetail", "", "L", "", 0));
...
//				$worksheet->write_string($xlsRow, 5, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
				...
				$xlsRow++;
				$worksheet->write_string($xlsRow, 0, "$ORG_TITLE  $ORG_NAME", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 1, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 2, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
				$worksheet->write_string($xlsRow, 3, "$DEPARTMENT_TITLE  $DEPARTMENT_NAME", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 4, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 5, "", set_format("xlsFmtTableDetail", "", "L", "", 0));

				$xlsRow++;
				$worksheet->write_string($xlsRow, 0, "$MINISTRY_TITLE  $MINISTRY_NAME", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 1, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 2, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
				$worksheet->write_string($xlsRow, 3, "เกิดวันที่  $PER_BIRTHDATE_D  เดือน  $PER_BIRTHDATE_M  พ.ศ.  $PER_BIRTHDATE_Y", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 4, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 5, "", set_format("xlsFmtTableDetail", "", "L", "", 0));

				$xlsRow++;
				$worksheet->write_string($xlsRow, 0, "รับราชการมาครบ 25 ปี  เมื่อวันที่  $COMPLETE_CONDDATE_D  เดือน  $COMPLETE_CONDDATE_M  พ.ศ.  $COMPLETE_CONDDATE_Y", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 1, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
//				$worksheet->write_string($xlsRow, 2, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
