...
//	$search_per_type = 1;
	...
	$report_code = "R0610";
	include ("rpt_R006010_format.php");	// กำหนดหัวและตัวแปรสำหรับการเปลี่ยนรูปแบบรายงาน
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if($REPORT_ORDER == "PROMOTELEVEL"){
				...
				if ($FLAG_RTF) {
					...
					$pdf->report_title = "บัญชีรายชื่อ$PERSON_TYPE[$search_per_type]ที่ ". $search_promote_name ." ปีงบประมาณ $search_budget_year";
					$pdf->AddPage();
	//				print_header();
					$head_text1 = implode(",", $heading_text);
					$head_width1 = implode(",", $heading_width);
