...
//	fix head for rpt_R002006
	...
	$heading_text[] = "<**1**>วุฒิอื่น ๆ|จำนวน";
	$heading_text[] = "<**1**>วุฒิอื่น ๆ|ร้อยละ";
	$heading_text[] = "<**2**>ต่ำกว่าป.ตรี|จำนวน";
	$heading_text[] = "<**2**>ต่ำกว่าป.ตรี|ร้อยละ";
	$heading_text[] = "<**3**>ป.ตรี|จำนวน";
	$heading_text[] = "<**3**>ป.ตรี|ร้อยละ";
	$heading_text[] = "<**4**>ป.โท|จำนวน";
	$heading_text[] = "<**4**>ป.โท|ร้อยละ";
	$heading_text[] = "<**5**>ป.เอก|จำนวน";
	$heading_text[] = "<**5**>ป.เอก|ร้อยละ";
	$heading_text[] = "<**6**>รวม|จำนวน";
	$heading_text[] = "<**6**>รวม|ร้อยละ";
	...
	$column_function[] = (($NUMBER_DISPLAY==2)?"TNUM-2":"ENUM-2");
	$column_function[] = (($NUMBER_DISPLAY==2)?"TNUM":"ENUM");
	$column_function[] = (($NUMBER_DISPLAY==2)?"TNUM-2":"ENUM-2");	// ร้อยละ แนวตั้ง
