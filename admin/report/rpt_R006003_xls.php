<?
	...
	include ("rpt_R006003_format.php");	// ใช้เฉพาะในส่วนการแปลง COLUMN_FORMAT เท่านั้น
...
//	$arr_rpt_order = array("ORG"); 
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ลำดับ","หน่วยงาน/ชื่อ - นามสกุล","ตำแหน่ง","เลขที่","เงินเดือน","เหตุที่ไม่มีสิทธิ์","หมายเหตุ");
		...
		$ws_width = array(8,35,35,10,10,20,20);
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	if($count_data){
		...
		// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนข้อมูล
			...
			$wsdata_align_1 = array("C","L","L","C","R","L","L");
