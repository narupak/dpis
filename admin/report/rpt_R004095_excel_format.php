...
//	fix head for rpt_R004095
	...
	$heading_text[] = "เงินเดือน|";
        $heading_text[] = "<**1**>หน่วยงานตามกฎหมาย|สำนัก";
        $heading_text[] = "<**1**>หน่วยงานตามกฎหมาย|ฝ่าย";
	$heading_text[] = "<**1**>หน่วยงานตามกฎหมาย|กลุ่ม";
	$heading_text[] = "<**1**>หน่วยงานตามกฎหมาย|จังหวัด";
	$heading_text[] = "<**1**>หน่วยงานตามกฎหมาย|สังกัด";
	$heading_text[] = "<**1**>หน่วยงานตามกฎหมาย|กรม";
        $heading_text[] = "<**2**>หน่วยงานตามมอบหมายงาน|สำนัก";
        $heading_text[] = "<**2**>หน่วยงานตามมอบหมายงาน|ฝ่าย";
	$heading_text[] = "<**2**>หน่วยงานตามมอบหมายงาน|กลุ่ม";
	$heading_text[] = "<**2**>หน่วยงานตามมอบหมายงาน|จังหวัด";
	$heading_text[] = "<**2**>หน่วยงานตามมอบหมายงาน|สังกัด";
	$heading_text[] = "<**2**>หน่วยงานตามมอบหมายงาน|กรม";
	$heading_text[] = "กรมเดียวกัน/|ต่างกรม";
	...
	if ($have_pic)
	$data_align =    array("R","C","C","L","L","L","L","L","R","L","L","L","C","L","L","L","L","L","C","L","L","C");
	else
	$data_align =    array("R","C","L","L","L","L","L","R","L","L","L","C","L","L","L","L","L","C","L","L","C");
