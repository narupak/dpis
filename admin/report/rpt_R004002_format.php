...
//	fix head for rpt_R004002
	...
	$heading_text[] = "ตำแหน่ง/ระดับตำแหน่ง|";
	$heading_text[] = "เลขที่|ตำแหน่ง";
	$heading_text[] = "เงินเดือน|";
	$heading_text[] = "วันเข้ารับราชการ|";
	$heading_text[] = "วันเกิด|";
	$heading_text[] = "<**6**>อายุราชการ|ปกติ";
	$heading_text[] = "<**6**>อายุราชการ|ทวีคูณ";
	$heading_text[] = "<**6**>อายุราชการ|รวม";
        if($have_cardno=='1'){
