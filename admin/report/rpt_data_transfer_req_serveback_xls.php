...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	header("Content-Type: application/x-msexcel; name=\"สอบถามข้อมูลข้าราชการ/ลูกจ้างขอบรรจุกลับ.xls\"");
	header("Content-Disposition: inline; filename=\"สอบถามข้อมูลข้าราชการ/ลูกจ้างขอบรรจุกลับ.xls\"");
	$fh=fopen($fname, "rb");
	fpassthru($fh);
	fclose($fh);
	unlink($fname);
