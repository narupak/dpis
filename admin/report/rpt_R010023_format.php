...
//	fix head for rpt_R010023
	...
	$heading_text[] = "$CARDNO_TITLE";
	$heading_text[] = "วันเริ่ม";
	$heading_text[] = "$PM_TITLE";
	$heading_text[] = "$PL_TITLE";
	$heading_text[] = "ระดับ";
	$heading_text[] = "$MINISTRY_TITLE";
	$heading_text[] = "$DEPARTMENT_TITLE";
	$heading_text[] = "$ORG_TITLE";
	$heading_text[] = "วันเดือนปีเกิด";
	$heading_text[] = "อายุ";
	$heading_text[] = "ระดับการศึกษา|(ในตำแหน่ง)";
	$heading_text[] = "วันเริ่ม";
	$heading_text[] = "วันสิ้นสุด";
	$heading_text[] = "ระยะเวลา";
	$heading_text[] = "$PM_TITLE";
	$heading_text[] = "$PL_TITLE";
	$heading_text[] = "ระดับ";
	$heading_text[] = "$MINISTRY_TITLE";
	...
	if($have_pic)
		$data_align = array("L","C","L","C","L","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C","C");
	else
