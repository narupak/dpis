...
//			$list_type_text .= " - $MINISTRY_NAME";
	...
	include ("rpt_R002005_format.php");	// กำหนดหัวและตัวแปรสำหรับการเปลี่ยนรูปแบบรายงาน
...
//	echo "default font_id::".$RTF->dfl_FontID."<br>";	
	...
	$report_title = "$DEPARTMENT_NAME||โครงสร้างอายุราชการ ณ วันที่ ". (date("d") + 0) ." ". $month_full[(date("m") + 0)][TH] ." ". (date("Y") + 543);
...
//				$PER_AGE = floor(date_difference(date("Y-m-d"), $PER_STARTDATE, "y"));
...
//			คิดตามอายุจริง (จากวันเข้ารับราชการ ถึง วันปัจจุบัน)
//			$startdate_min = date_adjust(date("Y-m-d"), "y", -5);
...
//			คิดตามอายุจริง (จากวันเข้ารับราชการ ถึง วันปัจจุบัน)
//			$startdate_max = date_adjust(date("Y-m-d"), "y", -35);
...
//			คิดตามอายุจริง (จากวันเข้ารับราชการ ถึง วันปัจจุบัน)
//			$startdate_max = date_adjust(date("Y-m-d"), "y", $min_age);
//			$startdate_min = date_adjust(date("Y-m-d"), "y", $max_age);
...
//			คิดเฉพาะปีเข้ารับราชการ กับปีปัจจุบัน
			$startyear_max = date("Y") + $min_age;
			$startyear_min = date("Y") + $max_age;
