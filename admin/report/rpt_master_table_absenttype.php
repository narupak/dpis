...
//	session_cache_limiter("nocache");
	...
	session_start();
		...
		$fname= "rpt_master_table_absenttype.rtf";
	...
	$heading_text[2] = "จำนวนวันลา";
	$heading_text[3] = "นับวันหยุด";
...
//	$db_dpis->show_error();
	...
	if($count_data){
		...
		while($data = $db_dpis->get_array()){
			...
			$arr_data[] = "<*img*".(($data[$arr_fields[3]]==1)?"../images/true.jpg":"../images/false.jpg")."*img*>";
