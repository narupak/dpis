...
//	$arr_rpt_order = array("POSNO"); 
	...
	$company_name = "$MINISTRY_NAME";
	$report_title = "ข้อมูลข้าราชการ กรม / สำนักงาน   $list_type_text   ปีงบประมาณ $search_budget_year";
	$report_code = "ข้อมูลข้าราชการ";
...
*/
	function print_header(){
		...
		*/
		$worksheet->write($xlsRow, 0, "ตำแหน่งเลขที่", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 1, "คำนำหน้า", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 2, "ชื่อ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 3, "นามสกุล", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 4, "ตำแหน่งในการบริหารงาน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 5, "ตำแหน่งในสายงาน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		...
		$worksheet->write($xlsRow, 8, "ระดับ (ซี) เดิม", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 9, "สำนัก / กอง", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 10, "กรม", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		$worksheet->write($xlsRow, 11, "จังหวัด", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		$worksheet->write($xlsRow, 12, "ระดับการศึกษา", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		$worksheet->write($xlsRow, 13, "วุฒิการศึกษาสูงสุด", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		$worksheet->write($xlsRow, 14, "สาขาวิชาเอก", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		$worksheet->write($xlsRow, 15, "สถาบันการศึกษา", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		$worksheet->write($xlsRow, 16, "วันเกิด", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		$worksheet->write($xlsRow, 17, "วันบรรจุเข้ารับราชการ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 18, "วันเข้าสู่ระดับตำแหน่งปัจจุบัน", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 19, "วันเกษียณอายุราชการ", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	if($count_data){
		...
		/*	if (trim($arr_content[$data_count][birthdate])) :
			...
			$ORG_NAME_1 = $arr_content[$data_count][org_name_1]; 	// ชื่อกรม
			$ORG_NAME_2 = $arr_content[$data_count][org_name_2]; 	// ชื่อสำนัก/กอง
			$ORG_NAME_3 = $arr_content[$data_count][org_name_3]; 	// ชื่อฝ่าย
			$ORG_NAME_4 = $arr_content[$data_count][org_name_4]; 	// ชื่องาน
			...
			$LEVEL_NO2 = $arr_content[$data_count][level_no2];
			...
			if($REPORT_ORDER == "ORG_REF"){
				...
				$worksheet->write_string($xlsRow, 1, "$PN_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				...
				$worksheet->write_string($xlsRow, 6, "$CMD_POSITION_TYPE", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 7, "$LEVEL_NAME", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 8, "$LEVEL_NO2", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 9, "$ORG_NAME_2", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				$worksheet->write_string($xlsRow, 10, "$ORG_NAME_1", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				$worksheet->write_string($xlsRow, 11, "$PV_NAME", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
				...
				$worksheet->write_string($xlsRow, 16, "$PER_BIRTHDATE", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 17, "$PER_STARTDATE", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 18, "$POH_EFFECTIVEDATE", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
				$worksheet->write_string($xlsRow, 19, "$PER_RETIREDATE", set_format("xlsFmtTableDetail", "", "C", "TLRB", 0));
	...
	header("Content-Type: application/x-msexcel; name=\"moac.xls\"");
	header("Content-Disposition: inline; filename=\"moac.xls\"");
	$fh=fopen($fname, "rb");
	fpassthru($fh);
	fclose($fh);
	unlink($fname);
