...
//	fix head for rpt_R010032
	...
	if ($ISCS_FLAG==1) {
		...
		$heading_text[2] = "<**1**>บริหาร|<**6**>สูง|ชาย";
		$heading_text[3] = "<**1**>บริหาร|<**6**>สูง|หญิง";
		$heading_text[4] = "<**1**>บริหาร|<**7**>ต้น|ชาย";
		$heading_text[5] = "<**1**>บริหาร|<**7**>ต้น|หญิง";
		$heading_text[6] = "<**2**>อำนวยการ|<**8**>สูง|ชาย";
		$heading_text[7] = "<**2**>อำนวยการ|<**8**>สูง|หญิง";
		$heading_text[8] = "<**2**>อำนวยการ|<**9**>ต้น|ชาย";
		$heading_text[9] = "<**2**>อำนวยการ|<**9**>ต้น|หญิง";
		...
		$heading_text[0] = "|ลำดับ||";
		$heading_text[1] = "|$heading_name||";
		$heading_text[2] = "<**1**>บริหาร|<**6**>|<**6^**>สูง|ชาย";
		$heading_text[3] = "<**1**>บริหาร|<**6**>|<**6^**>สูง|หญิง";
		$heading_text[4] = "<**1**>บริหาร|<**7**>|<**7^**>ต้น|ชาย";
		$heading_text[5] = "<**1**>บริหาร|<**7**>|<**7^**>ต้น|หญิง";
		$heading_text[6] = "<**2**>อำนวยการ|<**8**>|<**8^**>สูง|ชาย";
		$heading_text[7] = "<**2**>อำนวยการ|<**8**>|<**8^**>สูง|หญิง";
		$heading_text[8] = "<**2**>อำนวยการ|<**9**> |<**9^**>ต้น|ชาย";
		$heading_text[9] = "<**2**>อำนวยการ|<**9**> |<**9^**>ต้น|หญิง";
