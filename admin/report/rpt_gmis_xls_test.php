...
//	$arr_rpt_order = array("POSNO"); 
	...
	function print_header(){
		...
		$worksheet->set_column(42, 42, 20);
                ...
                $worksheet->set_column(55, 55, 50);
                $worksheet->set_column(56, 56, 50);
                $worksheet->set_column(57, 57, 50);
                */
		...
		$worksheet->write($xlsRow, 46, "tempPerSPSkillDes1", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
                ...
                $worksheet->write($xlsRow, 52, "tempSPS_Flag2", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
            /*    
                $worksheet->write($xlsRow, 53, "tempMPerSPSkill3", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
		$worksheet->write($xlsRow, 54, "tempSPerSPSkill3", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
                $worksheet->write($xlsRow, 55, "tempSkillLevel3", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
                $worksheet->write($xlsRow, 56, "tempPerSPSkillDes3", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
                $worksheet->write($xlsRow, 57, "tempSPS_Flag3", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 0));
            */    
                                                                ...
                                                                if($PER_ID){
                                                                        $cmd = "    WITH TB_MAIN AS ( 
                                                                                        SELECT 	ROW_NUMBER() OVER (
                                                                                                ...
                                                                                                b.PER_ID, c.SS_NAME, SPS_EMPHASIZE, b.SS_CODE, b.LEVELSKILL_CODE,(CASE WHEN b.AUDIT_FLAG IS NULL OR b.AUDIT_FLAG='N' THEN '0' ELSE b.AUDIT_FLAG END) AS AUDIT_FLAG,
                                                                                                b.SPS_FLAG , d.LEVELSKILL_NAME
                                                                                                FROM 	 PER_SPECIAL_SKILL b ,PER_SPECIAL_SKILLGRP c ,PER_LEVELSKILL d
                                                                                                WHERE 	 b.SS_CODE = c.SS_CODE and b.LEVELSKILL_CODE = d.LEVELSKILL_CODE(+)
                                                                                        ...
                                                                                        SELECT 	ROW_NUM AS ROW_NUM2 ,	PER_ID AS PER_ID2, SS_NAME as SS_NAME2, SPS_EMPHASIZE as SPS_EMPHASIZE2,
                                                                                                SS_CODE AS SS_CODE2, LEVELSKILL_CODE AS LEVELSKILL_CODE2, AUDIT_FLAG AS AUDIT_FLAG2,
                                                                    ...
                                                                    /*            
                                                                        $cmd = "  select * from (
                                                                                        select rownum rnum, q1.* from ( 
                                                                                                select 	 	b.PER_ID, c.SS_NAME, SPS_EMPHASIZE, b.SS_CODE, b.LEVELSKILL_CODE,(case when b.AUDIT_FLAG is null or b.AUDIT_FLAG='N' then '0' else b.AUDIT_FLAG end) as AUDIT_FLAG,b.SPS_FLAG
                                                                        ...
                                                                        //echo "สกิล 1 =>".$LEVELSKILL_NAME."<br>";
                                                                        //echo "ความเชี่ยวชาญพิเศษ 1 =>".$SS_CODE."<br>";
                                                                        //echo "เน้นทาง 1 =>".$SPS_EMPHASIZE."<br>";
                                                                
                                                                        // ความเชี่ยวชาญพิเศษ และ เน้นทาง col 2  07/11/2016
                                                                        $cmd = "  select * from (
                                                                                        select rownum rnum2, q2.* from ( 
                                                                                                select 	 	b.PER_ID, c.SS_NAME as SS_NAME2, SPS_EMPHASIZE as SPS_EMPHASIZE2, b.SS_CODE as SS_CODE2, b.LEVELSKILL_CODE as LEVELSKILL_CODE2,(case when b.AUDIT_FLAG is null or b.AUDIT_FLAG='N' then '0' else b.AUDIT_FLAG end) as AUDIT_FLAG2,b.SPS_FLAG as SPS_FLAG2
                                                                                                from 		PER_SPECIAL_SKILL b 
                                                                                                                left join PER_SPECIAL_SKILLGRP c on(b.SS_CODE = c.SS_CODE)
                                                                                                where 		PER_ID=$PER_ID  
                                                                                                ORDER BY        (case when b.AUDIT_FLAG is null or b.AUDIT_FLAG='N' then '0' else b.AUDIT_FLAG end) desc, b.SPS_SEQ_NO  asc   
                                                                ...
                                                                /*
                                                                        ...
                                                                        $cmd = " select * from (
                                                                                        select rownum rnum3, q3.* from ( 
                                                                                                select 	 	b.PER_ID, c.SS_NAME as SS_NAME3, SPS_EMPHASIZE as SPS_EMPHASIZE3, b.SS_CODE as SS_CODE3, b.LEVELSKILL_CODE as LEVELSKILL_CODE3, NVL(b.AUDIT_FLAG,'N') as AUDIT_FLAG3,b.SPS_FLAG as SPS_FLAG3
                                                                                                from 		PER_SPECIAL_SKILL b 
                                                                                                                left join PER_SPECIAL_SKILLGRP c on(b.SS_CODE = c.SS_CODE)
                                                                                                where 		PER_ID=$PER_ID  
                                                                                                ORDER BY        NVL(b.AUDIT_FLAG,'N')  asc, b.SPS_SEQ_NO  asc   
                                                                                         )  q3
                                                                        ...
                                                                        $SPS_FLAG_C3 = trim($data2[SPS_FLAG3]);
                                                                        if($SPS_FLAG_C3 == '1'){
                                                                            $SPS_FLAG3 = $SPS_FLAG_C3."-ความเชี่ยวชาญในงานราชการ";
                                                                        }else if($SPS_FLAG_C3 == '2'){
                                                                             $SPS_FLAG3 = $SPS_FLAG_C3."-ความเชี่ยวชาญอื่น ๆ";
                                                                        }else{
                                                                             $SPS_FLAG3 = "";
                                                                        }
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			$PERCENT_SALARY2 = $arr_content[$data_count][percent_salary2];
                        if($PER_NAME){
                                ...
                                $SPS_FLAG2  = $arr_content[$data_count][SPS_FLAG2];
                            /*    
                                ...
                                $SPS_FLAG3  = $arr_content[$data_count][SPS_FLAG3];
                            */    
                        }else{
                                ...
                                $SPS_FLAG2  = $arr_content[SPS_FLAG2];
                            /*    
                                ...
                                $SPS_FLAG3  = $arr_content[SPS_FLAG3];
                            */    
                        }
...
//				require_once "../../Excel/my.defined_format.inc.php";	// use set_format(set of parameter) funtion , help is in file
				...
				if($company_name){
					...
					$worksheet->write($xlsRow, 42, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
                                    ...
                                    /*    
                                        ...
                                        $worksheet->write($xlsRow, 55, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
                                        $worksheet->write($xlsRow, 56, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
                                        $worksheet->write($xlsRow, 57, "", set_format("xlsFmtSubTitle", "B", "L", "", 1));
                                    */    
			...
			if(!$f_org_ref_skip){ // ถ้ารายการนี้มี $REPORT_ORDER == "ORG_REF" จะไม่พิมพ์รายละเอียดข้างล่าง
				...
				$worksheet->write_string($xlsRow, 42, "$PERCENT_SALARY2", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                            ...
                            /*     
                                $worksheet->write_string($xlsRow, 53, "$SS_CODE3", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                $worksheet->write_string($xlsRow, 54, "$REF_CODE3", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                $worksheet->write_string($xlsRow, 55, "$LEVELSKILL_NAME3", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                $worksheet->write_string($xlsRow, 56, "$SPS_EMPHASIZE3", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                                $worksheet->write_string($xlsRow, 57, "$SPS_FLAG3", set_format("xlsFmtTableDetail", "", "L", "TLRB", 0));
                            */    
