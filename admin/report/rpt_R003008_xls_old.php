...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	if($count_data){
		...
		$worksheet->write($xlsRow, 4, ($GRAND_TOTAL_4?(($NUMBER_DISPLAY==2)?convert2thaidigit(number_format($GRAND_TOTAL_4,2)):number_format($GRAND_TOTAL_4, 2)):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
