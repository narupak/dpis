...
//	fix head for rpt_R001001
	...
	$heading_text[3] = "<**2**>ว่าง|ตำแหน่ง";
	$heading_text[4] = "<**2**>ว่าง|ร้อยละ";
	if ($BKK_FLAG==1) {
		$heading_text[5] = "<**3**>กรอบอัตรากำลัง|ตำแหน่ง";
		$heading_text[6] = "<**3**>กรอบอัตรากำลัง|ร้อยละ";
	} else {
		$heading_text[5] = "<**3**>รวม|ตำแหน่ง";
		$heading_text[6] = "<**3**>รวม|ร้อยละ";
	}
