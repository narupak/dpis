...
//	fix head for user_menu
	...
	$heading_text[0] =  "ชื่อเมนู";
	$heading_text[1] =  "แสดง";
	$heading_text[2] =  "เพิ่ม";
	$heading_text[3] =  "แก้ไข";
	$heading_text[4] =  "ลบ";
    $heading_text[5] =  "รายงาน";
	$heading_text[6] =  "ยืนยันคำสั่ง";
	$heading_text[7] =  "ตรวจสอบ";
	$heading_text[8] =  "แนบไฟล์";
