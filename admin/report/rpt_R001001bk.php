...
//		echo "<br>$cmd<br>";
	...
	while($data = $db_dpis->get_array()){
		...
		if($MINISTRY_ID != $data[MINISTRY_ID]){
			...
			$arr_content[$data_count][short_name] = str_repeat(" ", ($rpt_order_index * 5)) .$MINISTRY_NAME;
			$arr_content[$data_count][id] = $DEPARTMENT_ID;
			$arr_content[$data_count][count1] = $GRAND_TOTAL1[$DEPARTMENT_ID];
			$arr_content[$data_count][count2] = $GRAND_TOTAL2[$DEPARTMENT_ID];
			$arr_content[$data_count][count3] = $GRAND_TOTAL3[$DEPARTMENT_ID];
		...
		if($DEPARTMENT_ID_INI != $DEPARTMENT_ID){
			...
			$arr_content[$data_count][short_name] = str_repeat(" ", ($rpt_order_index * 5)) .$DEPARTMENT_NAME;
			$arr_content[$data_count][id] = $DEPARTMENT_ID;
			$arr_content[$data_count][count1] = $GRAND_TOTAL1[$DEPARTMENT_ID];
			$arr_content[$data_count][count2] = $GRAND_TOTAL2[$DEPARTMENT_ID];
			$arr_content[$data_count][count3] = $GRAND_TOTAL3[$DEPARTMENT_ID];
	...
	if($count_data){
		...
		for($data_count=0; $data_count<count($arr_content); $data_count++){
			...
			if($REPORT_ORDER == "MINISTRY" || $REPORT_ORDER == "DEPARTMENT"){ 
				$COUNT_1 = $arr_content[$data_count][count1];
				$COUNT_2 = $arr_content[$data_count][count2];
				$COUNT_3 = $arr_content[$data_count][count3];
