...
//	session_cache_limiter("nocache");
	...
	function print_header(){
		...
		$pdf->Cell($heading_width[1] ,7,"ชื่อสมรรถนะ",'LTBR',0,'C',1);
		$pdf->Cell($heading_width[2] ,7,"โมเดล",'LTBR',0,'C',1);
...
//	$db_dpis->show_error();
	...
	if($count_data){
		...
		while($data = $db_dpis->get_array()){
			...
			if ($CP_MODEL == 1)			$CP_MODEL = "ความรอบรู้ในการบริหาร";
			elseif ($CP_MODEL == 2)		$CP_MODEL = "การบริหารอย่างมืออาชีพ";
			elseif ($CP_MODEL == 3)		$CP_MODEL = "การบริหารคน";
			elseif ($CP_MODEL == 4)		$CP_MODEL = "การบริหารแบบมุ่งผลสัมฤทธิ์";
