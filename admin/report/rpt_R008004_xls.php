...
//	$arr_rpt_order = array("ORG", "CRIME", "LINE", "LEVEL", "SEX"); 
	...
	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		$ws_head_line1 = array("ฐานความผิด","<**1**>รวม","<**1**>รวม");
		$ws_head_line2 = array("","จำนวน","ร้อยละ");
...
/*		
		...
		$xlsRow++;
		$worksheet->write($xlsRow, 0, "ฐานความผิด", set_format("xlsFmtTableHeader", "B", "C", "TLR", 0));
		$worksheet->write($xlsRow, 1, "รวม", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));
		$worksheet->write($xlsRow, 2, "", set_format("xlsFmtTableHeader", "B", "C", "TLRB", 1));

		$xlsRow++;
		$worksheet->write($xlsRow, 0, "", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 1, "จำนวน", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
		$worksheet->write($xlsRow, 2, "ร้อยละ", set_format("xlsFmtTableHeader", "B", "C", "LRB", 0));
*/
	} // function		
...
//	echo "<pre>"; print_r($arr_content); echo "</pre>";
	...
	if($count_data){
		...
		// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนข้อมูล
			$wsdata_fontfmt_1 = array("B","B","B");
			$wsdata_align_1 = array("L","C","C");
			$wsdata_border_1 = array("TLRB","TLRB","TLRB");
			$wsdata_colmerge_1 = array(0,0,0);
...
/*
			if(array_search($REPORT_ORDER, $arr_rpt_order) !== false  && array_search($REPORT_ORDER, $arr_rpt_order) == 0 && count($arr_rpt_order) > 1){
				...
				$worksheet->write($xlsRow, 2, ($COUNT_PERCENT?number_format($COUNT_PERCENT, 2):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
			}else{
				$xlsRow++;
				...
				$worksheet->write($xlsRow, 2, ($COUNT_PERCENT?number_format($COUNT_PERCENT, 2):"-"), set_format("xlsFmtTableDetail", "", "R", "TLRB", 0));
			} // end if
*/
		} // end for
...
/*
		...
		$worksheet->write($xlsRow, 1, ($GRAND_TOTAL_1?number_format($GRAND_TOTAL_1):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
		$worksheet->write($xlsRow, 2, ($GRAND_TOTAL?number_format((($GRAND_TOTAL/$GRAND_TOTAL) * 100), 2):"-"), set_format("xlsFmtTableDetail", "B", "R", "TLRB", 0));
*/
	}else{
		$xlsRow = 0;
