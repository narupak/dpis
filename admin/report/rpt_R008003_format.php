...
//	fix head for rpt_R008003
	...
	$heading_text[1] = "<**1**>ผลการลงโทษ|ภาคทัณฑ์";
	$heading_text[2] = "<**1**>ผลการลงโทษ|ตัดเงินเดือน";
	$heading_text[3] = "<**1**>ผลการลงโทษ|ลดเงินเดือน";
	$heading_text[4] = "<**1**>ผลการลงโทษ|ปลดออก";
	$heading_text[5] = "<**1**>ผลการลงโทษ|ไล่ออก";
	$heading_text[6] = "<**2**>รวม|จำนวน";
	$heading_text[7] = "<**2**>รวม|ร้อยละ";
	...
	$data_align = array("L","R","R", "R","R","R","R","R");
