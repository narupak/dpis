...
//	fix head for P03011
	...
	$heading_text[2] = $FULLNAME_HEAD." ";
	if ($CARDNO_FLAG==1) $heading_text[2] .= "|$CARDNO_TITLE";
	$heading_text[3] = $COM_HEAD_01."ที่ ก.พ. กำหนดไว้เดิม|ตำแหน่ง/สังกัด";
	$heading_text[4] = $COM_HEAD_01."ที่ ก.พ. กำหนดไว้เดิม|ประเภทตำแหน่ง";
	$heading_text[5] = $COM_HEAD_01."ที่ ก.พ. กำหนดไว้เดิม|ระดับตำแหน่ง";
	$heading_text[6] = $COM_HEAD_01."ที่ ก.พ. กำหนดไว้เดิม|เงินเดือน";
	$heading_text[7] = $COM_HEAD_02."ที่กำหนดใหม่|ตำแหน่ง/สังกัด";
	$heading_text[8] = $COM_HEAD_02."ที่กำหนดใหม่|ประเภทตำแหน่ง";
	$heading_text[9] = $COM_HEAD_02."ที่กำหนดใหม่|ระดับตำแหน่ง";
	$heading_text[10] = $COM_HEAD_02."ที่กำหนดใหม่|เงินเดือน";
	...
	$data_align = array("C", "C", "L", "L", "C", "C", "R", "L", "C", "C", "R", "L");
