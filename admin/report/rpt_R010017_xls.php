...
//	session_cache_limiter("nocache");
	...
	session_start();
 	...
 	// กำหนดค่าตัวแปรเพื่อพิมพ์ ส่วนหัวรายงาน
		...
		$ws_head_line1 = array("ส่วนราชการ","ตำแหน่ง","ระดับวุฒิ","ชื่อวุฒิ","สาขาวิชาเอก","สถาบัน","ประเทศ","ปีเกษียณ");
		$ws_head_line2 = array("ชื่อ-สกุล","","การศึกษา","การศึกษา","","การศึกษา","","(1 ต.ค.)");
...
//									$style = array("B", "B", "", "", "", "", "", "");
								...
								for($i=0; $i < count($ws_width1); $i++) {
									if ($i==0)
										$worksheet->write($xlsRow, $colseq, "********** ไม่มีข้อมูล **********", set_format("xlsFmtTitle", "B", "C", "", 1));
									else
...
//							$db_dpis2->show_error();
							if($count_specialskillhis){
								...
								for($i=0; $i < count($ws_width1); $i++) {
									if ($i==0)
										$worksheet->write($xlsRow, $colseq, "ความเชี่ยวชาญพิเศษ", set_format("xlsFmtTitle", "B", "L", "", 0));
									else
										$worksheet->write($xlsRow, $colseq, "", set_format("xlsFmtTitle", "B", "L", "", 0));
						//				echo "$xlsRow $colseq ($i)-> $report_title<br>";
									$colseq++;
