<?
	...
	$company_name = "";
	$report_title = "บัญชีจัดข้าราชการพลเรือนสามัญเข้าประเภทตำแหน่ง สายงานและระดับตำแหน่งตามพระราชบัญญัติระเบียบข้าราชการพลเรือน พ.ศ.2551<br>ใน$DEPARTMENT_NAME  $MINISTRY_NAME  บัญชี 2";
	$report_code = "";
...
//		$worksheet->set_column(15, 15, 20);
		...
		$worksheet->write($xlsRow, 6, "ส่วนราชการและตำแหน่งที่ ก.พ. กำหนดเดิม", set_format("xlsFmtTableHeader", "B", "C", "T", 1));
		...
		$worksheet->write($xlsRow, 10, "ส่วนราชการและตำแหน่งที่ กำหนดใหม่", set_format("xlsFmtTableHeader", "B", "C", "T", 1));
...
//					$worksheet->write($xlsRow, 15, "", set_format("xlsFmtTableDetail", "", "L", "", 0));
					...
					$worksheet->write($xlsRow, 13, "$CMD_SALARY", set_format("xlsFmtTableDetail", "", "R", "TLRB", 0));
