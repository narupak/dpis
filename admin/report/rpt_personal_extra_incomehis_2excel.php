<?	
	...
	$header_width[0] = 15; $header_text[0] = "รหัสรายการ"; 			//	EXINH_ID;
	$header_width[1] = 30; $header_text[1] = "ชื่อ";							//	PER_NAME+PER_SURNAME;
	$header_width[2] = 20; $header_text[2] = "วันที่มีผล";					//	EXINH_EFFECTIVEDATE;
	$header_width[3] = 20; $header_text[3] = "ถึงวันที่";					//	EXINH_ENDDATE; 
	$header_width[4] = 20; $header_text[4] = "จำนวนเงิน";				//	EXINH_AMT;
	$header_width[5] = 40; $header_text[5] = "ประเภทเงินพิเศษ";		//	EXIN_CODE;
