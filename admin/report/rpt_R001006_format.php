...
//	fix head for rpt_R001006
	...
	for($i=0; $i<5; $i++) {
		$heading_text[] = "<**1**>ปีงบประมาณ|<**".($i+1)."**>".(($NUMBER_DISPLAY==2)?convert2thaidigit($arr_budget_year[$i]):$arr_budget_year[$i])."|จำนวน";
		$heading_text[] = "<**1**>ปีงบประมาณ|<**".($i+1)."**>".(($NUMBER_DISPLAY==2)?convert2thaidigit($arr_budget_year[$i]):$arr_budget_year[$i])."|ร้อยละ";
	}
	$heading_text[] = "<**2**>รวม||จำนวน";
	$heading_text[] = "<**2**>รวม||ร้อยละ";
