...
//	session_cache_limiter("nocache");
	...
	$heading_width[EDUCATE][0] = "30";		// "40";
	$heading_width[EDUCATE][1] = "13";		// "20";
	$heading_width[EDUCATE][2] = "20";		// "35";
	$heading_width[EDUCATE][3] = "20";		// "35";
	$heading_width[EDUCATE][4] = "15";		// "25";
	$heading_width[EDUCATE][5] = "32";		// "45";
	...
	$heading_bkk1_width[EDUCATE][0] = "60";
	$heading_bkk1_width[EDUCATE][1] = "30";
	$heading_bkk1_width[EDUCATE][2] = "40";
	$heading_bkk2_width[EDUCATE][0] = "40";
	$heading_bkk2_width[EDUCATE][1] = "30";
	$heading_bkk2_width[EDUCATE][2] = "60";
	...
	if ($BKK_FLAG==1) {
		...
		$heading_width[POSITIONHIS][1] = "60";      
		$heading_width[POSITIONHIS][2] = "10";
		$heading_width[POSITIONHIS][3] = "10";
		$heading_width[POSITIONHIS][4] = "10";
		$heading_width[POSITIONHIS][5] = "20";
		$date_format = 2;
	} else {
		$heading_width[POSITIONHIS][0] = "60";
		$heading_width[POSITIONHIS][1] = "20";      
		$heading_width[POSITIONHIS][2] = "10";
		$heading_width[POSITIONHIS][3] = "10";
		$heading_width[POSITIONHIS][4] = "10";
		$heading_width[POSITIONHIS][5] = "20";
	...
	$heading_width[PUNISHMENT][0] = "34";
	$heading_width[PUNISHMENT][1] = "62";
	$heading_width[PUNISHMENT][2] = "34";
	...
	$heading_width[NOTPAID][0] = "34";
	$heading_width[NOTPAID][1] = "62";
	$heading_width[NOTPAID][2] = "34";
	...
	$heading_width[ABILITY][0] = "65";
	$heading_width[ABILITY][1] = "65";
	...
	$heading_width[SERVICEHIS][1] = "45";
	$heading_width[SERVICEHIS][2] = "20";
	$heading_width[SERVICEHIS][3] = "45";
...
//	$heading_text[SERVICEHIS][3] = "หนังสือ";
	...
	$heading_width[SPECIALSKILLHIS][0] = "55";
	$heading_width[SPECIALSKILLHIS][1] = "75";
	...
	$heading_width[DECORATEHIS][0] = "34";
	$heading_width[DECORATEHIS][1] = "36";
	$heading_width[DECORATEHIS][2] = "20";
	$heading_width[DECORATEHIS][3] = "20";
	$heading_width[DECORATEHIS][4] = "20";
	...
	$heading_width[ABSENTSUM][0] = "18";
	$heading_width[ABSENTSUM][1] = "8";
	$heading_width[ABSENTSUM][2] = "8";
	$heading_width[ABSENTSUM][3] = "8";
	$heading_width[ABSENTSUM][4] = "8";
	$heading_width[ABSENTSUM][5] = "8";
	$heading_width[ABSENTSUM][6] = "8";
	$heading_width[ABSENTSUM][7] = "8";
	$heading_width[ABSENTSUM][8] = "8";
	$heading_width[ABSENTSUM][9] = "8";
	$heading_width[ABSENTSUM][10] = "8";
	$heading_width[ABSENTSUM][11] = "8";
	$heading_width[ABSENTSUM][12] = "8";
	$heading_width[ABSENTSUM][13] = "8";
	$heading_width[ABSENTSUM][14] = "8";
	...
	if ($BKK_FLAG==1) {
		$heading_width[KPI][0] = "16";
		$heading_width[KPI][1] = "19";
		$heading_width[KPI][2] = "19";
		$heading_width[KPI][3] = "19";
		$heading_width[KPI][4] = "19";
		$heading_width[KPI][5] = "19";
		$heading_width[KPI][6] = "19";
		...
		$heading_width[KPI][0] = "11";
		$heading_width[KPI][1] = "11";
		$heading_width[KPI][2] = "11";
		$heading_width[KPI][3] = "11";
		$heading_width[KPI][4] = "11";
		$heading_width[KPI][5] = "11";
		$heading_width[KPI][6] = "11";
		$heading_width[KPI][7] = "11";
		$heading_width[KPI][8] = "11";
		$heading_width[KPI][9] = "11";
		$heading_width[KPI][10] = "20";
	...
	function print_header($HISTORY_NAME){
		...
		global $heading_width, $heading_text, $heading_align, $column_function;
...
//				echo "colmap $i=".$arr_column_map[$col]."..select=".$arr_column_sel[$arr_column_map[$col]]."<br>";
				if ($arr_column_sel[$arr_column_map[$col]]==1) {	// พิมพ์เฉพาะที่เลือกให้แสดง
					$buff = explode("|",doo_merge_cell($head_text[$row][$arr_column_map[$col]], "TLBR", "0", $pgrp, ($col == count($heading_width[$HISTORY_NAME])-1)));
...
//					$worksheet->write($xlsRow, $colseq, $ndata, set_format("xlsFmtTableHeader", $ws_fontfmt_line1[$arr_column_map[$i]], $ws_headalign_line1[$arr_column_map[$i]], $border, $merge));
					...
					$RTF->cell($RTF->bold(1).$ndata.$RTF->bold(0), $heading_width[$HISTORY_NAME][$col], $a, "25", $border);	
				}
			}
			$RTF->close_line();
		}
/*
		switch($HISTORY_NAME){
			...
			case "DECORATEHIS" :
				...
				$RTF->set_font($font, 14);
				$RTF->color("0");	// 0='BLACK'
				$RTF->cell($RTF->bold(1)."(1) ตำแหน่ง (อดีต-ปัจจุบัน เฉพาะปีที่ได้รับ พระราชทานเครื่องราชฯ)".$RTF->bold(0), $heading_width[$HISTORY_NAME][0], "center", "25", "TRBL");	
				$RTF->cell($RTF->bold(1)."(2) ลำดับเครื่องราชฯ ที่ได้รับ พระราชทานแล้ว จากชั้นรองไปชั้นสูงตาม (1)".$RTF->bold(0), $heading_width[$HISTORY_NAME][1], "center", "25", "TRBL");
				$RTF->cell($RTF->bold(1)."(3) ว.ด.ป. ที่ได้รับ พระราชทานตาม (2)".$RTF->bold(0), $heading_width[$HISTORY_NAME][2], "center", "25", "TRBL");
				$RTF->cell($RTF->bold(1)."(4) เครื่องราชฯ ตาม (2) รับมอบเมื่อ ".$RTF->bold(0), $heading_width[$HISTORY_NAME][3], "center", "25", "TRBL");
				$RTF->cell($RTF->bold(1)."(5) เครื่องราชฯ ตาม (2) ส่งคืนเมื่อ ".$RTF->bold(0), $heading_width[$HISTORY_NAME][4], "center", "25", "TRBL");
				$RTF->close_line();
				break;			
			case "ABSENTHIS" :
				$RTF->open_line();
...
*/
	...
	function print_footer($LEVEL_NAME) {
		...
		$RTF->color("0");	// 0='BLACK'
		$RTF->cell($RTF->bold(1).$prt_text_footer.$RTF->bold(0), 100, "left", "25", "TBL");	
		$RTF->cell($RTF->bold(1)."หน้า [$page_no]".$RTF->bold(0), 30, "right", "25", "TRB");
		$RTF->close_line();
	} // function footer
...
//						$DEH_SHOW1 = "$DC_NAME รับพระราชทานเมื่อ $DEH_DATE1 ";
			...
			for($history_index=0; $history_index<count($arr_history_sort); $history_index++){
				...
				switch($HISTORY_NAME){
					case "EDUCATE" :
						...
						$RTF->cell($RTF->color("0").$RTF->bold(1)."11. การได้รับโทษทางวินัย ".$RTF->bold(0), "$page_ch", "center", "16", "TRBL");
						$RTF->close_line();
			...
			//			$db_dpis2->show_error();
						...
						$RTF->cell("1. ชื่อ  ".$FULLNAME, "32", "left", "8", "TRBL");
						$RTF->cell("5. ชื่อบิดา  ".($FATHERNAME?$FATHERNAME:"-"), "34", "left", "8", "TRBL");
						...
						$RTF->set_font($font,14);
						$RTF->color("1");	// 0=DARKGRAY
						$RTF->cell("2. วัน เดือน ปี เกิด  ".$PER_BIRTHDATE, "32", "left", "8", "TRBL");
						$RTF->cell("6. ชื่อมารดา  ".($MOTHERNAME?$MOTHERNAME:"-"), "34", "left", "8", "TRBL");
						...
						$RTF->set_font($font,14);
						$RTF->color("1");	// 0=DARKGRAY
						$RTF->cell("3. วันครบเกษียณอายุ ".$PER_RETIREDATE, "32", "left", "8", "TRBL");
						$RTF->cell("7. วันสั่งบรรจุ  ".$PER_STARTDATE, "34", "left", "8", "TRBL");
						$RTF->cell("", "32", "left", "8", "RL");
						$RTF->close_line();
						...
						$RTF->set_font($font,14);
						$RTF->color("1");	// 0=DARKGRAY
						$RTF->cell("4. ชื่อคู่สมรส ".($SHOW_SPOUSE?$SHOW_SPOUSE:"-"), "32", "left", "8", "TRBL");
						$RTF->cell("8. วันเริ่มปฏิบัติราชการ  ".$PER_STARTDATE, "34", "left", "8", "TRBL");
						$RTF->cell("", "32", "left", "8", "RL");
						$RTF->close_line();
						...
						$RTF->set_font($font,14);
						$RTF->color("1");	// 0=DARKGRAY
						$RTF->cell("    ภูมิลำเนา ".($PV_NAME?$PV_NAME:"-"), "32", "left", "8", "TRBL");
						$RTF->cell("9. ประเภทข้าราชการ ".$OT_NAME, "34", "left", "8", "TRBL");
						...
						$RTF->cell("เลขประจำตัวประชาชน : ".(($NUMBER_DISPLAY==2)?convert2thaidigit(card_no_format($PER_CARDNO,1)):card_no_format($PER_CARDNO,1)), "32", "left", "8", "TRBL");
						$RTF->close_line();
						...
						$RTF->cell("เลขประจำตัวข้าราชการ : $PER_OFFNO", "32", "left", "8", "TRBL");
						$RTF->close_line();
					...
					// เฉพาะ EDUCATE และ TRAINING
						...
						$RTF->set_font($font,14);
						$RTF->color("1");	// 0=DARKGRAY
						$RTF->cell($RTF->bold(1)."10. ประวัติการศึกษา ฝึกอบรมและดูงาน".$RTF->bold(0), "$page_ch", "center", "8", "TRBL");
						$RTF->close_line();
						...
						if($DPISDB=="odbc"){
							$cmd = " 	select		a.EDU_STARTYEAR, a.EDU_ENDYEAR, a.EDU_INSTITUTE, b.EN_NAME, c.EM_NAME, d.INS_NAME, EDU_HONOR
									 ...
									 order by		a.EDU_SEQ, a.EDU_STARTYEAR, a.EDU_ENDYEAR ";							   
						}elseif($DPISDB=="oci8"){
							$cmd = " select		a.EDU_STARTYEAR, a.EDU_ENDYEAR, a.EDU_INSTITUTE, b.EN_NAME, c.EM_NAME, d.INS_NAME, EDU_HONOR
...
//						$HISTORY_NAME = "EDUCATE";
						if ($BKK_FLAG==1) { // กทม
							$RTF->open_line();
							$RTF->set_font($font,14);
							$RTF->color("1");	// 0=DARKGRAY
							$RTF->cell("ประวัติการศึกษา", "100", "center", "8", "TRBL");
//							$RTF->cell("ประวัติการฝึกอบรมและดูงาน", "52", "center", "8", "TRBL");
							...
							$RTF->set_font($font, 14);
							$RTF->color("0");	// 0='BLACK'
							$RTF->cell($RTF->bold(1).$heading_bkk1_text[$HISTORY_NAME][0].$RTF->bold(0), $heading_bkk1_width[$HISTORY_NAME][0], "center", "25", "TRBL");	
							$RTF->cell($RTF->bold(1).$heading_bkk1_text[$HISTORY_NAME][1].$RTF->bold(0), $heading_bkk1_width[$HISTORY_NAME][1], "center", "25", "TRBL");
							$RTF->cell($RTF->bold(1).$heading_bkk1_text[$HISTORY_NAME][3].$RTF->bold(0), $heading_bkk1_width[$HISTORY_NAME][2], "center", "25", "TRBL");
							$RTF->close_line();
							...
							for($row_count=0; $row_count < $edu_count; $row_count++) {
									...
									$RTF->set_font($font,14);
									$RTF->color("1");	// 0=DARKGRAY
									$RTF->cell($arr_content[$row_count][ins_name], $heading_bkk1_width[$HISTORY_NAME][0], "left", "8", $border);
									$RTF->cell($arr_content[$row_count][edu_period], $heading_bkk1_width[$HISTORY_NAME][1], "center", "8", $border);
									$RTF->cell($arr_content[$row_count][en_name]."  ".$arr_content[$row_count][em_name], $heading_bkk1_width[$HISTORY_NAME][2], "left", "8", $border);
									$RTF->close_line();
							...
							$RTF->set_font($font, 14);
							$RTF->color("0");	// 0='BLACK'
							$RTF->cell($RTF->bold(1).$heading_bkk2_text[$HISTORY_NAME][0].$RTF->bold(0), $heading_bkk2_width[$HISTORY_NAME][0], "center", "25", "TRBL");	
							$RTF->cell($RTF->bold(1).$heading_bkk2_text[$HISTORY_NAME][1].$RTF->bold(0), $heading_bkk2_width[$HISTORY_NAME][1], "center", "25", "TRBL");
							$RTF->cell($RTF->bold(1).$heading_bkk2_text[$HISTORY_NAME][3].$RTF->bold(0), $heading_bkk2_width[$HISTORY_NAME][2], "center", "25", "TRBL");
							$RTF->close_line();
							...
							for($row_count=0; $row_count < $trn_count; $row_count++) {
									...
									$RTF->set_font($font,14);
									$RTF->color("1");	// 0=DARKGRAY
									$RTF->cell($arr_content[$row_count][trn_place], $heading_bkk2_width[$HISTORY_NAME][0], "left", "8", $border);
									$RTF->cell($arr_content[$row_count][trn_duration], $heading_bkk2_width[$HISTORY_NAME][1], "center", "8", $border);
									$RTF->cell($arr_content[$row_count][tr_name], $heading_bkk2_width[$HISTORY_NAME][2], "left", "8", $border);
									$RTF->close_line();
							} // end for loop $row_count
						} else {	// $BKK_FLAG != 1
							$RTF->open_line();
							$RTF->set_font($font,14);
							$RTF->color("1");	// 0=DARKGRAY
							$RTF->cell("ประวัติการศึกษา", "46", "center", "8", "TRBL");
							$RTF->cell("ประวัติการฝึกอบรมและดูงาน", "52", "center", "8", "TRBL");
							$RTF->close_line();
...
//							$RTF->add_text("", "left");
							...
							$RTF->set_font($font,14);
							$RTF->color("1");	// 0=DARKGRAY
							$RTF->cell($RTF->bold(1).($history_index)."  ความสามารถพิเศษ ".$RTF->bold(0), "$page_ch", "left", "8", "TRBL");
							$RTF->close_line();
...
//							$RTF->add_text("", "left");
							...
							$RTF->set_font($font,14);
							$RTF->color("1");	// 0=DARKGRAY
							$RTF->cell($RTF->bold(1).($history_index)."  ประวัติการปฏิบัติราชการพิเศษ ".$RTF->bold(0), "$page_ch", "left", "8", "TRBL");
							$RTF->close_line();
...
//							$db_dpis2->show_error();
							if($count_namehis){
								...
								while($data2 = $db_dpis2->get_array()){
									...
									$RTF->set_font($font,14);
									$RTF->color("1");	// 0=DARKGRAY
									$RTF->cell("วันที่เปลี่ยน : $NH_DATE จาก $OLD_NAME เป็น $NEW_NAME", $heading_width[$HISTORY_NAME][0]+$heading_width[$HISTORY_NAME][1], "left", "8", $border);
									$RTF->close_line();
								} // end while
								$RTF->open_line();
								$RTF->set_font($font,14);
...
//										echo "w_chr=$w_chr, RTF->_font_size()=$fsnum<br>";
										if ($arr_imgshow[$i]==1){  
											$RTF->color("16");	 
											$RTF->cell($RTF->bold(1)."รูปที่ ".($i+1).$RTF->bold(0), "$w_chr", "center", "8", "TRL");
										} else {  
											$RTF->color("0");  
											$RTF->cell("รูปที่ ".($i+1), "$w_chr", "center", "8", "TRL");
										}
										$j++;
									} // end if			
								}
								...
								for($i=$start_pic; $i  < $imgcnt; $i++) {
									if($arr_img[$i]){
										...
										if ($arr_imgshow[$i]==1){  
											$RTF->color("16");	 
											$RTF->cell($RTF->bold(1)."พ.ศ. ".substr($arr_imgsavedate[$i],0,4).$RTF->bold(0), "$w_chr", "center", "8", "RBL");
										} else {  
											$RTF->color("0");  
											$RTF->cell("พ.ศ. ".substr($arr_imgsavedate[$i],0,4), "$w_chr", "center", "8", "RBL");
										}
										$j++;
									} // end if			
								}
...
//							$RTF->add_text("", "left");
							...
							$RTF->set_font($font,14);
							$RTF->color("1");	// 0=DARKGRAY
							$RTF->cell($RTF->bold(1)."สรุปผลการประเมินประสิทธิภาพและประสิทธิผลการปฏิบัติงานของข้าราชการของ ".(($NUMBER_DISPLAY==2)?convert2thaidigit($FULLNAME):$FULLNAME).$RTF->bold(0), "$page_ch", "left", "8", "TRBL");
							$RTF->close_line();
...
//										echo "yidx=$yidx  year=".$arr_year[$yidx]."  รอบ=$abidx  คะแนน=".$arr_AB_NAME[$arr_year[$yidx]][$abidx]."  remark=".$arr_rem[$yidx]."<br>";
										if ($arr_AB_NAME[$arr_year[$yidx]][$abidx]==0) $dd = "-";
										else $dd = $arr_AB_NAME[$arr_year[$yidx]][$abidx];
