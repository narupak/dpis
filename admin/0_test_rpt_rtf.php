...
//	session_cache_limiter("nocache");
	...
	$fname= "0_test_rpt_rtf.rtf";
//	$fname= "0_test_rpt_rtf.txt";
...
//	echo "$head_text1<br>";
	...
	for($i=0; $i < count($arr_thai); $i++) {
		$arr_data = (array) null;
		$arr_data[] = $arr_thai[$i];
		$arr_data[] = "<*img*../images/Chrysanthemum.jpg,15*img*>";
		$arr_data[] = " ";
		$arr_data[] = " ";
		$arr_data[] = " ";
		$arr_data[] = " ";
...
//			echo "$PER_ID-$FULLNAME [$PL_NAME]<br>";
			...
			$arr_data = (array) null;
			$arr_data[] = "$PER_ID $FULLNAME (".card_no_format($PER_CARDNO,1).")".(((int)$PER_CARDNO==13)?"<*img*../../attachment/pic_personal/3609900687557-004.jpg,15*img*>" : "");
