...
//        echo "โปรแกรมฉบับชั่วคราว (beta 5.2.1.14 : 29 พ.ย. 2560)<br>";
...
$impfile_head_thai = array( "เลขประจำตัวประชาชน","ชื่อ-นามสกุล","เลขที่ตำแหน่ง", "ชื่อตำแหน่ง", "ระดับตำแหน่ง", "เงินเดือน", "เงินเดือนสูงสุด", "ฐานในการคำนวณ", "คะแนนการประเมิน",	"ร้อยละของการเลื่อน", "จำนวนเงินที่คำนวณได้", "จำนวนเงินที่ได้รับการเลื่อนจริง", "เงินตอบแทนฯ", "รวม", "เงินเดือนหลังเลื่อน", "ผลการประเมิน", "หมายเหตุ","*ค่าครองชีพชั่วคราว",  "สังกัด");
$impfile_exam_map = array( "1234567890123","นายสมชาย ใจดี","1", "นักบริหาร", "สูง<br>บ.2", "69350", "69810", "66460", "94.64", "3.9", "2600", "460", "2131.94", "2591.94", "69810", "ดีเด่น<br>0.5 ขั้น", "","1500","");
...
$column_map[PER_CARDNO] = "sql-s-d-select PER_CARDNO from PER_PERSONAL where  PER_ID=@1"; //"php-s-e-PER_CARDNO";		// 10-map กับ column 1 ใน text หรือ excel  PER_CARDNO
