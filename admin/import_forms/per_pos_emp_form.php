...
//	$head_map = array("ฟิลด์ 1","ฟิลด์ 2","ฟิลด์ 3","ฟิลด์ 4","ฟิลด์ 5","ฟิลด์ 6","ฟิลด์ 7","","ฟิลด์ 9","");
	...
	$column_map[] = "sql-s-d-select PN_CODE from PER_POS_NAME where PN_NAME='@6'";
	$column_map[] = "7";
	$column_map[] = "8";
	$column_map[] = "9";
	...
	$column_map[] = "sql-n-d-select ORG_ID from PER_ORG where ORG_NAME='@16'";
	$column_map[] = "sql-n-d-select ORG_ID from PER_ORG where ORG_NAME='@17'";
	$column_map[] = "18";
	$column_map[] = "19";
	$column_map[] = "sql-s-d-select LEVEL_NO from PER_LEVEL where LEVEL_NAME='@20'";
