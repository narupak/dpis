...
//	$head_map = array("ฟิลด์ 1","ฟิลด์ 2","ฟิลด์ 3","ฟิลด์ 4","ฟิลด์ 5","ฟิลด์ 6","ฟิลด์ 7","","ฟิลด์ 9","");
	...
	$column_map[] = "sql-s-d-select EP_CODE from PER_EMPSER_POS_NAME where EP_NAME='@6'";
	$column_map[] = "7";
	$column_map[] = "8";
	$column_map[] = "9";
	$column_map[] = "update_user";	// 10-map กับ UPDATE_USER จากระบบ
	$column_map[] = "update_date";	// 11-map กับ UPDATE_DATE จากระบบ
	$column_map[] = "sql-n-d-select ORG_ID from PER_ORG where ORG_NAME='@12'";
	$column_map[] = "13";
	$column_map[] = "14";
	$column_map[] = "sql-s-d-select PPT_CODE from PER_PRACTICE where PPT_NAME='@15'";
	$column_map[] = "sql-s-d-select PEF_CODE from PER_POS_EMPSER_FRAME where PEF_NAME='@16'";
	$column_map[] = "sql-s-d-select PPS_CODE from PER_?????? where PPS_NAME='@17'";
	$column_map[] = "sql-n-d-select ORG_ID from PER_ORG where ORG_NAME='@18'";
	$column_map[] = "sql-n-d-select ORG_ID from PER_ORG where ORG_NAME='@19'";
	$column_map[] = "sql-n-d-select ORG_ID from PER_ORG where ORG_NAME='@20'";
	$column_map[] = "21";
	$column_map[] = "22";
	$column_map[] = "23";
