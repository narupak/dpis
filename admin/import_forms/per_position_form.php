...
//	$head_map = array("ฟิลด์ 1","ฟิลด์ 2","ฟิลด์ 3","ฟิลด์ 4","ฟิลด์ 5","ฟิลด์ 6","ฟิลด์ 7","","ฟิลด์ 9","");
	...
	$column_map[] = "19";
	$column_map[] = "20";
	$column_map[] = "21";	// POS_STATUS 0=ยกเลิก  1=ปกติ
	$column_map[] = "update_user";	// 22-map กับ UPDATE_USER จากระบบ
	$column_map[] = "update_date";	// 23-map กับ UPDATE_DATE จากระบบ
	...
	$column_map[] = "32";
	$column_map[] = "33";	// AUDIT_FLAG 0=ไม่ได้ audit  1= audit
