...
//echo("count_data - $count_data");
	...
	$arr_series_list[0] = implode(";", $arr_series_caption_data[0]).";$GRAND_TOTAL_1[$DEPARTMENT_ID]";
	$arr_series_list[1] = implode(";", $arr_series_caption_data[1]).";$GRAND_TOTAL_2[$DEPARTMENT_ID]";
	$arr_series_list[2] = implode(";", $arr_series_caption_data[2]).";$GRAND_TOTAL_3[$DEPARTMENT_ID]";
