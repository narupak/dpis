<?php
	...
	<tr>
      ...
      <tr>
		...
		<input type="submit" name="save_alias" id="save_alias" value="Save Alias" onclick="joinValueHidden(\';\',\'hidField\',\'hidJoinField\');sendRequest(\'phpscripts/xrpt_save_relationship.php\',document.form1.hidJoinField.value,\'DIV_step3\')" /></td>
      </tr>	
      </table>
	';
