...
//echo "<br> 2 : $cmd<br>";
		...
		if($AUTOMAIL_ABSENT_FLAG=="Y" && $APPROVE_PER_ID){
			...
			//echo "<br>$PER_EMAIL,$PER_NAME,$PER_APPROVE_EMAIL,$APPROVE_PER_NAME,$AB_NAME,$ABS_STARTDATE,$ABS_ENDDATE,0<hr>";
			$result=0;
...
//echo "$AUTOMAIL_ABSENT_FLAG / $APPROVE_PER_ID --> $result  / $cmd";
