...
//			echo "cmd=$cmd<br>";
		...
		$command = "SEARCH";
		insert_log("$MENU_TITLE_LV0 > $MENU_TITLE_LV1 > จัดลำดับบุคลากร [$PER_ID : $FULL_NAME]");
	} // end if
...
//			echo $cmd . "<br>";
	...
	//		$db_dpis->show_error();
		...
		$command = "SEARCH";
		$PER_ID = "";		//เคลียร์ค่า
		insert_log("$MENU_TITLE_LV0 > $MENU_TITLE_LV1 > ลบข้อมูล$PERSON_TITLE [ $PER_ID : $PER_NAME_DEL $PER_SURNAME_DEL ]");
	} // end if
?>