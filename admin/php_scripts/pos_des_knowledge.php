...
//			$db_dpis->show_error();
			...
			insert_log("$MENU_TITLE_LV0 > $MENU_TITLE_LV1 > เพิ่มข้อมูล [".trim($POS_DES_ID)." : ".$JOB_DES_ID." : ".$JOB_DES_LEVEL."]");
		} // command ADD
...
//			$db_dpis->show_error();
			...
			insert_log("$MENU_TITLE_LV0 > $MENU_TITLE_LV1 > แก้ไขข้อมูล [".trim($POS_DES_ID)." : ".$POS_JOB_DES_PRI_ID." : ".$JOB_DES_ID." : ".$JOB_DES_LEVEL."]");
...
//			$db_dpis->show_error();
			...
			insert_log("$MENU_TITLE_LV0 > $MENU_TITLE_LV1 > ลบข้อมูล [".trim($POS_DES_ID)." : ".$POS_JOB_DES_PRI_ID."]");
