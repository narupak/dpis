...
//		echo "upd-$cmd [$count_ctrl]<br>";
		if($count_ctrl){
			if ($CH_CTRL_TYPE<=2)  $org_0_text = "ORG_ID = 0, "; else $org_0_text = "";
			$cmd = " update SITE_INFO set SITE_LEVEL = $CH_CTRL_TYPE, $org_0_text
								SITE_NAME = '$SITE_NAME',
								SITE_BG_LEFT = '$SITE_BG_LEFT',
								SITE_BG_LEFT_X = $SITE_BG_LEFT_X,
								SITE_BG_LEFT_Y = $SITE_BG_LEFT_Y,
								SITE_BG_LEFT_W = $SITE_BG_LEFT_W,
								SITE_BG_LEFT_H = $SITE_BG_LEFT_H,
								SITE_BG_LEFT_ALPHA = $SITE_BG_LEFT_ALPHA,
								SITE_BG = '$SITE_BG',
								SITE_BG_X = $SITE_BG_X,
								SITE_BG_Y = $SITE_BG_Y,
								SITE_BG_W = $SITE_BG_W,
								SITE_BG_H = $SITE_BG_H,
								SITE_BG_ALPHA = $SITE_BG_ALPHA,
								SITE_BG_RIGHT = '$SITE_BG_RIGHT',
								SITE_BG_RIGHT_X = $SITE_BG_RIGHT_X,
								SITE_BG_RIGHT_Y = $SITE_BG_RIGHT_Y,
								SITE_BG_RIGHT_W = $SITE_BG_RIGHT_W,
								SITE_BG_RIGHT_H = $SITE_BG_RIGHT_H,
								SITE_BG_RIGHT_ALPHA = $SITE_BG_RIGHT_ALPHA,
								CSS_NAME = '$CSS_NAME',
								PV_CODE = $prov_ui,
