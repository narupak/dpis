<?	
	...
	if(trim($search_pos_change_date_max)){
  	...
  	if(trim($search_pos_no))  {	
		...
		elseif ($search_per_type == 2) 
			$arr_search_condition[] = "(b.POEM_NO like '$search_pos_no%')";		
		elseif ($search_per_type == 3) 	
			$arr_search_condition[] = "(b.POEMS_NO like '$search_pos_no%')";			
		elseif ($search_per_type == 4) 	
			$arr_search_condition[] = "(b.POT_NO like '$search_pos_no%')";			
	}
	if(trim($search_pl_code)){
		if($search_per_type == 1 || $search_per_type==5)
			$arr_search_condition[] = "(b.PL_CODE = '$search_pl_code')";
		elseif($search_per_type == 2)
			$arr_search_condition[] = "(b.PN_CODE = '$search_pl_code')";
		elseif($search_per_type == 3)
			$arr_search_condition[] = "(b.EP_CODE = '$search_pl_code')";
		elseif($search_per_type == 4)
			$arr_search_condition[] = "(b.TP_CODE = '$search_pl_code')";
	} // end if
...
//	if(trim($search_pos_ot_code)) $arr_search_condition[] = "(b.OT_CODE='$search_pos_ot_code')";
	...
	if(trim($search_poh_pl_code)){
		if($search_per_type == 1 || $search_per_type == 5) $arr_search_positionhis_condition[] = "(b.PL_CODE = '$search_poh_pl_code')";
		elseif($search_per_type == 2) $arr_search_positionhis_condition[] = "(b.PN_CODE = '$search_poh_pl_code')";
		elseif($search_per_type == 3) $arr_search_positionhis_condition[] = "(b.EP_CODE = '$search_poh_pl_code')";
		elseif($search_per_type == 4) $arr_search_positionhis_condition[] = "(b.TP_CODE = '$search_poh_pl_code')";
	} // end if
...
//		$db_dpis->show_error();
	...
	if(trim($search_sah_pl_code)){
		if($search_per_type == 1 || $search_per_type == 5) $arr_search_salaryhis_condition[] = "(b.PL_CODE = '$search_sah_pl_code')";
		elseif($search_per_type == 2) $arr_search_salaryhis_condition[] = "(b.PN_CODE = '$search_sah_pl_code')";
		elseif($search_per_type == 3) $arr_search_salaryhis_condition[] = "(b.EP_CODE = '$search_sah_pl_code')";
		elseif($search_per_type == 4) $arr_search_salaryhis_condition[] = "(b.TP_CODE = '$search_sah_pl_code')";
	} // end if
