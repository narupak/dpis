...
//echo "$setflagshow<br>";
		$cmd = " update $table set $arr_fields[3] = 0 where $arr_fields[0] in ($current_list) ";
		$db_dpis->send_cmd($cmd);
//$db->show_error(); echo "<br>";
		$cmd = " update $table set $arr_fields[3] = 1 where $arr_fields[0] in ($setflagshow) ";
		$db_dpis->send_cmd($cmd);
//$db->show_error(); echo "<br>";
