...
//echo "arr_level_startdate[0] = " . $arr_level_startdate[0] . " == ". ${$name_arr_DCON_TIME2}[$dc_type_tmp][$dc_code_tmp] . "<br>";
	...
	switch (${"arr_DC_TYPE$tmp_LEVEL_NO"}[$i]) {
		case 3:
echo " case 3 -> " . $dc_code_tmp . " => (" . $dc_code_old_tmp;
...
echo $arr_old_dc_code_date[$dc_code_old_tmp] .") " ;
			...
			if ($privilege1==true && $privilege2==true && $privilege3==true && $privilege4==true)		echo " *INSERT* ";
echo "<br>";			
			break;
			
		case 2:
echo " case 2 -> " . $dc_code_tmp . " => (" . $dc_code_old_tmp;
echo " '$arr_per_startdate[0]>=$dcon_time1_tmp' '$arr_level_startdate[0]>=$dcon_time2_tmp' '$dc_code_old_tmp' ' ";
echo $arr_dc_code_old_startdate[$dc_code_old_tmp][0] .">=". $dcon_time3_tmp . "' in ";
echo $arr_old_dc_code_date[$dc_code_old_tmp] .") " ;
			if (in_array($dc_code_tmp, $arr_old_dc_code)) {
			...
			if ($privilege1==true && $privilege2==true && $privilege3==true && $privilege4==true) {
				$cmd = " insert into PER_DECORDTL (DE_ID, DC_CODE, PER_ID, UPDATE_USER, UPDATE_DATE)
					 values ($DE_ID, '$dc_code_tmp', $tmp_PER_ID, $SESS_USERID, '$UPDATE_DATE') ";
...
echo "<br>";			
		...
		case 1:
echo " case 1 -> " . $dc_code_tmp . " => (" . $dc_code_old_tmp;
echo " '$arr_per_startdate[0]>=$dcon_time1_tmp' '$arr_level_startdate[0]>=$dcon_time2_tmp' '$dc_code_old_tmp' ' ";
echo $arr_dc_code_old_startdate[$dc_code_old_tmp][0] .">=". $dcon_time3_tmp . "' in ";
echo $arr_old_dc_code_date[$dc_code_old_tmp] .") " ;
			if (in_array($dc_code_tmp, $arr_old_dc_code)) {
