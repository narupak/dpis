...
//				$SAH_SALARY_UP = trim($fields[10]);
				...
				if ($SAH_LAST_SALARY!="Y") $SAH_LAST_SALARY = "N";
				...
				if ($count_data) {			
					...
					$cmd = " insert into PER_SALARYHIS (SAH_ID, PER_ID, SAH_EFFECTIVEDATE, MOV_CODE, SAH_SALARY, 
									...
									SAH_KF_YEAR, SAH_KF_CYCLE, SAH_TOTAL_SCORE, SAH_LAST_SALARY, SM_CODE, SAH_OLD_SALARY, SAH_CMD_SEQ)
									...
									'$SAH_LAST_SALARY', '$SM_CODE', $SAH_OLD_SALARY, $SAH_CMD_SEQ) ";
					$db_dpis->send_cmd($cmd);
					//$db_dpis->show_error();
					//echo "$cmd<br>";
