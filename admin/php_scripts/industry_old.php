...
ส่งเสริม สนับสนุน และดำเนินการอย่างเป็นรูปธรรม เพื่อรณรงค์ และผลักดันกระบวนการและกลไกการมีส่วนร่วมของทุกภาคส่วน เพื่อให้เกิดผลสัมฤทธิ์ต่อประชาชน สังคม และประเทศชาติอย่างแท้จริงและยั่งยืน', $SESS_USERID, '$UPDATE_DATE') ";
		...
		for ( $i=0; $i<count($code); $i++ ) { 
			...
			elseif ($i == 6) $desc = array(	"303", "313", "314", "316" );
			...
			elseif ($i == 19) $desc = array(	"301", "303", "305", "306", "311", "312", "313", "314", "315", "318" );
			elseif ($i == 20) $desc = array(	"302", "303", "304", "313", "314", "315", "316" );
			elseif ($i == 21) $desc = array(	"301", "303", "304", "305", "312", "313", "314", "315" );
			elseif ($i == 22) $desc = array(	"302", "304", "313", "317" );
			elseif ($i == 23) $desc = array(	"303", "304", "305", "309", "313" );
			elseif ($i == 24) $desc = array(	"303", "304", "306", "309", "311", "312", "315" );
			elseif ($i == 25) $desc = array(	"301", "304", "305", "309", "312", "313", "315", "316", "318" );
			elseif ($i == 26) $desc = array(	"306", "311", "315" );
			elseif ($i == 27) $desc = array(	"303", "304", "309" );
			elseif ($i == 28) $desc = array(	"303", "304", "305", "309", "314", "315" );
			elseif ($i == 29) $desc = array(	"301", "304", "305", "309", "312", "313", "315", "318" );
			elseif ($i == 30) $desc = array(	"302", "304", "313", "314", "315" );
			elseif ($i == 31) $desc = array(	"201", "202", "203", "204", "205", "206", "301", "302", "303", "304", "305", "312", "313", "314", "315", "316" );
			elseif ($i == 32) $desc = array(	"303", "304", "314", "315" );
			elseif ($i == 33) $desc = array(	"303", "313", "314", "315" );
			elseif ($i == 34) $desc = array(	"301", "302", "303", "304", "305", "313", "314", "315", "316", "318" );
			elseif ($i == 35) $desc = array(	"303", "313", "315" );
			elseif ($i == 36) $desc = array(	"303", "305", "313", "314", "315", "316" );
