...
//			$cmd = " update PER_PERSONAL set POS_ID=NULL, POEM_ID=NULL, POEMS_ID=NULL, MOV_CODE='$tmp_MOV_CODE', PER_STATUS=2, PER_POSDATE='$tmp_CMD_DATE' where PER_ID=$tmp_PER_ID ";
			...
			$cmd = " update PER_PERSONAL set MOV_CODE='$tmp_MOV_CODE', PER_STATUS=2, PER_POSDATE='$tmp_CMD_DATE' where PER_ID=$tmp_PER_ID ";
...
//echo "<br>";
			...
			$db_dpis1->send_cmd($cmd);
			$data1 = $db_dpis1->get_array();
			$data1 = array_change_key_case($data, CASE_LOWER);
...
// ($POH_ID, $tmp_PER_ID, '$tmp_year-10-01', '$tmp_MOV_CODE', '$COM_NO', '$COM_DATE', '', 							
			$db_dpis1->send_cmd($cmd);
//$db_dpis1->show_error();		
//echo "<br>";
