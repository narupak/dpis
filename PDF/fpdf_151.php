...
{
//Private properties
var	$flag_new_page;			//   flag return 'Y' when report begin new page
...
*                                                                           *
****************************************************************************/
function FPDF($orientation='P', $unit='mm', $format='A4', $lang_code, $company_name, $report_title, $report_code,$heading,$heading_width,$heading_align,$heading_border,$report_footer)
{
	...
	if(is_string($format))
	{
		...
		elseif($format=='envelope_dl')
			$format=array(311.81,623.62);
		elseif($format=='card_11x15')
			$format=array(311.81,425.20);
		else
