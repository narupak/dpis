...
//					$this->SetTextColor(108);
					...
					if ($fontsize-4 < 10)
						$this->SetFont($font,'',10); // บังคับไม่ให้ มี style
		 			    ...
		 			    $this->SetFont($font,'',$fontsize); // บังคับไม่ให้ มี style
					$this->Cell(0,8, $this->company_name,0,1,'L');
